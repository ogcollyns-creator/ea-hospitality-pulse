...
window.ADVISORIES = {
  updated: "8 September 2026 (evening — CORRECTION, UK RWANDA: the FCDO advice-against area is parts of RUSIZI District only, not 'Rubavu, Rusizi' as we carried it. Rubavu/Gisenyi on Lake Kivu is NOT in an advice-against area. Read directly from gov.uk 8 Sep 2026; page updated 4 Sep 2026. Do not discount Lake Kivu product on our old wording. Also verified 8 Sep 2026 via the Primary Source Sweep: UK KENYA updated 4 Sep 2026, advice-against unchanged, and the industrial-action note has been REMOVED from Warnings and insurance; UK UGANDA still carries no advice against travel to any part of Uganda and now notes WHO declaring the outbreak over; UK TANZANIA unchanged at the 20km Cabo Delgado border; CANADA KENYA updated 1 Sep 2026 and flags Pangani alongside Eastleigh and Kibera. Prior note — US UGANDA VERIFIED 3 Sep 2026: still Level 4, date issued 4 June 2026, unchanged despite WHO certifying Uganda Ebola-free on 26 Aug 2026. Also standing: Nairobi's Eastleigh & Kibera are US Level 4, verified vs travel.state.gov 12 Aug 2026.)",
  rows: [
