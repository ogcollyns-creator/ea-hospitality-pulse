# EA Pulse self-audit — 2026-08-18T07:21+03:00 EAT
...
| 🟢 | radar feed freshness | PASS | 520 in-window obs; newest observation 1.2h old (2026-08-18T06:11:00+03:00). |
| 🟡 | edition cadence | WARN | Missing slots (last 2 full days): 2026-08-17 morning |
| 🟡 | signal quality | WARN | Only 0 tier-tagged editions in 7d — too few to judge. |
| 🟢 | ledger hygiene | PASS | 100 calls: 80 open, 20 resolved. Overdue-open: 0. Missing source_url: 23. |
| 🟡 | data freshness | WARN | Stale/again-verify: advisories.js 6d>4 |
| 🟡 | rate-index integrity | WARN | n values seen: [0, 1, 2, 3, 4, 5]; confident true=65 false=6. |
| 🟢 | forecast throughput | PASS | 35 new falsifiable calls logged in last 7d. |
