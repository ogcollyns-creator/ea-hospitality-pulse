...
window.MICE = {
 updated: "14 September 2026 (evening \u2014 no event confirmed| moved| cancelled or bid resolved today. MICE scan run: convention bureaux| KICC| Kigali Convention Centre| JNICC Dar| Speke Resort Munyonyo| Kampala Serena and the ICCA/AU/EAC/UIA calendars produced no new dated confirmation. Standing watch unchanged: the 8 October Tatler Best of Africa date remains UNCONFIRMED against KTB or Tatler \u2014 do not block inventory against it. COST NOTE ADDED FOR THE MOMBASA CLUSTER: EPRA retained Kenyan pump prices for 15 Sep\u201314 Oct 2026| so the Africa MICE Summit window of 1\u20132 October falls inside a KNOWN fuel cost (Mombasa diesel KSh 214.58/L| roughly KSh 3/L below Nairobi across all three grades). Delegate transfer pricing for that summit can be fixed with confidence; anything quoted beyond 14 October cannot| because the diesel landed cost rose 11.86% in August without reaching the pump and the 8% petroleum VAT rate expires 14 Oct 2026. Coast venues should hold rate across 30 Sep\u20132 Oct rather than discounting into the shoulder| and keep the daytime vector protocol visibly in place \u2014 Mombasa carries Kenya\u2019s heaviest dengue and mpox burden and this is the single audience most likely to notice.)",
 events: [
