...
window.MICE = {
 updated: "15 September 2026 (morning \u2014 NO EVENT CONFIRMED| MOVED| CANCELLED OR BID RESOLVED TODAY. MICE scan run: convention bureaux| KICC| Rwanda Convention Bureau| Kigali Convention Centre| JNICC Dar| Speke Resort Munyonyo| Kampala Serena| Diani/Mombasa venues| and the ICCA/UIA/AU/EAC calendars produced no new dated confirmation. Standing watch unchanged: the 8 October Tatler Best of Africa date remains UNCONFIRMED against KTB or Tatler \u2014 do not block inventory against it. COST NOTE REVISED| AND IT CUTS THE OTHER WAY FROM YESTERDAY. On 14 Sep we said the 1-2 October Africa MICE Summit window in Mombasa falls inside a KNOWN fuel cost because EPRA retained pump prices to 14 Oct. That is still true| but the certainty is now narrower than it looked. Saudi Arabia has shut its 1|200km East-West pipeline \u2014 the route that bypasses the Strait of Hormuz and the reason Aramco displaced the UAE as Kenya\u2019s largest G-to-G fuel supplier \u2014 after drone strikes near Riyadh and Medina; Hormuz is running at roughly 6-9m bpd against 20m+ pre-war; Brent closed at US$107 on 14 Sep (Business Daily| 14 September 2026). Separately the Houthis took Mocha on 10 Sep and Yemen\u2019s remaining Red Sea coast| Perim Island and the Hanish Islands by 14 Sep| tightening control of Bab al-Mandeb (FDD| 14 September 2026). AND 14 OCTOBER IS NOW A DOUBLE DATE: EPRA\u2019s frozen cycle ends the same day the reduced 8% VAT on petrol| diesel and kerosene expires under KRA\u2019s Order of 14 July 2026. PRACTICAL EFFECT FOR THE AUTUMN CONFERENCE CLUSTER: delegate transfer pricing for Africa MICE Summit (Mombasa| 1-2 Oct) and Kenya Transport Summit (KICC| 30 Sep-2 Oct) can still be fixed with confidence because both sit INSIDE the frozen window \u2014 fix them this week. Anything quoted beyond 14 October should carry a fuel-adjustment clause. Coast venues should still hold rate across 30 Sep-2 Oct rather than discounting into the shoulder| and keep the daytime vector protocol visibly in place \u2014 Mombasa carries Kenya\u2019s heaviest dengue and mpox burden and this is the single audience most likely to notice.)",
 events: [
