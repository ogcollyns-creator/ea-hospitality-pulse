...
window.MICE = {
 updated: "15 September 2026 (evening \u2014 NO EVENT CONFIRMED| MOVED| CANCELLED OR BID RESOLVED TODAY. The daily MICE scan was run this morning (convention bureaux| KICC| Rwanda Convention Bureau| Kigali Convention Centre| JNICC Dar| Speke Resort Munyonyo| Kampala Serena| Diani/Mombasa venues| ICCA/UIA/AU/EAC calendars) and produced no new dated confirmation; the evening pass adds none. Standing watch unchanged: the 8 October Tatler Best of Africa date remains UNCONFIRMED against KTB or Tatler \u2014 do not block inventory against it. COST POSITION UNCHANGED FROM THIS MORNING: EPRA retained all three grades for 15 Sep \u2013 14 Oct 2026| so delegate transfer pricing for Africa MICE Summit (Mombasa| 1\u20132 Oct) and Kenya Transport Summit (KICC| 30 Sep\u20132 Oct) can still be fixed with confidence| while anything quoted beyond 14 October should carry a fuel-adjustment clause \u2014 the 8% petroleum VAT expires the same day the freeze ends. ADDED TONIGHT| A CONTRACTING POINT RATHER THAN AN EVENT: Rwanda's Ministry of Health notice of 22 May 2026 denies entry to any foreign national who travelled to or transited the DRC in the previous 30 days| while stating in the same document that 'all activities within Rwanda continue as usual| including conferences| events| tourism'. Kigali is defending its meetings book and its border in one instrument. Any property contracting a regional group into Kigali should collect DRC-transit history AT CONTRACTING| not at check-in \u2014 the clause catches a delegate who spent a single day in Kinshasa| 1|600km from the outbreak. The measure has not been revised since 22 May; the most recent EVD update on the MoH news listing is 16 June 2026.)",
 events: [
