...
window.MICE = {
 updated: "13 September 2026 (evening \u2014 no event confirmed| moved| cancelled or bid resolved today. MICE scan run: convention bureaux| KICC| Kigali Convention Centre| JNICC Dar| Speke Resort Munyonyo and the ICCA/AU/EAC calendars produced no new dated confirmation. LOGGED FROM THE KCAA SITE READ THIS RUN| for the record and NOT added as a forward event: AVIATION AFRICA 2026| 10th edition| ran at the Sarit Expo Centre Nairobi on 9-10 September 2026| hosted by the State Department for Aviation and Aerospace Development| KCAA and the Kenya Airports Authority \u2014 it is now past| and no organiser delegate figure was published. Standing watch unchanged: the 8 October Tatler Best of Africa date remains UNCONFIRMED against KTB or Tatler. NAIROBI CITY-VENUE OPERATIONAL NOTE UPDATED: the 13 September Linda Mwananchi procession proceeded as planned| All Saints Cathedral through Marikiti| Gikomba| Burma| Manyanja Road and Jogoo Road to Jacaranda Grounds| which filled to capacity; the police bar on large political gatherings in the CBD held and no curfew or CBD business closure was ordered. France Diplomatie has now put the gathering into its travel advice and frames Kenya as in an active pre-electoral period to the 10 August 2027 election \u2014 CBD-cluster venues should expect further dated assembly restrictions on rally weekends through that cycle rather than treating this as a one-off.)",
 events: [
