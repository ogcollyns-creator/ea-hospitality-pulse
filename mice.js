...
window.MICE = {
 updated: "17 September 2026 (evening \u2014 TWO EVENTS ADDED| BOTH LOGGED WITHOUT DELEGATE NUMBERS BECAUSE NONE IS PUBLISHED. FIRST| NAIROBI HAS THE 2029 WORLD ATHLETICS CHAMPIONSHIPS. World Athletics announced on 15 September 2026| after a Council meeting in Budapest| that Nairobi beat London and Rome to host the 2029 edition \u2014 the first on African soil \u2014 centred on Moi International Sports Centre| Kasarani; Munich takes 2031. Competition dates are not yet set and no attendance figure has been published| so there is nothing to price and we estimate nothing. SECOND| AFCON 2027 IS NOW A CONTRACTING CONVERSATION| NOT A CALENDAR ENTRY. At IFTM Top Resa in Paris on 16 September 2026 French and European buyers were discussing AFCON-linked multi-country itineraries with Ugandan operators alongside gorilla permit allocations for Bwindi and Mgahinga (Embassy of Uganda in Paris| via UG Standard and SoftPower News). The tournament falls in June-July 2027 across Kenya| Uganda and Tanzania| at the front of the high season| and we have found NO published room-block| rate-cap or accommodation-allocation framework from CAF or any of the three host tourism boards \u2014 that absence is logged as ledger call P192. THE EVENING MICE SCAN otherwise produced no new dated confirmation: convention bureaux| KICC| Rwanda Convention Bureau| Kigali Convention Centre| JNICC Dar| Speke Resort Munyonyo| Kampala Serena| Diani/Mombasa venues| ICCA/UIA/AU/EAC calendars and IATA/AFRAA were checked. STANDING WATCH UNCHANGED: the 8 October Tatler Best of Africa date remains UNCONFIRMED against KTB or Tatler \u2014 do not block inventory against it. CONTRACTING POINT ADDED: IFTM Top Resa 2026 drew 32|000 tourism professionals| 1|650 companies and institutions and 177 destinations over 15-17 September (Tanzania Ministry of Foreign Affairs and East African Cooperation| via Daily News| 16 September 2026)| with Tanzania fielding 15 companies under the Zanzibar Commission for Tourism and Uganda eleven DMCs at Stand T072| up from five in 2025. Anything quoted there for 2027 or 2028 was quoted before Kenya\u2019s 8% fuel VAT expires and EPRA\u2019s freeze ends on 14 October| and before UWA\u2019s reported US$1|800 habituation permit takes effect on 1 January 2027 \u2014 so any MICE or group rate carried out of Paris needs a tariff-variation clause.)",
 events: [
