window.EDITIONS = [
 {
  ...
  "editionKey": "evening",
  "summary": "KENYA GAVE ITS TOURISM LEVY TRUSTEES THREE-YEAR TERMS ON 18 SEPTEMBER, A DAY AFTER OPERATORS FOUGHT THE FEE SCHEDULE",
  "bodyHtml": "<p><strong>🌆 EVENING WRAP · Tue 22 Sep 2026</strong></p>\n<p><strong>📌 EXPERT BRIEF — nothing cleared tonight&#x27;s recency gate, so we lead with analysis and say so.</strong></p>\n<p><strong>KENYA GAVE ITS TOURISM LEVY TRUSTEES THREE-YEAR TERMS ON 18 SEPTEMBER, A DAY AFTER OPERATORS FOUGHT THE FEE SCHEDULE</strong></p>\n<p>On <strong>17 Sep</strong> nine trade associations told the Senate&#x27;s Delegated Legislation Committee that Legal Notice 127&#x27;s fee schedule was drafted without them. Chair <strong>Sen. Mwenda Gataya</strong>: the committee would decide <strong>&quot;whether to annul or accede&quot;</strong> <strong>(The Kenya Times, 18 Sep 2026)</strong>.</p>\n<p><strong>On 18 Sep the Cabinet Secretary gazetted three-year appointments to the bodies that hold the money.</strong> Tourism Fund Board: <strong>Patrick Ngere</strong> re-appointed, <strong>Nicholas Kimeli</strong> and <strong>Dr Yvonne Tharao</strong> appointed. Utalii College Council: <strong>Rose Polyne Nyambura</strong> re-appointed, <strong>Dr Dorothy Jepkoech Rotich</strong> appointed. KWS Board: <strong>Michemi Ndegwa</strong>, <strong>Beatrice Lempaira</strong>, renewed <strong>(Kenya Gazette w/e 18 Sep, via Vellum Kenya, 21 Sep)</strong>. <strong>We find no trade coverage of it.</strong></p>\n<p><strong>What everyone is missing.</strong> A licence fee is a fixed sum. The <strong>2% levy is a share of everything you sell</strong> — for any real turnover it is the bigger number, and it scales with your success. The Tourism Amendment Bill would give the CS the job of <strong>&quot;determining the amounts of money payable for the Fund&quot;</strong> <strong>(Eastleigh Voice, 21 Aug 2026)</strong>. PS <strong>Julius Bitok</strong> defends it by analogy to KRA collecting via e-Citizen for CBK. But <strong>KRA collects at rates Parliament sets.</strong> The analogy covers the plumbing, not the tap.</p>\n<p>Three-year terms run to <strong>Sept 2029</strong>, past the Aug 2027 election. The fee schedule is still undecided. The trustees are seated.<br><span class=\"tagline\">🏷 City, Bush, Beach | Kenya | Confirmed (gazette) · Inference (the read) | impact:margin</span><br><span class=\"sowhat\">🎯 Budget the 2027 levy as a <strong>variable, not a constant</strong>, and keep a statutory-cost-variation clause in 2027 group contracts. Then file on the Bill: <strong>Kareke Mbiuki</strong> has that window open. The fee window has closed.</span></p>\n<p><strong>📻 ALSO TONIGHT</strong><br>🇰🇪 Same gazette, not previously carried: Treasury reports <strong>KSh 882.23bn</strong> revenues to 31 Aug against <strong>KSh 5.18trn</strong> estimates.<br>🇺🇬 <strong>Blind spot partly closes.</strong> UWA&#x27;s rates page now carries a <strong>Tariff changes 2026-2027</strong> document, so a UWA-hosted replacement for the lapsed tariff <strong>does exist</strong>. The page still links the expired one. <strong>No Ugandan fee figure asserted until we parse it.</strong><br>🇨🇩 <strong>No new WHO DON since DON617 (10 Sep)</strong>: DRC <strong>6,757 cases / 3,267 deaths to 7 Sep</strong>, CFR 48.3% — the Confirmed floor. Secondary reporting carries <strong>7,672 / 3,699 to 20 Sep</strong>: Reported only.<br>🇨🇦 <strong>Canada&#x27;s Ebola border measures expire 28 Sep, six days out.</strong> No successor tonight. P198 open.</p>\n<p><strong>🔍 BLIND SPOTS.</strong> Africa CDC&#x27;s posted weekly is <strong>still August&#x27;s</strong>, third night running. The radar&#x27;s evening window returned <strong>0 observations</strong> — sandbox proxy, not a dead pipeline. Search served a Business Daily <strong>&quot;Taxman to collect tourism levy&quot;</strong> piece as current; it is dated <strong>3 July 2022</strong>. Dropped. Zanzibar&#x27;s health ministry <strong>was</strong> read directly, closing yesterday&#x27;s gap.</p>\n<p>🔗 Web: <a href=\"https://eahospitalitypulse.com/editions/pulse-2026-09-22-evening.html\" rel=\"noopener\">eahospitalitypulse.com/editions/pulse-2026-09-22-evenin…</a><br>💼 Tonight&#x27;s Big Read: <a href=\"https://www.linkedin.com/company/ea-hospitality-pulse/\" rel=\"noopener\">linkedin.com/company/ea-hospitality-pulse/</a></p>"
 },
 {
  "id": "pulse-2026-09-21-evening",
  "date": "2026-09-21",
  "dateDisplay": "Monday, 21 September 2026",
  "edition": "Evening Wrap",
  "editionKey": "evening",
  "summary": "79.5% OF KENYA'S 6,190 PIPELINE ROOMS ARE ALREADY UNDER CONSTRUCTION, AND THE 2027 TRADE IS BEING SOLD IN PARIS NOW",
  "bodyHtml": "<p><strong>🌆 EVENING WRAP · Mon 21 Sep 2026</strong></p>\n<p><strong>📌 EXPERT BRIEF — no second hard story cleared tonight&#x27;s recency gate, so we lead with analysis and say so.</strong></p>\n<p><strong>79.5% OF KENYA&#x27;S 6,190 PIPELINE ROOMS ARE ALREADY UNDER CONSTRUCTION, AND THE 2027 TRADE IS BEING SOLD IN PARIS NOW</strong></p>\n<p>Seychelles spent 15–17 Sep at IFTM Top Resa in Paris with <strong>nine partners</strong> behind its tourism board: four hotel groups, three DMCs, a specialist operator and the national airline. Special Advisor <strong>Bernadette Willemin</strong>: <strong>&quot;The 2027 planning cycle is being decided now, and for this market it is decided with the French trade.&quot;</strong> Creole Travel Services CEO <strong>Guillaume Albert</strong> said major French partners are positioning Seychelles for 2027 as they <strong>&quot;diversify their long-haul island offering&quot;</strong> <strong>(VoyagesAfriq, 21 Sep 2026)</strong>.</p>\n<p>Five days earlier <strong>Condor&#x27;s Frankfurt–Seychelles weekly went year-round</strong>, first resumed flight <strong>19 Sep</strong>, closing a mid-May-to-mid-Sep gap <strong>(Condor winter 26/27 timetable, reported 20 Sep)</strong>. Trade position in one European market, permanent lift in the other.</p>\n<p><strong>What everyone is missing — the construction ratio is not confidence, it&#x27;s a deadline.</strong> Kenya has <strong>4,922 of 6,190 pipeline rooms under construction: 79.5%</strong>. Tanzania <strong>77.5%</strong>, Ethiopia <strong>79.9%</strong>. Nigeria converts at <strong>39.2%</strong>, Cape Verde <strong>8.6%</strong> <strong>(W Hospitality Group, 10 Mar 2026)</strong>. At 8.6% it&#x27;s an option somebody can shelve. At 79.5% it&#x27;s a liability with a completion date. Those rooms open whether or not the trade sells them.</p>\n<p>Demand isn&#x27;t matching: UN Tourism has global H1 2026 arrivals <strong>+0.4%</strong>, Africa best-in-class <strong>+4%</strong>, full-year cut to <strong>1–2%</strong> from 3–4% <strong>(Barometer, Sep 2026)</strong>.</p>\n<p>And the exposure isn&#x27;t priced in beach terms. <strong>Mohammed Hersi</strong> (Pollmans), 20 Sep: <strong>&quot;People come to the Mara and then add Diani or Zanzibar. Or they come to Zanzibar and add two or three days on safari in the Serengeti or Manyara.&quot;</strong> A Seychelles booking carries no Serengeti leg. The substitution costs a beach week <strong>and</strong> the bush nights that travelled with it.<br><span class=\"tagline\">🏷 Beach, Bush, City | Tanzania, Zanzibar, Kenya | Confirmed | impact:demand</span><br><span class=\"sowhat\">🎯 Ask your inbound agents this week what share of 2027 European safari bookings still carries a Zanzibar or Diani extension, and what&#x27;s quoted against it. That ratio moves months before arrivals data does.</span></p>\n<p><strong>📻 ALSO TONIGHT</strong><br>🇰🇪 <strong>UN Tourism Week runs in Kenya 21–27 Sep — it started today.</strong> Announced on the Tourism Ministry&#x27;s Facebook <strong>19 Sep</strong>, two days out, with <strong>no venue, programme or delegate figure</strong> <strong>(People Daily, 19 Sep)</strong>. We didn&#x27;t have it; it goes in the tracker tonight. A promotional week, not room-night compression.<br>🌍 <strong>WTM Africa 2027 buyer applications opened today</strong> — 7–9 Apr 2027, Cape Town ICC <strong>(VoyagesAfriq, 21 Sep)</strong>.<br>🇰🇪 <strong>Gazette index read directly tonight</strong> (Weekly Issue 003/26-27, 21 Sep): <strong>no</strong> tourism, levy, park or licensing notice. LN 127/2026 still with the Senate committee after its 17 Sep session. Last night&#x27;s gazette blind spot is closed.<br>🇨🇩 WHO <strong>DON617</strong> (10 Sep, read in full): DRC <strong>6,757 cases, 3,267 deaths to 7 Sep</strong>, CFR <strong>48.3%</strong>. WHO <strong>advises against travel restrictions</strong>; Rwanda&#x27;s DRC entry bar still has no end date.</p>\n<p><strong>🔍 BLIND SPOTS.</strong> Africa CDC&#x27;s posted Epidemic Intelligence Weekly is <strong>still August&#x27;s</strong>. Zanzibar&#x27;s health ministry again not read directly. The radar&#x27;s evening window returned <strong>0 observations</strong> — that&#x27;s this sandbox&#x27;s proxy, not a dead pipeline, so tonight leaned on the 12:02 EAT midday feed (125 observations) plus manual scanning.</p>\n<p>🔗 This edition on the web: <a href=\"https://eahospitalitypulse.com/editions/pulse-2026-09-21-evening.html\" rel=\"noopener\">eahospitalitypulse.com/editions/pulse-2026-09-21-evenin…</a><br>💼 Tonight&#x27;s Big Read: <a href=\"https://eahospitalitypulse.com/guides/east-africa-building-faster-than-selling-2027.html\" rel=\"noopener\">eahospitalitypulse.com/guides/east-africa-building-fast…</a></p>"
 },
 {
 ...
 },
 {
  ...
  "edition": "Evening Wrap",
  "editionKey": "evening",
  "summary": "Kenya's operators spent Thursday arguing about the price. The only argument with a deadline is about the process.",
  "bodyHtml": "<p><span class=\"meta-line\">🏨 EA HOSPITALITY PULSE — Evening Wrap</span><br><span class=\"meta-line\">📅 Friday, 18 September 2026 | 🇰🇪 🇷🇼 🇹🇿 🇺🇬</span></p>\n<p>Kenya&#x27;s operators spent Thursday arguing about the price. The only argument with a deadline is about the process.<br>━━━━━━━━━<br><strong>1️⃣ KENYA IS ABOUT TO PRICE A LICENCE OFF YOUR TURNOVER</strong></p>\n<p>The Senate Committee on Delegated Legislation took evidence on Thursday 17 September from nine industry bodies on the Tourism (Tourism Enterprises) Regulations 2026 — <strong>Legal Notice No. 127 of 2026</strong>, published 10 July and tabled in the Senate on 17 July <strong>(People Daily, 18 September 2026)</strong>. The regime licences, classifies and grades hotels, restaurants, tour operators, travel agents, tourist transport, air charter and nature-based enterprises under the Tourism Regulatory Authority. Licence fees are banded on <strong>annual gross revenue</strong> — reported from KSh 16,000 for a new or sub-KSh 2m restaurant up to <strong>KSh 250,000</strong> <strong>(The Kenya Times, 18 September 2026)</strong>. Specified offences carry up to KSh 1m, six months, or both.</p>\n<p><strong>WHAT EVERYONE IS MISSING</strong><br>Kenya already charges 2% of gross sales on accommodation, food and drink as the Tourism Levy <strong>(Tourism Fund)</strong>. Band a licence on gross revenue too and you have a second turnover charge wearing a licence&#x27;s clothes. But the fee is not the winnable argument. The associations also told the committee they were <strong>not consulted before the regulations were drafted</strong> — a public-participation defect. That is the ground on which Kenyan instruments actually get annulled, and it is on a clock: under the <strong>Statutory Instruments Act No. 23 of 2013, s.15</strong>, the committee must report within 28 sitting days of referral. Chair Sen. Mwenda Gataya (Tharaka Nithi) put it plainly: the committee will decide &quot;whether to annul or accede to the Regulations.&quot;</p>\n<p><span class=\"sowhat\">🎯 <strong>So what:</strong> Count your licensable entities before you budget one fee — a lodge with a transport arm and a tour-operating arm is three applications, not one. Then get a written submission to the committee naming the public-participation defect specifically. Verbal evidence on Thursday is not a filing.</span><br><span class=\"tagline\">🏷 Beach·Bush·City | 🇰🇪 | Confirmed (instrument &amp; hearing) · Reported (fee bands) | impact:margin</span></p>\n<p>━━━━━━━━━<br><strong>ALSO TONIGHT</strong><br>🇳🇱 KLM&#x27;s first A350 is slated for Kilimanjaro, Dar, Nairobi and Zanzibar — 331 seats, but business class is <strong>not certified</strong> on the first two aircraft <strong>(Tourism Update, 17 September 2026)</strong>. Tell agents before they sell the cabin.<br>🇺🇬 <strong>Open Park Days 25–27 September</strong> — free entry, parks <strong>and</strong> reserves incl. Ajai, Katonga, Toro-Semuliki, Pian Upe; World Tourism Day nationals at Mbale on the 27th <strong>(Daily Monitor, 5 September 2026)</strong>.<br>🇷🇼 Rwanda&#x27;s <strong>30-day DRC-transit entry denial</strong> re-verified tonight, unrevised <strong>(Rwanda MoH, 22 May 2026)</strong>.</p>\n<p><span class=\"meta-line\">💬 Has anyone actually seen the fee schedule in the notice itself — or are we all working off the reporting?</span></p>\n<p>🔗 This edition on the web: <a href=\"https://eahospitalitypulse.com/editions/pulse-2026-09-18-evening.html\" rel=\"noopener\">eahospitalitypulse.com/editions/pulse-2026-09-18-evenin…</a><br>💼 Today&#x27;s Big Read on LinkedIn: <a href=\"https://www.linkedin.com/company/ea-hospitality-pulse/\" rel=\"noopener\">linkedin.com/company/ea-hospitality-pulse/</a><br>— EA Hospitality Pulse | Daily intelligence for city, bush &amp; beach properties</p>"
 },
 {
  "id": "pulse-2026-09-18-morning",
  "date": "2026-09-18",
  "dateDisplay": "Friday, 18 September 2026",
  "edition": "Morning Brief",
  "editionKey": "morning",
  "summary": "Africa's hotels adopted AI faster than anywhere on earth. New data says that was the easy part.",
  "bodyHtml": "<p><span class=\"meta-line\">🏨 EA HOSPITALITY PULSE — Big Read Special</span><br><span class=\"meta-line\">📅 Friday, 18 September 2026 | 🇰🇪 🇷🇼 🇹🇿 🇺🇬</span></p>\n<p>Africa&#x27;s hotels adopted AI faster than anywhere on earth. New data says that was the easy part.<br>━━━━━━━━━<br><strong>THE HEADLINE NUMBER</strong><br>57% of Middle East &amp; Africa hotel chains have already integrated AI-driven features, against 35% globally and under 30% in Europe, the Americas and Asia-Pacific <strong>(h2c/Profitroom Global Hospitality Technology Study, 171 chains, 27 October 2025)</strong>. MEA hoteliers also report the highest trust in AI of any region surveyed.</p>\n<p><strong>BUT THE BIGGER STUDY SAYS</strong><br>&quot;State of Distribution 2026&quot; — RateGain, NYU&#x27;s Tisch Center of Hospitality and HEDNA, built on 270+ brands and 58,000+ properties across 53 countries — finds more than half of hotels worldwide now use or are buying generative AI. Fewer than one in ten report it has cut manual workload by more than 30%. Only 8% of chains have a company-wide AI strategy at all. &quot;Buying AI is easy. Getting value from it is not,&quot; says RateGain&#x27;s Bhanu Chopra.</p>\n<p><strong>WHERE EAST AFRICA FITS</strong><br>CityBlue Hotels — Nairobi, Mombasa, Kigali, Dar es Salaam, Accra — announced an AI-native operations partnership with London&#x27;s Inntelo AI in March. The RateGain data says the clearest gains go to mid-sized chains, not giants: large enough to invest properly, small enough to avoid the legacy-systems tangle that slows a global brand to a crawl. &quot;As we scale, AI-native operations become essential to delivering consistency,&quot; says CityBlue&#x27;s Jameel Verjee.<br><span class=\"sowhat\">🎯 <strong>So what:</strong> If a vendor pitches you this quarter, the question worth asking isn&#x27;t whether it runs the latest model — it&#x27;s whether it can prove, with a number, that it has cut someone&#x27;s workload by more than 30% at a property that looks like yours. Most vendors cannot answer that yet, in Nairobi or New York.</span><br><span class=\"tagline\">🏷 Bush·City | 🇰🇪🇷🇼🇹🇿🇺🇬 | Confirmed | impact:strategy</span><br>━━━━━━━━━<br><span class=\"meta-line\">💬 Full Big Read, in full: the sourcing, the sweet-spot finding, and what East Africa is getting right that bigger chains are still missing.</span></p>\n<p>📖 Read the full Big Read: <a href=\"https://eahospitalitypulse.com/guides/africa-hotels-ai-adoption-proof-problem\" rel=\"noopener\">eahospitalitypulse.com/guides/africa-hotels-ai-adoption…</a><br>🔗 This edition on the web: <a href=\"https://eahospitalitypulse.com/editions/pulse-2026-09-18-morning\" rel=\"noopener\">eahospitalitypulse.com/editions/pulse-2026-09-18-morning</a><br>💼 Also on LinkedIn: <a href=\"https://www.linkedin.com/company/ea-hospitality-pulse/\" rel=\"noopener\">linkedin.com/company/ea-hospitality-pulse/</a><br>— EA Hospitality Pulse | Daily intelligence for city, bush &amp; beach properties</p>"
 },
 {
 ...
 },
 {
  ...
  "edition": "Evening Wrap",
  "editionKey": "evening",
  "summary": "Uganda has been Ebola-free for 86 days and is still banned. Here is the thing this industry keeps measuring wrong.",
  "bodyHtml": "<p><span class=\"meta-line\">🏨 EA HOSPITALITY PULSE — Evening Wrap</span><br><span class=\"meta-line\">📅 Tuesday, 15 September 2026 | 🇰🇪 🇺🇬 🇷🇼 🇹🇿</span></p>\n<p>Uganda has been Ebola-free for 86 days and is still banned. Here is the thing this industry keeps measuring wrong.<br>━━━━━━━━━<br><strong>1️⃣ 86 DAYS EBOLA-FREE. STILL BANNED. THE RISK IS THE MAP, NOT THE VIRUS.</strong></p>\n<p>DRC now stands at <strong>7,200 confirmed cases and 3,475 deaths</strong> on data to 12 September — up <strong>258 cases and 126 deaths in two days</strong> — with <strong>62 of 167 health zones</strong> affected across <strong>seven</strong> provinces <strong>(DRC INSP SitRep N°122/MVEBDB/13/09/2026, via ECDC, page updated 14 September 2026)</strong>. WHO&#x27;s DON617 of <strong>10 September</strong> had it at 6,757 and 3,267 across <strong>six</strong> provinces on 7 September data. North Kivu, the province that touches Uganda and Rwanda, carries the outbreak&#x27;s <strong>highest case fatality ratio at 65.4%</strong> and added <strong>453 confirmed cases in 21 days</strong> <strong>(WHO DON617)</strong>.</p>\n<p>Now the part operators miss. You are tracking your own country&#x27;s case count. What prices your rooms is the granularity of somebody else&#x27;s map.</p>\n<p>Every restriction written in this outbreak was written at <strong>country</strong> resolution. Rwanda denies entry to any foreign national who transited DRC within 30 days <strong>(Ministry of Health, Kigali, 22 May 2026)</strong>. Bahrain, Jordan, Kuwait, Lebanon, Mauritius, Taiwan, Canada and the UAE all named DRC, Uganda and South Sudan as <strong>countries</strong> <strong>(Fragomen, 9 June 2026)</strong>. None of them separates Ituri from Kinshasa, 1,600km apart.</p>\n<p>Uganda has had no confirmed case since <strong>21 June</strong> and was declared outbreak-free on <strong>25 August</strong> <strong>(WHO AFRO)</strong> — <strong>86 days clean</strong> on our arithmetic. It is still named.</p>\n<p><span class=\"sowhat\">🎯 <strong>So what:</strong> stop asking your DMC whether cases are falling. Ask one question instead — <strong>has any ministry moved from country-level to province-level language?</strong> That, not epidemiology, is the recovery signal. Restrictions arrive at the speed of news and leave at the speed of bureaucracy.</span><br><span class=\"tagline\">🏷 City, Bush | 🇺🇬 🇷🇼 | Confirmed (data) · Inference (transmission) | impact:risk</span><br>━━━━━━━━━<br>📻 <strong>STILL TRUE</strong> — Rwanda&#x27;s 22 May notice protects its own MICE book in the same breath as it closes the airport door: <strong>&quot;all activities within Rwanda continue as usual, including conferences, events, tourism.&quot;</strong> Study the drafting.</p>\n<p>💰 <strong>COST PULSE</strong> — EPRA retained all three grades for 15 Sep–14 Oct <strong>(review announced 14 September 2026)</strong>. Diesel landed cost rose <strong>11.86%</strong> and was not passed through. The 8% fuel VAT expires <strong>14 October</strong>, the day the freeze ends.</p>\n<p><span class=\"meta-line\">📅 <strong>WEEK AHEAD</strong> — WHO&#x27;s next biweekly Bundibugyo DON is due on or about <strong>24 September</strong>. Watch whether the province count prints at seven.</span></p>\n<p>🎪 <strong>MICE WATCH</strong> — nothing newly confirmed today. Africa MICE Summit, Mombasa, <strong>1–2 October</strong>, still sits inside the fixable-fuel window.</p>\n<p>🔎 <strong>Blind spots and provenance:</strong> KCAA&#x27;s eAIP and the Kenya Gazette portal again refused our crawler. Both recovered via mirrors on two queries each; nothing tourism-relevant in window. Africa CDC has published no September Epidemic Intelligence Weekly Report — the August edition is still the latest, so our continental read tonight rests on WHO and ECDC alone. For the record, our radar first observed DRC SitRep N°122 at 16:14 EAT today, three days after its 13 September date.</p>\n<p><span class=\"meta-line\">💬 Has an agent asked you about Ebola this month — and did they name a country or a province?</span></p>\n<p>🔗 This edition on the web: <a href=\"https://eahospitalitypulse.com/editions/pulse-2026-09-15-evening.html\" rel=\"noopener\">eahospitalitypulse.com/editions/pulse-2026-09-15-evenin…</a><br>💼 Today&#x27;s Big Read on LinkedIn: <a href=\"https://www.linkedin.com/company/ea-hospitality-pulse/\" rel=\"noopener\">linkedin.com/company/ea-hospitality-pulse/</a><br>— EA Hospitality Pulse | Daily intelligence for city, bush &amp; beach properties</p>"
 },
 {
 ...
 },
 {
  ...
  "edition": "Morning Brief",
  "editionKey": "morning",
  "summary": "1️⃣ FOUR STATISTICS OFFICES. ONE FINDING. YOUR BIGGEST INPUT IS INFLATING UP TO FIVE TIMES FASTER THAN YOUR ROOM RATE.",
  "bodyHtml": "<p>🌅 <strong>EA HOSPITALITY PULSE — MORNING BRIEF</strong><br>Friday 11 September 2026</p>\n<p><strong>1️⃣ FOUR STATISTICS OFFICES. ONE FINDING. YOUR BIGGEST INPUT IS INFLATING UP TO FIVE TIMES FASTER THAN YOUR ROOM RATE.</strong></p>\n<p>All four August CPI releases are now out. Read side by side — which almost nobody does — they say the same thing. <strong>Transport inflation, annual: Kenya 15.7% · Rwanda 24.2% · Tanzania 13.8% · Uganda 9.4%.</strong> Restaurants-and-accommodation in the same releases: <strong>Kenya 3.0% · Tanzania 3.0% · Uganda 2.5% · Rwanda 15.6%</strong> <strong>(KNBS 31 Aug; NISR 10 Sep, urban; NBS TZ 8 Sep; UBOS Aug 2026)</strong>.</p>\n<p>Kenyan transport is running <strong>5.2× the hospitality line</strong>. Tanzania 4.6×. Uganda 3.8×. That second line is effectively the official record of what the trade has managed to charge — so four governments have independently documented the same squeeze.</p>\n<p><span class=\"sowhat\">🎯 <strong>So what:</strong> stop burying transfers in the rate. If road transfers, game drives and airport runs sit inside an inclusive price, you are absorbing a 9–24% input rise inside a 2.5–3.0% price. Break them out as a quoted line with a fuel-adjustment clause — you are contracting 2027 rates <strong>now</strong>.</span><br><span class=\"tagline\">🏷 Bush, Beach, City | 🇰🇪 🇹🇿 🇺🇬 🇷🇼 | Confirmed | impact:cost</span></p>\n<p><strong>2️⃣ AND KENYA IS ABSORBING THE MOST OF ANYONE.</strong></p>\n<p>Subtract headline inflation from the hospitality line and you get the real price of a room: <strong>Kenya −3.6pp · Uganda −1.6pp · Tanzania −1.3pp · Rwanda −0.1pp</strong> <strong>(our calculation from the four releases)</strong>.</p>\n<p><span class=\"sowhat\">🎯 <strong>So what:</strong> if you held Nairobi or coast rate flat this year &quot;to stay competitive&quot;, you did not hold it. You cut it about 3.6% in real terms while your transport bill rose 15.7%. Take that number into the October budget round instead of a gut feel.</span><br><span class=\"tagline\">🏷 City, Beach | 🇰🇪 | Confirmed (inputs) / Our calculation (the spread) | impact:cost</span></p>\n<p><strong>3️⃣ RWANDA HAS LEFT THE REGION&#x27;S PRICE BAND.</strong></p>\n<p>Urban CPI <strong>15.7%</strong> y/y, from 14.5% in July and 9.2% in March — up every month since. Rural 16.0%. Housing and utilities <strong>20.4%</strong>, food 16.3%, core 11.5% <strong>(NISR, 10 Sep 2026)</strong>. Kigali&#x27;s hospitality line is up <strong>15.6%</strong>: Rwandan operators have passed the shock through, Kenyan and Tanzanian ones have not.</p>\n<p><span class=\"sowhat\">🎯 <strong>So what:</strong> a Kigali conference gets dearer against Dar and Kampala every month, and RDB is chasing a US$156m MICE target into that. Selling Rwanda: quote in hard currency, shorten rate-validity windows. Selling Kampala or Dar against Kigali: your relative price has never been better — tell buyers now.</span><br><span class=\"tagline\">🏷 City, Bush | 🇷🇼 | Confirmed | impact:demand</span></p>\n<p><strong>4️⃣ UGANDA IS THE CHEAP SEAT — BUT NOT AT THE PUMP.</strong></p>\n<p>Headline <strong>4.1%</strong>, the region&#x27;s softest hospitality line at <strong>2.5%</strong> (from 3.2%). But petrol <strong>+28.5%</strong>, kerosene <strong>+31.2%</strong>, energy/fuel/utilities <strong>+14.3%</strong>. One easing: international flights <strong>+17.0%</strong>, from 24.1% <strong>(UBOS, Aug 2026)</strong>.</p>\n<p><span class=\"sowhat\">🎯 <strong>So what:</strong> Uganda is the value play and its airfare drag is loosening. Price Bwindi–Queen Elizabeth against Kenyan equivalents in the Q4 deck — but fuel-index vehicle costs.</span><br><span class=\"tagline\">🏷 Bush, City | 🇺🇬 | Confirmed | impact:demand</span></p>\n<p><strong>📒 LEDGER — FOUR CALLS SETTLED, THREE RIGHT</strong><br>✅ Uganda headline ≥4.0% (4.1%). ✅ Kenya ≥6.5% (6.6%). ✅ Rwanda–Tanzania hospitality gap ≥6 points (12.6). ❌ <strong>Wrong:</strong> we said Tanzania would stay at or below 4.0% while Kenya cleared 6.5%. Kenya did; Tanzania printed 4.2% in July and 4.3% in August — it had already breached that ceiling when we wrote the call. Resolved record: <strong>25 correct, 7 incorrect.</strong></p>\n<p><strong>📻 WEEK AHEAD</strong><br>• <strong>EPRA</strong> review closes 14 Sep, effective 15 Sep — the first test of item 1.<br>• <strong>CBK bulletin</strong> due today, not yet posted.<br>• <strong>MICE:</strong> KICC 30 Sep–2 Oct; Africa MICE Summit, Mombasa, 1–2 Oct.</p>\n<p>⚠️ All four figures read from the primary PDFs, not press coverage.</p>\n<p>🔗 This edition on the web: <a href=\"https://eahospitalitypulse.com/editions/pulse-2026-09-11-morning.html\" rel=\"noopener\">eahospitalitypulse.com/editions/pulse-2026-09-11-mornin…</a></p>"
 },
 {
 ...
 },
 {
  ...
  "edition": "Evening Wrap",
  "editionKey": "evening",
  "summary": "1️⃣ EAST AFRICA NO LONGER HAS ONE COST BASE. RWANDA'S HOTEL PRICES ROSE 14.2% THIS YEAR. TANZANIA'S ROSE 2.7%.",
  "bodyHtml": "<p>🌙 <strong>EA HOSPITALITY PULSE — EVENING WRAP</strong><br>Tuesday 8 September 2026</p>\n<p><strong>1️⃣ EAST AFRICA NO LONGER HAS ONE COST BASE. RWANDA&#x27;S HOTEL PRICES ROSE 14.2% THIS YEAR. TANZANIA&#x27;S ROSE 2.7%.</strong></p>\n<p>Same month, same statistical category. In the year to July 2026, restaurants and accommodation services rose <strong>14.2%</strong> in Rwanda <strong>(NISR CPI, released 10 Aug 2026)</strong> and <strong>2.7%</strong> in Tanzania <strong>(NBS, July 2026)</strong>.</p>\n<p>Behind it: Rwandan headline inflation <strong>14.5%</strong> in July — transport +24.2%, housing/electricity/gas/fuels +21.0%, food +13.1%. BNR&#x27;s MPC on 26 Aug put Q2 core at 12.3% and <strong>energy inflation at 45.7%</strong>, then took the policy rate to <strong>8.75%</strong> on 27 Aug — a third straight rise, per Bloomberg a 17-year high. BNR forecasts 13.1% average this year, ~7.9% next, back inside its 2–8% band only in H2 2027.</p>\n<p><strong>What got missed: the currency has stopped paying for it.</strong> Dollar-earning operators used to be carried by the franc — Governor Rwangombwa told Parliament in Nov 2024 it had fallen <strong>16.3%</strong> in FY2023/24. BNR reports it depreciated <strong>0.5%</strong> in Q1 2026, on exports up 63%. So a dollar rate card held flat now buys roughly <strong>14% less</strong> local input than in July 2025. Nothing on the rate sheet changed; the margin moved anyway. <strong>(Our calculation from NISR and BNR figures — inference.)</strong></p>\n<p><span class=\"sowhat\">🎯 <strong>So what — this is a contract problem, not a quarterly one.</strong> RDB&#x27;s 2025 annual report <strong>(28 Apr 2026)</strong> puts MICE at <strong>US$94.7m from 165 events</strong>. Congress business is won on bids placed years ahead and priced in dollars then; Visit Rwanda&#x27;s own commitments run to 2028 and 2030; gorilla product enters brochures 12–18 months out. Compound BNR&#x27;s forecast — 13.1% then 7.9% — and about <strong>22% of cumulative cost inflation is already sitting inside signed prices.</strong></span></p>\n<p>• <strong>KIGALI / MICE:</strong> audit every rate fixed beyond March 2027. Bidding for 2028? Price off BNR&#x27;s forecast path. Energy-escalation clause in anything signed this quarter.<br>• <strong>BUSH (Volcanoes, Nyungwe, Akagera):</strong> exposure is transport +24.2% and energy +21%, not the permit — that&#x27;s a dollar pass-through. Set 2027 brochure rates against those lines.<br>• <strong>BEACH / REGIONAL (Zanzibar, Diani):</strong> a real advantage, and temporary. On 2027 multi-country programmes the Tanzanian and Kenyan legs hold value better. Tell your DMCs now.<br><span class=\"tagline\">🏷 City, Bush, Beach | 🇷🇼 🇹🇿 🇰🇪 | Confirmed (figures) / Inference (the read) | impact:margin</span></p>\n<p><strong>📻 ALSO STANDING</strong><br>• <strong>STILL TRUE</strong> — Uganda&#x27;s standard gorilla permit is still <strong>US$800</strong> <strong>(UWA, current)</strong>. The reported US$1,800 habituation tariff from 1 Jan 2027 remains <strong>unsighted</strong>. Don&#x27;t requote a 2027 habituation leg off it.<br>• <strong>COST PULSE</strong> — EPRA review closes 14 Sep, new prices 15 Sep. Nairobi diesel KSh 217.86/L <strong>(EPRA / Business Daily, 14 Aug)</strong>. The 8% petroleum VAT rate expires 14 Oct.<br>• <strong>WEEK AHEAD</strong> — EU EmpCo green-claims rules apply 27 Sep. Kenya&#x27;s travel-health insurance petition heard 16 Sep. CBK MPC 7 Oct.<br>• <strong>MICE WATCH</strong> — Nairobi&#x27;s autumn calendar firms up: Kenya Transport Summit &amp; Expo, KICC, 30 Sep–2 Oct; Africa Commerce &amp; Industry Summit, Uhuru Gardens, 14–16 Oct; Kasneb International Conference, The Edge, 26–30 Oct, 500+ delegates <strong>(Business Daily, 25 Aug)</strong>.<br>• <strong>BLIND SPOT, DECLARED</strong> — two sources on tonight&#x27;s must-check list were not reached: France&#x27;s Kenya advisory and the Bank of Tanzania monthly review (diarised due today). Both carry to the next slot. Everything else on the sweep was checked.</p>\n<p>🔗 This edition on the web: <a href=\"https://eahospitalitypulse.com/editions/pulse-2026-09-08-evening.html\" rel=\"noopener\">eahospitalitypulse.com/editions/pulse-2026-09-08-evenin…</a><br>💼 Today&#x27;s Big Read on LinkedIn: <a href=\"https://www.linkedin.com/company/ea-hospitality-pulse/\" rel=\"noopener\">linkedin.com/company/ea-hospitality-pulse/</a></p>\n<hr class=\"divider\">"
 },
 {
  "id": "pulse-2026-09-08-morning",
  "date": "2026-09-08",
  "dateDisplay": "Tuesday, 8 September 2026",
  "edition": "Morning Brief",
  "editionKey": "morning",
  "summary": "1️⃣ WHO IS PROVISIONING 2,071 MORE EBOLA BEDS. THAT IS THE REAL CLOCK ON UGANDA'S LEVEL 4.",
  "bodyHtml": "<p>🌅 <strong>EA HOSPITALITY PULSE — MORNING BRIEF</strong><br>Tuesday 8 September 2026</p>\n<p><strong>1️⃣ WHO IS PROVISIONING 2,071 MORE EBOLA BEDS. THAT IS THE REAL CLOCK ON UGANDA&#x27;S LEVEL 4.</strong></p>\n<p>WHO AFRO published field capacity numbers yesterday (7 September). As of 1 September, Ituri Province held 974 beds across 25 facilities in 19 health zones; 1,346 beds across all affected provinces. On 19 May — four days into the response — there was one 9-bed centre. Over 4,000 extra health workers have gone in since.</p>\n<p>Then the forward line: over the next three months the response needs 6,200+ more staff and <strong>2,071 more operational beds</strong>. Ituri runs at ~62% bed occupancy; Bunia&#x27;s centres at 90–100%.</p>\n<p><span class=\"sowhat\">🎯 <strong>So what:</strong> that is a resourcing plan, not an epidemiological forecast — but nobody provisions 2,071 beds for an outbreak they expect to close in October <strong>(our inference, labelled)</strong>. Washington raised Uganda to Level 4 on 17 May over this outbreak, and the PHEIC declared the same day names DRC <strong>and Uganda</strong>. Uganda&#x27;s own outbreak ended 28 July, certified 26 August — yet Uganda sits inside a live PHEIC while the DRC side expands. If your Q4 plan assumes a US downgrade, rebuild it without one.</span></p>\n<p>Worth putting in front of every agent: WHO explicitly <strong>advises against international travel and trade restrictions</strong>, and says border closures are not evidence-based.<br><span class=\"tagline\">🏷 Bush, City | 🇺🇬 🇷🇼 | Confirmed (facts) / Inference (read) | impact:risk</span></p>\n<p><strong>2️⃣ ZANZIBAR ADDED TWO RESORTS ON SATURDAY — AND THE PRESIDENT ASKED THEM TO BUY LOCAL</strong></p>\n<p>President Hussein Ali Mwinyi inaugurated Anaya Hotels &amp; Resorts Zanzibar and Kappa Senses Zanzibar at Pwani Mchangani, North Unguja, on 6 September. Combined investment above <strong>US$52m</strong>; <strong>371 jobs</strong> for Zanzibaris, per the President. Kappa Senses lists 85 villas and suites on its own booking pages.</p>\n<p>Mwinyi said Zanzibar now takes more than 100,000 visitors a month — his figure, not an OCGS release, and we have not yet matched it to the statistics office. He pressed hotels to buy more locally produced goods and open supply chains to local entrepreneurs.</p>\n<p><span class=\"sowhat\">🎯 <strong>So what:</strong> north-east coast stock is thickening at the top end. Treat the procurement message as direction of travel — document your local-sourcing share before someone asks for it.</span><br><span class=\"tagline\">🏷 Beach | 🇹🇿 Zanzibar | Confirmed (The Respondent, Zanzibar, 7 September 2026) | impact:watch</span></p>\n<p><strong>3️⃣ STILL TRUE — THE US HAS TANZANIA AT LEVEL 3. IGNORE THE FEED SAYING LEVEL 1.</strong></p>\n<p>Our radar caught a US State Department feed item at 18:04 EAT last night headed &quot;Tanzania – Level 1&quot;. We opened the rendered page this morning: <strong>&quot;Travel Advisory October 31, 2025 — Tanzania Level 3: Reconsider Travel&quot;</strong>, on unrest, crime, terrorism (highest risk in Mtwara) and targeting of gay and lesbian individuals. Unchanged 312 days. The feed and the page disagree; the page is what State stands behind.</p>\n<p><span class=\"sowhat\">🎯 <strong>So what:</strong> don&#x27;t discount against a rumoured upgrade. When an agent says Tanzania is cleared, send the page.</span><br><span class=\"tagline\">🏷 All segments | 🇹🇿 | Confirmed | impact:risk</span></p>\n<p><strong>📻 RADAR &amp; WEEK AHEAD</strong><br>• <strong>EPRA fuel review</strong> — cycle ends 14 Sep, new prices 15 Sep. Nairobi diesel KSh 217.86/L <strong>(EPRA / Business Daily, 14 Aug)</strong>. The 8% petroleum VAT rate expires 14 Oct.<br>• <strong>UBOS August CPI</strong> due within days — open call: Uganda inflation prints ≥4.0%.<br>• <strong>Kenya Airways</strong> — Habil Waswani acting Group MD &amp; CEO from 15 Sep <strong>(The Star, 1 Sep — diary, not news)</strong>.<br>• <strong>CBK MPC</strong> next meets 7 Oct <strong>(CBK)</strong>.<br>• <strong>MICE live now</strong> — Miss Tourism East Africa, Marriott Kampala, 5–12 Sep. Two dozen contestants: one property&#x27;s group booking, not city compression. Don&#x27;t lift Kampala BAR on it.</p>\n<p>🔗 This edition on the web: <a href=\"https://eahospitalitypulse.com/editions/pulse-2026-09-08-morning.html\" rel=\"noopener\">eahospitalitypulse.com/editions/pulse-2026-09-08-mornin…</a></p>\n<hr class=\"divider\">"
 },
 {
 ...
 },
 {
  ...
  "edition": "Sunday Foresight",
  "editionKey": "foresight",
  "summary": "You are now priced on the quality of your records, not your assets.",
  "bodyHtml": "<p><span class=\"meta-line\">🏨 EA HOSPITALITY PULSE — Sunday Foresight</span><br><span class=\"meta-line\">📅 Sunday, 6 September 2026 | 🇰🇪 🇺🇬 🇹🇿 🇷🇼</span></p>\n<p><strong>You are now priced on the quality of your records, not your assets.</strong></p>\n<p>Five stories, one pattern. Tanzania&#x27;s airlines stay barred from EU skies on the <strong>regulator&#x27;s</strong> file, not any aircraft fault (DG MOVE, 9 Jun 2026). Britain logged Uganda&#x27;s Ebola all-clear on 2 September; Washington has not. In 21 days the EU stops accepting &quot;eco&quot; and starts demanding a certificate. Nine in ten reservation calls produce no guest record. And Kenya would fold the body keeping its arrivals series into the body paid to market the country (The Kenya Times, 21 Aug 2026).</p>\n<p><strong>What everyone is missing.</strong> The reflex is to call this unfair — Tanzanian aircraft are safe, Uganda has no Ebola, the lodges are low-impact. All true, all irrelevant. Buyers have stopped trusting claims and started pricing them, and an unverified claim now trades at a discount. Verification is the cheapest yield lever here, and one of the few not hostage to airlift or a foreign government. It arrives as an absence, not an argument: quietly out of the 2027 brochure, never told why.<br>━━━━━━━━━<br><strong>THE WEEK&#x27;S SIGNALS</strong></p>\n<p><span class=\"item-head\">1️⃣ EXCLUSIVE — BRITAIN LOGGED UGANDA&#x27;S ALL-CLEAR. WASHINGTON HAS NOT.</span><br>FCDO updated its Uganda advice on 2 September 2026 to record WHO declaring the outbreak over on 27 August; still current at 6 Sep, and it advises against travel to no part of Uganda (gov.uk, verified directly; no press coverage found). The US holds Level 4, re-issued 4 June 2026 (travel.state.gov, checked 6 Sep). DRC — the stated ground — has 6,342 confirmed cases to 2 Sep (ECDC, 4 Sep). WHO opposes travel restrictions; ECDC puts EU/EEA risk &quot;very low&quot;.<br><span class=\"sowhat\">🎯 So what: send European agents the gov.uk line dated 2 September. Cheapest reassurance of the quarter.</span><br><span class=\"tagline\">🏷 Bush, City | 🇺🇬 | Confirmed | impact:demand</span></p>\n<p><span class=\"item-head\">2️⃣ 21 DAYS TO EMPCO — THE EVIDENCE BURDEN FINALLY RUNS OUR WAY</span><br>Directive (EU) 2024/825 applies 27 September 2026: generic &quot;eco/green/sustainable&quot; barred without recognised certification, &quot;carbon neutral&quot; via offsets barred outright (EUR-Lex; Sustainable Travel International, 5 Aug 2026).<br><span class=\"sowhat\">🎯 So what: the fine sits with the European party, the evidence with you. Send EU partners a substantiation sheet before the Q4 round; you set the template.</span><br><span class=\"tagline\">🏷 Bush, Beach, City | 🇰🇪 🇺🇬 🇹🇿 🇷🇼 | Confirmed / Inference (ours) | impact:strategy</span></p>\n<p><span class=\"item-head\">3️⃣ 92.2% OF RESERVATION CALLS PRODUCE NO RECORD AT ALL</span><br>Revinate mystery-shop, 308 calls to 135 luxury and upscale properties (via Hospitality Net, 4 Sep 2026). North American sample; the failure is not.<br><span class=\"sowhat\">🎯 So what: every other record here is written by someone else. This one you write, and it is free.</span><br><span class=\"tagline\">🏷 City, Bush, Beach | 🌍→EA | Confirmed / Inference (ours) | impact:cost</span><br>━━━━━━━━━<br><span class=\"meta-line\">📡 30/90-DAY DEMAND CALENDAR</span></p>\n<p>🇰🇪 14 Sep — EPRA fuel review; diesel held KSh 217.86/L to then. Refuse supplier surcharges until it lands.<br>🇰🇪 15 Sep — Habil Waswani becomes acting KQ Group MD/CEO, Kamal exits 30 Sep (The Star, 1 Sep 2026). Paper Q4 block-space deals this month.<br>🇰🇪 16 Sep — hearing on Gazette Notice 11492, the US$50,000 travel-insurance rule. Keep it out of agent packs.<br>🇪🇺 27 Sep — EmpCo applies. Evidence, replace or delete every green word by 26 Sep.<br>🇺🇬🇷🇼 18 Nov — Uganda Airlines Entebbe–Kigali daily (announced 5 Aug 2026). Rebuild Bwindi–Volcanoes on it.<br>🇹🇿 30 Nov — Ethiopian daily Addis–Kilimanjaro–Zanzibar (filed 4 Sep 2026). Hold peak beach rate.</p>\n<p>If verification is the cheapest thing you can buy, why is it the last line in your budget?</p>\n<p>🔗 This edition on the web: <a href=\"https://eahospitalitypulse.com/editions/foresight-2026-09-06.html\" rel=\"noopener\">eahospitalitypulse.com/editions/foresight-2026-09-06.html</a><br>💼 This week&#x27;s Big Read on LinkedIn: <a href=\"https://www.linkedin.com/company/ea-hospitality-pulse/\" rel=\"noopener\">linkedin.com/company/ea-hospitality-pulse/</a><br>— EA Hospitality Pulse | Daily intelligence for city, bush &amp; beach properties</p>"
 },
 {
 ...
 },
 {
  ...
  "edition": "Morning Brief",
  "editionKey": "morning",
  "summary": "The JKIA strike is over. Read the agreement, not the headline — it sets its own expiry date, and it falls in three weeks.",
  "bodyHtml": "<p><span class=\"meta-line\">🏨 EA HOSPITALITY PULSE — Morning Brief</span><br><span class=\"meta-line\">📅 Tuesday, 1 September 2026 | 🇰🇪 🇺🇬 🇹🇿 🇷🇼</span></p>\n<p>The JKIA strike is over. Read the agreement, not the headline — it sets its own expiry date, and it falls in three weeks.<br>━━━━━━━━━<br><span class=\"item-head\">1️⃣ KAWU CALLS OFF THE STRIKE. THE DEAL HAS A THREE-WEEK FUSE.</span></p>\n<p>The Kenya Aviation Workers Union signed a return-to-work agreement this morning with KCAA, the Kenya Airports Authority and Jambojet, after a meeting chaired by Transport CS Davis Chirchir. Members were sent back immediately; agency fees held by KAA go to the union at once (KBC, 1 September, 07:36 EAT).</p>\n<p>Now the fine print. The Salaries and Remuneration Commission withdrew its 28 July guidance and issued fresh parameters on 1 September — and <strong>the union recorded reservations about those parameters inside the agreement itself</strong>. The 20 July strike-notice grievances go to arbitration under the PS for Aviation <strong>within three weeks — by roughly 22 September</strong>. The Jambojet recognition dispute is parked with a court.</p>\n<p><span class=\"sowhat\">🎯 So what: Called off is not recovered. KBC reports passengers at JKIA since Monday; aircraft and crew are out of position, so today&#x27;s arrivals are harder to plan than yesterday&#x27;s. Hold rooms through tonight. Then diarise 22 September — February&#x27;s settlement held five months, July&#x27;s held one, and this one names its own next flashpoint.</span><br><span class=\"tagline\">🏷 City, Bush, Beach | Kenya | Confirmed | impact:risk</span></p>\n<p><span class=\"item-head\">2️⃣ THE FCDO DID NOT DOWNGRADE KENYA. IT ADDED AN AIRPORT NOTE.</span></p>\n<p>&quot;UK warns its citizens against travel to Kenya,&quot; ran the local headline yesterday (The Kenya Times, 31 August). We read the page. What the FCDO added on 31 August is one operational paragraph: industrial action is affecting airport operations, check with your airline. The advise-against-all-travel geography is unchanged and years old — Mandera; Tarbaj and Wajir East (except Wajir Town) and Wajir within 60km of Somalia; Garissa except Garissa Town, Lagdera and specified Balambala areas; Lamu except Lamu and Manda Islands. Ground: terrorism from Somalia-based groups (gov.uk, updated 31 August).</p>\n<p><span class=\"sowhat\">🎯 So what: Nairobi, Mombasa, Diani, Watamu, the Mara, Amboseli and Laikipia are not in that list and never have been. When an agent forwards you the headline, don&#x27;t reassure — quote the counties back. Precision closes the booking.</span><br><span class=\"tagline\">🏷 City, Bush, Beach | Kenya | Confirmed | impact:demand</span></p>\n<p><span class=\"item-head\">3️⃣ KENYA 6.6%, UGANDA 4.1% — AND KENYAN DIESEL FELL.</span></p>\n<p>Kenya&#x27;s annual inflation rose to 6.6% from 6.5%: food +9.0%, <strong>transport +15.7%</strong>, housing and utilities +3.6% (KNBS, 31 August). Uganda printed 4.1% from 4.0%, on food crops moving to 2.1% from 1.6% (UBOS, 31 August).</p>\n<p><span class=\"sowhat\">🎯 So what: Kenyan transport inflation ran at 15.7% in a month when <strong>average diesel fell 2.2% to KSh 219.04/litre</strong> (KNBS). The pump isn&#x27;t driving it — fares and margin are. Next time a transfer operator hands you a fuel surcharge, the fuel number is on your side of the table.</span><br><span class=\"tagline\">🏷 City, Bush | Kenya, Uganda | Confirmed | impact:cost</span><br>━━━━━━━━━<br><span class=\"meta-line\">📡 RADAR</span><br>• KAWU arbitration deadline ~22 September — diarise it<br>• Kwita Izina, Kinigi — ceremony 4 Sept, exhibition to 8 Sept (RDB)<br>• Miss Tourism East Africa finals, Kampala — 5–12 Sept<br>• CBK weekly bulletin Friday; EPRA fuel review ~14 Sept</p>\n<p><span class=\"meta-line\">💬 Our ledger called settlement by 6 September. It landed on the 1st. The harder question is whether 22 September holds.</span></p>\n<p>🔗 This edition on the web: <a href=\"https://eahospitalitypulse.com/editions/pulse-2026-09-01-morning.html\" rel=\"noopener\">eahospitalitypulse.com/editions/pulse-2026-09-01-mornin…</a><br>— EA Hospitality Pulse | Daily intelligence for city, bush &amp; beach properties</p>"
 },
 {
 ...
 },
 {
  ...
  "edition": "Morning Brief",
  "editionKey": "morning",
  "summary": "JKIA is delayed, not closed — and that distinction is worth money to you today.",
  "bodyHtml": "<p><span class=\"meta-line\">🏨 EA HOSPITALITY PULSE — Morning Brief</span><br><span class=\"meta-line\">📅 Monday, 31 August 2026 | 🇰🇪 🇺🇬 🇹🇿 🇷🇼</span></p>\n<p>JKIA is delayed, not closed — and that distinction is worth money to you today.<br>━━━━━━━━━<br><span class=\"item-head\">1️⃣ JKIA STRIKE ENTERS DAY TWO. 30% OF KQ FLIGHTS LEFT BY 2PM.</span></p>\n<p>Kenya Aviation Workers Union members downed tools at the Kenya Airports Authority, KCAA and Jambojet on Sunday 30 August. Kenya Airways reported that only <strong>30% of its scheduled flights had departed by 14:00 EAT</strong>, with those that went averaging two-to-three-hour delays and later departures running beyond three (KQ customer update via KATA, 30 August). Disruption continued into this morning. KAA confirms delays but reports no closure — flights are operating.</p>\n<p><span class=\"sowhat\">🎯 So what: Your exposure is <strong>missed onward connections</strong>, not cancellations. Any guest landing at JKIA today with a same-day Wilson or coastal leg to the Mara, Kilimanjaro or Zanzibar should be treated as at risk. Hold their room rather than releasing it, ring the DMC before the guest rings you, and offer the date change before anyone asks for a refund.</span><br><span class=\"tagline\">🏷 City, Bush, Beach | Kenya | Confirmed | impact:risk</span></p>\n<p><span class=\"item-head\">2️⃣ THIS IS THE THIRD ROUND OF THE SAME DISPUTE SINCE FEBRUARY.</span></p>\n<p>Treat this as a pattern, not an accident. The same CBA dispute shut JKIA for two days on 16–17 February 2026 — Jambojet flew just 25% of its schedule, cancelled over 40 flights and disrupted 5,000+ passengers (Jambojet CEO Karanja Ndegwa, Capital FM, 19 February). A second round was enjoined by the High Court on 23 July and suspended on 27 July under a return-to-work deal. KAWU has now lifted that suspension, saying the agencies never honoured it.</p>\n<p><span class=\"sowhat\">🎯 So what: February&#x27;s round ended on day two via mediation led by Transport CS Davis Chirchir. That is the base rate to plan against — expect resolution in days, not weeks, and don&#x27;t panic-discount Q4. But stop treating JKIA reliability as a given when you build September–December itineraries: build a buffer night in Nairobi into long-haul arrivals rather than selling same-day bush connections.</span><br><span class=\"tagline\">🏷 City, Bush | Kenya | Confirmed | impact:watch</span></p>\n<p><span class=\"item-head\">3️⃣ STILL TRUE — KENYA IS STILL LEVEL 2. THIS IS NOT A RISK EVENT.</span></p>\n<p>We checked travel.state.gov this morning: Kenya remains <strong>Level 2, Exercise Increased Caution, date issued 28 July 2026</strong> — unchanged. No government has moved on Kenya because of the strike.</p>\n<p><span class=\"sowhat\">🎯 So what: When an agent asks whether Kenya is &quot;having problems&quot;, answer precisely. A labour delay at an airport is an operations event; nothing about the country&#x27;s risk posture has changed. Properties that blur the two hand a booking to the one that doesn&#x27;t.</span><br><span class=\"tagline\">🏷 City, Bush, Beach | Kenya | Confirmed | impact:demand</span><br>━━━━━━━━━<br><span class=\"meta-line\">📡 RADAR</span><br>• KNBS August CPI due on its end-of-month pattern — July printed 6.5% (KNBS, July 2026)<br>• Kwita Izina, Kinigi — ceremony 4 September; exhibition runs 28 Aug–8 Sep (RDB)<br>• Miss Tourism East Africa finals, Kampala — 5–12 September<br>• Uganda Airlines starts daily Entebbe–Kigali 18 November, Accra 27 October (announced 5 August)</p>\n<p><span class=\"meta-line\">💬 If a guest misses a Mara connection today, who eats the cost at your property — you, the DMC or the airline? Worth knowing before lunchtime.</span></p>\n<p>🔗 This edition on the web: <a href=\"https://eahospitalitypulse.com/editions/pulse-2026-08-31-morning.html\" rel=\"noopener\">eahospitalitypulse.com/editions/pulse-2026-08-31-mornin…</a><br>— EA Hospitality Pulse | Daily intelligence for city, bush &amp; beach properties</p>"
 },
 {
  "id": "pulse-2026-08-28-midday",
  "date": "2026-08-28",
  "dateDisplay": "Friday, 28 August 2026",
  "edition": "Midday Pulse",
  "editionKey": "midday",
  "summary": "1️⃣ THE MAINLAND JUST OVERTOOK ZANZIBAR ON YIELD",
 ...
 },
 {
  ...
  "edition": "Evening Wrap",
  "editionKey": "evening",
  "summary": "Uganda holds the WHO's certificate. Washington's page hasn't moved in 84 days — and the reason is written in Washington's own advisory history.",
  "bodyHtml": "<p><span class=\"meta-line\">🏨 <strong>EA HOSPITALITY PULSE — Evening Wrap</strong></span><br><span class=\"meta-line\">📅 Thursday, 27 August 2026 | 🇰🇪 🇺🇬 🇹🇿 🇷🇼</span></p>\n<p>Uganda holds the WHO&#x27;s certificate. Washington&#x27;s page hasn&#x27;t moved in 84 days — and the reason is written in Washington&#x27;s own advisory history.<br>━━━━━━━━━<br><strong>1️⃣ 🇺🇬 WHO CERTIFIES UGANDA EBOLA-FREE — AND THE US LEVEL 4 STILL DOESN&#x27;T BUDGE</strong></p>\n<p>The WHO confirmed this week that Uganda has cleared the 42-day monitoring period with no new transmission (Al Jazeera, 26 Aug 2026). Total: <strong>20 confirmed infections, two deaths</strong>, last case 21 June. Kampala had declared it over on 28 July, counting from an earlier date — hence the month&#x27;s gap. Permanent Secretary Diana Atwine: &quot;Unless they have other reasons, they should definitely lift the restrictions off the country.&quot;</p>\n<p><strong>We read travel.state.gov directly this afternoon.</strong> Uganda remains <strong>Level 4 — Do Not Travel</strong>, issued <strong>4 June 2026</strong>. Unchanged for 84 days.</p>\n<p><strong>What everyone is missing:</strong> State&#x27;s own advisory history says the 17 May move to Level 4 was made <strong>&quot;due to the Ebola Bundibugyo Virus Disease outbreak in Ituri Province in the DRC.&quot;</strong> The trigger was never Ugandan epidemiology. Ituri is now the epicentre of the largest Ebola outbreak ever recorded — <strong>5,656 confirmed cases, 2,715 deaths as at 25 August</strong>, still climbing (DRC government data cited by ECDC, via Al Jazeera, 26 Aug 2026). Kampala cannot clear a condition set 877km away.</p>\n<p><span class=\"sowhat\">🎯 <strong>So what:</strong> stop treating the Level 4 as a countdown. Contract 2027 as though it holds, reweight allocation towards UK, EU, Gulf and EAC trade, and ask your US agents this week what their insurers do with a Level 4 destination.</span><br><span class=\"tagline\">🏷 City/Bush | UG | Confirmed (WHO; advisory read directly 27 Aug) / Inference (EA read) | impact:risk</span><br>━━━━━━━━━<br><strong>2️⃣ 🇺🇬 KAMPALA SPENDS THE ALL-CLEAR ON CAPACITY, NOT MARKETING</strong></p>\n<p>Uganda took delivery of the antibody treatment <strong>MBP134</strong> at Kajjansi on 26 August (Uganda Ministry of Health, 26 Aug 2026) and a <strong>Shs 1.87bn</strong> mobile laboratory (Daily Monitor, 27 Aug 2026). It is also opening two further treatment centres inside the DRC — four in total — and supporting labs at Aru and Kasenyi in Ituri (Al Jazeera, 26 Aug 2026). Right public health. Commercially, it hard-wires the Uganda–Ituri association into the very documents advisory desks read.</p>\n<p><span class=\"sowhat\">🎯 <strong>So what:</strong> send agents the arithmetic — 20 against 5,656 — not adjectives.</span><br><span class=\"tagline\">🏷 City/Bush | UG | Confirmed | impact:watch</span><br>━━━━━━━━━<br><strong>3️⃣ 🌍 H1 2026: THE WORLD&#x27;S HOTELS GREW ON RATE, NOT HEADS</strong></p>\n<p>Global RevPAR ran <strong>3–4% for the major chains in H1 2026</strong>, but occupancy plateaued across most markets — the growth came from ADR (Hospitality Net, 27 Aug 2026).</p>\n<p><span class=\"sowhat\">🎯 <strong>So what:</strong> if Uganda volumes disappoint this quarter, discounting is the wrong lever. Hold BAR, cut the length-of-stay minimum instead.</span><br><span class=\"tagline\">🏷 City/Bush/Beach | KE·UG·TZ·ZNZ·RW | Reported | impact:watch</span><br>━━━━━━━━━<br>🟢 <strong>STILL TRUE</strong> — Kenya US Level 2, Uganda 4, Tanzania &amp; Zanzibar 3, Rwanda 3 (advisory board, verified 12 Aug 2026; Uganda re-verified directly today, 27 Aug). Nothing eased.</p>\n<p>💲 <strong>COST PULSE</strong> — Nairobi diesel KSh 217.86/L, super KSh 214.03/L (EPRA cycle 15 Aug–14 Sep; EPRA notice / Business Daily, 14 Aug 2026). Refuse any supplier fuel surcharge this cycle.</p>\n<p><span class=\"meta-line\">📅 <strong>WEEK AHEAD</strong> — <strong>28 Aug</strong> WTA Africa Gala, Zanzibar · <strong>28 Aug</strong> CBK weekly bulletin · <strong>28 Aug–8 Sep</strong> Kwita Izina exhibition, Musanze · <strong>29–31 Aug</strong> KNBS &amp; UBOS CPI prints · <strong>4 Sep</strong> Kwita Izina, Kinigi · <strong>~14 Sep</strong> EPRA fuel review.</span></p>\n<p><span class=\"meta-line\">💬 If the Level 4 is still there next March, does your 2027 plan survive it?</span></p>\n<p>🔗 This edition on the web: <a href=\"https://eahospitalitypulse.com/editions/pulse-2026-08-27-evening.html\" rel=\"noopener\">eahospitalitypulse.com/editions/pulse-2026-08-27-evenin…</a><br>💼 Today&#x27;s Big Read on LinkedIn: <a href=\"https://www.linkedin.com/company/ea-hospitality-pulse/\" rel=\"noopener\">linkedin.com/company/ea-hospitality-pulse/</a><br>— EA Hospitality Pulse | Daily intelligence for city, bush &amp; beach properties</p>"
 },
 {
  "id": "pulse-2026-08-26-evening",
  "date": "2026-08-26",
  "dateDisplay": "Wednesday, 26 August 2026",
  "edition": "Evening Wrap",
  "editionKey": "evening",
  "summary": "Google searches now end with zero clicks 68% of the time. For a safari sale built on weeks of research, that is where your guest quietly disappears.",
  "bodyHtml": "<p><span class=\"meta-line\">🏨 <strong>EA HOSPITALITY PULSE — Evening Wrap</strong></span><br><span class=\"meta-line\">📅 Wednesday, 26 August 2026 | 🇰🇪 🇺🇬 🇹🇿 🇷🇼</span></p>\n<p>Google searches now end with zero clicks 68% of the time. For a safari sale built on weeks of research, that is where your guest quietly disappears.<br>━━━━━━━━━<br><strong>1️⃣ 🌍 THE SEARCH BOX STOPPED SENDING PEOPLE — AND A SAFARI IS THE MOST RESEARCHED PURCHASE IN TRAVEL</strong></p>\n<p>US Google searches ended <strong>without a single click 68.01%</strong> of the time between January and April 2026, up from <strong>60.45%</strong> in 2024 (SparkToro, on Similarweb clickstream data, 9 Jun 2026). AI Overviews now appear on <strong>more than 20%</strong> of searches; where one appears, click-through falls by close to <strong>60%</strong>.</p>\n<p>Booking Holdings confirmed the mechanism. CEO Glenn Fogel told analysts Google&#x27;s display changes &quot;definitely put some pressure on SEO&quot; — while direct traffic, mid-60% range, &quot;hasn&#x27;t gone down at all&quot; (Skift, 4 Aug 2026).</p>\n<p><strong>Read that split properly.</strong> People who already know the name still arrive. People who don&#x27;t, no longer do. Booking loses one channel. A 14-tent camp in the Mara loses its <strong>only</strong> one.</p>\n<p><strong>What everyone is missing:</strong> this never appears in your booking report. A safari is bought after weeks of informational queries — when the crossing happens, what a gorilla permit costs, is Zanzibar safe, Kenya or Tanzania. Those are exactly the questions a generated answer settles on the page. The loss lands in your agent&#x27;s enquiry inbox, three to six months upstream of your pick-up.</p>\n<p><span class=\"sowhat\">🎯 <strong>So what:</strong> publish citable facts, not adjectives. Models quote dated, checkable statements — a fee table with its effective date, exact crossing windows, transfer times in minutes. Then ask your three largest agents for <strong>enquiry</strong> counts, not bookings. That is the early-warning line.</span><br><span class=\"tagline\">🏷 City/Bush/Beach | KE·UG·TZ·ZNZ·RW | Confirmed (search data) / Inference (EA read) | impact:watch</span><br>━━━━━━━━━<br>🟢 <strong>STILL TRUE</strong> — the US State Department re-issued four advisories today, 26 Aug (Israel L3, West Bank L3, Gaza L4, Albania L2), each stating no change in level. No EA advisory moved: Kenya US Level 2, Uganda 4, Tanzania &amp; Zanzibar 3, Rwanda 3 (advisory board, verified 12 Aug 2026). Don&#x27;t discount against a fear you can&#x27;t name.</p>\n<p>💲 <strong>COST PULSE</strong> — Nairobi diesel KSh 217.86/L, super KSh 214.03/L (EPRA cycle 15 Aug–14 Sep; EPRA notice / Business Daily, 14 Aug 2026). Diesel sits ~KSh 14.28 above the KSh 203.58 landed costs implied. Refuse any supplier fuel surcharge this cycle.</p>\n<p><span class=\"meta-line\">📅 <strong>WEEK AHEAD</strong> — <strong>26–28 Aug</strong> Africa Global PR Week, Nairobi · <strong>27 Aug</strong> Smart Green Village ground-breaking, Musanze · <strong>28 Aug</strong> WTA Africa Gala, Diamonds Bijoux, Zanzibar · <strong>28 Aug–8 Sep</strong> Kwita Izina exhibition · <strong>4 Sep</strong> Kwita Izina, Kinigi · <strong>~14 Sep</strong> EPRA fuel review.</span></p>\n<p><span class=\"meta-line\">💬 When did you last ask an agent how many <strong>enquiries</strong> they got — not how many bookings they sent?</span></p>\n<p>🔗 This edition on the web: <a href=\"https://eahospitalitypulse.com/editions/pulse-2026-08-26-evening.html\" rel=\"noopener\">eahospitalitypulse.com/editions/pulse-2026-08-26-evenin…</a><br>💼 Today&#x27;s Big Read on LinkedIn: <a href=\"https://www.linkedin.com/company/ea-hospitality-pulse/\" rel=\"noopener\">linkedin.com/company/ea-hospitality-pulse/</a><br>— EA Hospitality Pulse | Daily intelligence for city, bush &amp; beach properties</p>"
 },
 {
  "id": "pulse-2026-08-25-evening",
  "date": "2026-08-25",
  "dateDisplay": "Tuesday, 25 August 2026",
  "edition": "Evening Wrap",
  "editionKey": "evening",
  "summary": "The cleanest natural experiment in hotel pricing we have seen this year was published today. It is American, and it is about you.",
  "bodyHtml": "<p><span class=\"meta-line\">🏨 <strong>EA HOSPITALITY PULSE — Evening Wrap</strong></span><br><span class=\"meta-line\">📅 Tuesday, 25 August 2026 | 🇰🇪 🇺🇬 🇹🇿 🇷🇼</span></p>\n<p>The cleanest natural experiment in hotel pricing we have seen this year was published today. It is American, and it is about you.<br>━━━━━━━━━<br><strong>1️⃣ 📉 THE DANGEROUS NUMBER ISN&#x27;T −9.3%. IT&#x27;S +4.6 POINTS.</strong></p>\n<p>US H1 2026 chain-scale data, out today: <strong>luxury</strong> hotels lifted ADR <strong>10.1%</strong> (USD 302.97 → 333.49) <strong>and</strong> occupancy <strong>3.4 points</strong>, for RevPAR <strong>+15.9%</strong>. <strong>Economy</strong> hotels filled more rooms than any other chain scale — occupancy up <strong>4.6 points</strong>, 63.9% → 68.5% — while ADR fell <strong>9.3%</strong> (USD 120.34 → 109.11). RevPAR: <strong>−2.7%</strong> (HotelData.com H1 2026 Profitability Report, via Hospitality Net, 25 Aug 2026).</p>\n<p>Read what that says. Economy&#x27;s problem was never demand. <strong>The discounting worked.</strong> It filled the house and lost money anyway, because every incremental occupied room carries variable cost.</p>\n<p><strong>The part nobody transfers to us:</strong> that arithmetic is crueller here. The marginal cost of an occupied bed-night in a bush camp — diesel for game drives and generators, trucked water, staff ratios, supply runs — is a multiple of a US limited-service room turn. Nairobi diesel is <strong>KSh 217.86/L</strong> this cycle, about <strong>KSh 14.28 above the KSh 203.58</strong> landed costs implied (EPRA / Business Daily, 14 Aug 2026). A Mara camp discounting to fill climbs a steeper cliff than a roadside hotel in Ohio.</p>\n<p>Kenya already runs the economy playbook at national scale. Per TRI&#x27;s own 2025 report, earnings per arrival rose <strong>3.13%</strong> to KSh 189,004 against the report&#x27;s own <strong>4.075%</strong> inflation assumption — real yield per visitor down roughly <strong>0.9%</strong>. More visitors, less real money each.</p>\n<p><span class=\"sowhat\">🎯 <strong>So what:</strong> the divide is not luxury versus budget. It is <strong>substitutable versus not</strong>. Run the test on your own property — name what a guest cannot get 400 metres away. If the honest list is empty, you have economy pricing power on a premium cost base. That is the worst seat in the industry.</span><br><span class=\"tagline\">🏷 City/Bush/Beach | KE·UG·TZ·ZNZ·RW | Confirmed (US data) / Inference (EA read) | impact:watch</span><br>━━━━━━━━━<br>🟢 <strong>STILL TRUE</strong> — no EA advisory level moved on the radar today. Kenya US Level 2, Uganda 4, Tanzania &amp; Zanzibar 3, Rwanda 3 (advisory board, verified 12 Aug 2026).</p>\n<p>💲 <strong>COST PULSE</strong> — Nairobi diesel KSh 217.86/L, super KSh 214.03/L (EPRA, cycle 15 Aug–14 Sep). Inflation: KE 6.4% · TZ 4.0% · UG 3.7% · RW 13.6% urban.</p>\n<p><span class=\"meta-line\">📅 <strong>WEEK AHEAD</strong> — <strong>26–28 Aug</strong> Africa Global PR Week, Nairobi · <strong>28 Aug</strong> WTA Gala, Zanzibar · <strong>4 Sep</strong> Kwita Izina, Musanze · <strong>~14 Sep</strong> EPRA fuel review.</span></p>\n<p><span class=\"meta-line\">💬 Name one thing on your property a competitor could not copy by Christmas.</span></p>\n<p>🔗 This edition on the web: <a href=\"https://eahospitalitypulse.com/editions/pulse-2026-08-25-evening.html\" rel=\"noopener\">eahospitalitypulse.com/editions/pulse-2026-08-25-evenin…</a><br>💼 Today&#x27;s Big Read on LinkedIn: <a href=\"https://www.linkedin.com/company/ea-hospitality-pulse/\" rel=\"noopener\">linkedin.com/company/ea-hospitality-pulse/</a><br>— EA Hospitality Pulse | Daily intelligence for city, bush &amp; beach properties</p>"
 },
 {
  "id": "pulse-2026-08-25-midday",
  "date": "2026-08-25",
  "dateDisplay": "Tuesday, 25 August 2026",
  "edition": "Midday Pulse",
  "editionKey": "midday",
  "summary": "1️⃣ 🇰🇪 ⚖️ A COURT SUSPENDED KENYA'S US$50,000 TOURIST INSURANCE RULE ON 21 AUGUST — THE TRADE ONLY NOTICED YESTERDAY",
  "bodyHtml": "<p><strong>1️⃣ 🇰🇪 ⚖️ A COURT SUSPENDED KENYA&#x27;S US$50,000 TOURIST INSURANCE RULE ON 21 AUGUST — THE TRADE ONLY NOTICED YESTERDAY</strong></p>\n<p>The High Court at Marsabit issued conservatory orders on <strong>21 August 2026</strong> halting <strong>Gazette Notice No. 11492</strong>, the travel-health insurance rule gazetted by Health CS Aden Duale on 30 July. Justice Francis Rayola Olel certified it urgent; heard inter partes <strong>16 September 2026</strong> (Kahawatungu / The Standard, 24–25 Aug 2026).</p>\n<p>Petitioners argue entry conditions belong to Interior and Immigration, not Health; that it encroaches on the IRA; and that uploading health data via the eTA breaches Article 31 privacy. It is the <strong>second</strong> case filed — a COFEK challenge runs alongside.</p>\n<p><strong>Correction, ours:</strong> on 24 Aug we called this &quot;under challenge, mention 29 Sep&quot;. It had been suspended three days earlier; 29 Sep belongs to the other case. Tracker fixed.</p>\n<p><span class=\"sowhat\">🎯 <strong>So what:</strong> that cost line is judicially frozen, not dormant. Quote high-season packages without it, but do <strong>not</strong> delete the clause from 2027 contracts — 16 Sep can restore it. 🏷 All · KE · Confirmed</span></p>\n<p><strong>2️⃣ 🇰🇪 ✈️ NINETY DEAD AIRCRAFT ARE DIVERTING FLIGHTS AT WILSON — YOUR SAFARI FEEDER HUB</strong></p>\n<p>An Auditor-General audit finds <strong>90 grounded aircraft</strong> occupying apron space at Wilson, &quot;forcing flight diversions&quot; and costing KAA revenue (Nancy Gathungu, via Business Daily, 23 Aug 2026). Wilson handled <strong>83,855 movements</strong> in the year to June 2025 vs 65,512 in 2021 — up 28%. About five aircraft have been auctioned since 2024, when the count was 70; it is now 90. Some traffic is pushed to Orly Airpark near Kiserian. The audit also flags no proper terminal — a corridor holding 50 passengers — and incomplete screening.</p>\n<p>On 24 Aug KCAA acting DG <strong>Nicholas Bondo</strong> said training schools should move off Wilson, with landing and parking charges under discussion (People Daily, 24 Aug 2026).</p>\n<p><strong>Read the mechanism correctly:</strong> the constraint is <strong>apron parking</strong>, not runway slots — and flight schools are not the dead metal. Relocation is a proposal with no date.</p>\n<p><span class=\"sowhat\">🎯 <strong>So what:</strong> bush properties — treat Wilson diversion risk as live for peak season. Pad transfer windows, confirm your charter&#x27;s parking arrangement, and brief guests on the terminal reality before arrival. 🏷 Bush/City · KE · Confirmed</span></p>\n<p><strong>3️⃣ 🇰🇪 📊 THAT KSh 564 BILLION FIGURE — READ IT PROPERLY</strong></p>\n<p>CS Rebecca Miano&#x27;s ministry reports <strong>KSh 564bn in FY2025/26, up from KSh 224bn in FY2021/22</strong> (The Standard, 21–22 Aug 2026) — a <strong>four-year</strong> rise, not a recent doubling.</p>\n<p><strong>And the visitor number is misquoted.</strong> The 7.91m headline is <strong>total tourism activity</strong>: <strong>2.76m international arrivals plus 5.15m domestic bed-nights</strong>. A bed-night is not a visitor. &quot;7.9 million visitors&quot; inflates the addressable market roughly threefold.</p>\n<p><span class=\"sowhat\">🎯 <strong>So what:</strong> if a lender or JV partner quotes 7.9m visitors at you this week, correct it. Your international denominator is 2.76m. 🏷 All · KE · Confirmed</span></p>\n<p>🟢 <strong>STILL TRUE</strong> — no EA advisory level moved. Kenya US Level 2, Uganda 4, Tanzania &amp; Zanzibar 3, Rwanda 3.</p>\n<p>💲 <strong>COST PULSE</strong> — Nairobi diesel KSh 217.86/L, super KSh 214.03/L (EPRA, 14 Aug). Inflation: KE 6.4% · TZ 4.0% · UG 3.7% · RW 13.6%.</p>\n<p><span class=\"meta-line\">📅 <strong>WEEK AHEAD</strong> — <strong>26–28 Aug</strong> Africa Global PR Week, Nairobi · <strong>28 Aug</strong> WTA Gala, Zanzibar · <strong>16 Sep</strong> insurance case.</span></p>\n<p><span class=\"meta-line\">📡 <strong>RADAR</strong> — 636 in-window observations to 09:51 EAT; feed live. Uganda MoH posted cross-border Ebola collaboration with DRC (24 Aug) — no entry-rule change.</span></p>\n<p>🔗 This edition on the web: <a href=\"https://eahospitalitypulse.com/editions/pulse-2026-08-25-midday.html\" rel=\"noopener\">eahospitalitypulse.com/editions/pulse-2026-08-25-midday…</a><br>— EA Hospitality Pulse | Daily intelligence for city, bush &amp; beach properties</p>"
 },
 {
  "id": "pulse-2026-08-25-special",
  "date": "2026-08-25",
  "dateDisplay": "Tuesday, 25 August 2026",
  "edition": "Morning Brief",
  "editionKey": "morning",
  "summary": "📕 SPECIAL — WE READ KENYA'S 2025 TOURISM REPORT LINE BY LINE. PART 1 OF 3: THE HEADLINE ISN'T THE STORY.",
  "bodyHtml": "<p><strong>📕 SPECIAL — WE READ KENYA&#x27;S 2025 TOURISM REPORT LINE BY LINE. PART 1 OF 3: THE HEADLINE ISN&#x27;T THE STORY.</strong></p>\n<p>The Tourism Research Institute&#x27;s Annual Tourism Sector Performance Report 2025 (90pp, v8, dated 4 June 2026) is public. The press reported it in April. Almost every number in circulation is wrong.</p>\n<p><strong>What the document actually says:</strong> international arrivals <strong>2,652,540</strong> in 2025, from 2,474,551 in 2024 — <strong>+7.2%</strong>. Earnings <strong>KSh 501.34bn</strong>, from KSh 453.50bn — <strong>+10.55%</strong>.</p>\n<p><strong>What the press reported:</strong> &quot;7.9 million visitors&quot; · &quot;2.7 million, +9%&quot; · &quot;2.55 million, +6.2%&quot; · &quot;Africa 47% of arrivals&quot;. None of those match the report. Africa is <strong>37.59%</strong> (997,188). The 7.9m figure adds domestic bed-nights to international arrivals — a bed-night is not a visitor.</p>\n<p><strong>Four things nobody has reported.</strong></p>\n<p><strong>1️⃣ A tenth of your &quot;international&quot; arrivals are Kenyans coming home.</strong> The report states plainly that the 2,652,540 &quot;includes 250,603 Kenyan diaspora arrivals&quot; (p.22). That is <strong>9.45%</strong> of the headline. Strip it out and genuine foreign arrivals are <strong>2,401,937</strong>, growing <strong>6.6%</strong>, not 7.2%. Diaspora itself grew 13.4% — faster than the market.</p>\n<p><strong>2️⃣ Kenya grew slower than Africa.</strong> The same report cites UN Tourism: Africa <strong>+8%</strong> in 2025 (81m), the world +4%. Kenya&#x27;s +7.2% sits <strong>below the continental average</strong>, and far below Egypt (+20%) and Morocco (+14%). The report never makes this comparison.</p>\n<p><strong>3️⃣ Real yield per arrival went backwards.</strong> Earnings ÷ arrivals: KSh 177,074 (2023) → 183,264 (2024) → <strong>189,004 (2025)</strong>. That is +3.13% nominal. The report&#x27;s own inflation assumption for 2025 is <strong>4.075%</strong>. Real revenue per visitor <strong>fell about 0.9%</strong>. Kenya sold more nights for less real money.</p>\n<p><strong>4️⃣ The growth is decelerating hard.</strong> Earnings: +41.26% (2023) → +20.13% (2024) → <strong>+10.55%</strong> (2025). Arrivals: +15.71% (2024) → <strong>+7.19%</strong> (2025). Growth halved in a year. &quot;Consolidation&quot; is the report&#x27;s word for it.</p>\n<p><span class=\"sowhat\">🎯 <strong>So what — this week:</strong></span><br>• <strong>Reprice off 2,401,937, not 2.7m or 7.9m.</strong> If a lender, landlord or JV partner is modelling on the inflated figure, your projected share of market is overstated by up to 3x.<br>• <strong>Diaspora is your most defensible segment</strong> — 250,603 people, +13.4%, travelling Christmas and Easter, staying longer, spending locally. Almost nobody prices for them. Build a diaspora rate with a long-stay fence and a family-room bias before December.<br>• <strong>Stop selling volume.</strong> With real yield falling, another 7% of arrivals at flat real rate is a busier hotel earning the same money.</p>\n<p><strong>Coming in this series:</strong> Part 2 — the MICE numbers, and what 998 &quot;international conferences&quot; actually contained. Part 3 — the park-gate admission, the receivership line, and why the 2030 forecast is a straight line.</p>\n<p>📄 Source: Tourism Research Institute, <strong>Annual Tourism Sector Performance Report 2025</strong>, v8 dated 4 June 2026. All figures quoted are the report&#x27;s own.</p>\n<p>🔗 Full analysis on the web: <a href=\"https://eahospitalitypulse.com/editions/pulse-2026-08-25-special.html\" rel=\"noopener\">eahospitalitypulse.com/editions/pulse-2026-08-25-specia…</a><br>— EA Hospitality Pulse | Daily intelligence for city, bush &amp; beach properties</p>"
 },
 {
  "id": "pulse-2026-08-24-evening",
  "date": "2026-08-24",
  "dateDisplay": "Monday, 24 August 2026",
  "edition": "Evening Wrap",
  "editionKey": "evening",
  "summary": "1️⃣ 🇰🇪➡️🇺🇬 JAMBOJET RETURNS TO ENTEBBE — DAILY, FROM 1 OCTOBER",
  "bodyHtml": "<p><strong>1️⃣ 🇰🇪➡️🇺🇬 JAMBOJET RETURNS TO ENTEBBE — DAILY, FROM 1 OCTOBER</strong></p>\n<p>Jambojet resumes Nairobi–Entebbe after six years away: daily flights plus cargo from 1 October 2026, one-way from about KSh 22,950 (Bizna Kenya, 21 Aug 2026). Announced 20 Aug at a TUGATA breakfast in Kampala. The airline projects ~300,000 Kenya–Uganda passengers in 2026 and is selling onward links to Mombasa, Diani, Malindi and Lamu.</p>\n<p><strong>Straight with you:</strong> we flagged Jambojet&#x27;s press page as a blind spot on 18, 19 and 21 Aug. It moved today at 11:50 EAT. This is what was behind it — we were late.</p>\n<p><span class=\"sowhat\">🎯 <strong>So what:</strong> Ugandan corporate and leisure demand into the Kenyan coast just got a cheap daily seat. Kenyan coast properties — build a Kampala-facing rate and a two-centre package NOW, not in October; Q4 contracting closes before the route flies. Kampala city hotels — expect a modest inbound business bump and firmer midweek. 🏷 City/Beach · KE·UG · Confirmed</span></p>\n<p><strong>2️⃣ 🇰🇪 CBK PUBLISHED ITS JULY SURVEYS TODAY — AND KENYA&#x27;S ONLY HOTEL BOOKING DATA WITH THEM</strong></p>\n<p>CBK posted its July 2026 Market Perceptions, CEOs and Agriculture surveys today (centralbank.go.ke, 24 Aug 2026): inflation seen holding within the target band despite fuel pressure, optimism sustained.</p>\n<p><strong>What almost nobody in the trade uses:</strong> that panel includes <strong>96 hotels</strong>, and CBK publishes their forward bookings by city. Per the May 2026 edition — Nairobi&#x27;s June reading ran <strong>71 against 45 a year earlier</strong>; Mombasa <strong>60 vs 56</strong>; national average <strong>62 vs 51</strong>. Nairobi is carried by MICE. The coast is not moving with it.</p>\n<p><span class=\"sowhat\">🎯 <strong>So what:</strong> free, official, city-level booking-pace data. Benchmark your own pace against it instead of guessing. 🏷 City/Beach · KE · Confirmed</span></p>\n<p><strong>3️⃣ 🌏 THAILAND REVIVES ITS TOURIST FEE AT US$14 — SIX YEARS AND FIVE REVERSALS IN</strong></p>\n<p>Thailand&#x27;s National Tourism Policy Committee has endorsed a THB 450 (~US$14) arrival fee, up from the original 300 baht, now heading to a 30-day consultation then Cabinet; air arrivals first, from late 2026 or early 2027 (Skift, 24 Aug 2026). It lands with arrivals near 33m in 2025 against a 40m pre-pandemic peak.</p>\n<p><span class=\"sowhat\">🎯 <strong>So what:</strong> read it as a mirror. Kenya is mid-stack — US$30 ETA in force, a US$50,000 mandatory travel-health insurance rule gazetted 30 Jul but not operational and under High Court challenge (mention 29 Sep). Thailand&#x27;s lesson is that a fee announced five times and collected zero times still damages trade confidence. Price your 2027 contracts on what is <strong>collected</strong>, not what is <strong>gazetted</strong>. 🏷 All · KE/Regional · Reported</span></p>\n<p>🟢 <strong>STILL TRUE</strong> — no EA advisory level moved. Kenya US Level 2 (re-issued 28 Jul 2026), Uganda 4, Tanzania &amp; Zanzibar 3 (since 31 Oct 2025), Rwanda 3. Don&#x27;t pre-emptively discount.</p>\n<p>💲 <strong>COST PULSE</strong> — Nairobi diesel KSh 217.86/L, super KSh 214.03/L (EPRA, 14 Aug). Inflation: KE 6.4% · TZ 4.0% · UG 3.7% · RW 13.6%. KES→USD 129.30 (CBK).</p>\n<p><span class=\"meta-line\">📅 <strong>WEEK AHEAD</strong> — <strong>26–28 Aug</strong> Africa Global PR Week, Nairobi · <strong>28 Aug</strong> WTA Africa Gala, Zanzibar · <strong>27 Aug–8 Sep</strong> Kwita Izina, Musanze · late-Aug CPI prints.</span></p>\n<p><span class=\"meta-line\">📡 <strong>RADAR</strong> — 328 in-window observations to 15:53 EAT; feed live. Jambojet&#x27;s press page moved after a week as a blind spot. WHO AFRO surfaced ten Jan–Mar 2026 archive bulletins as lead candidates — all dropped as stale traps.</span></p>\n<p>🔗 This edition on the web: <a href=\"https://eahospitalitypulse.com/editions/pulse-2026-08-24-evening.html\" rel=\"noopener\">eahospitalitypulse.com/editions/pulse-2026-08-24-evenin…</a><br>💼 Today&#x27;s Big Read on LinkedIn: <a href=\"https://www.linkedin.com/company/ea-hospitality-pulse/\" rel=\"noopener\">linkedin.com/company/ea-hospitality-pulse/</a><br>— EA Hospitality Pulse | Daily intelligence for city, bush &amp; beach properties</p>"
 },
 {
  ...
  "edition": "Evening Wrap",
  "editionKey": "evening",
  "summary": "TANZANIA IS NOW POWER-LONG. ZANZIBAR STILL CAN'T PLUG IN.",
  "bodyHtml": "<p><strong>🌍 THE EXPERT BRIEF — TANZANIA IS NOW POWER-LONG. ZANZIBAR STILL CAN&#x27;T PLUG IN.</strong></p>\n<p>On 22 August Tanzania inaugurated the 2,115MW Julius Nyerere Hydropower Project, lifting installed capacity to 4,646MW against roughly 2,271MW of peak demand — a surplus near 2,375MW (TanzaniaInvest, 23 Aug 2026). For a region where hotels budget diesel gensets as a standing cost line, a neighbour turning structurally power-long is a competitiveness event.</p>\n<p><strong>The catch most will miss:</strong> the surplus stops at the water. Zanzibar — Tanzania&#x27;s highest-value tourism zone — draws power over two submarine cables running at 98.8% and 97.3% of capacity, capping reliable island supply near 135MW against a ~65MW deficit (The Citizen TZ / AfDB). The bottleneck has moved from generation to transmission. Mainland abundance does not reach an Unguja beach resort until the planned 220kV upgrade and new 270MW cable are commissioned.</p>\n<p><strong>🎯 So what, by segment:</strong><br>• CITY (Dar, Arusha, Dodoma): the clear winner — grid reliability should ease genset reliance. Revisit 2027 diesel-backup assumptions, but don&#x27;t bank a tariff cut nobody has announced.<br>• BUSH: mostly off-grid solar+diesel, so direct gain is marginal; the win is gateway-town reliability and cold chain.<br>• BEACH (Zanzibar): do NOT cut genset capex or fuel budgets on the mainland headline — your power risk is unchanged this season.<br>• KE BENCHMARK: Kenya&#x27;s EPRA pass-through charges hit a combined KSh4.70/kWh in August (Kenyans.co.ke, 18 Aug 2026), on Nairobi diesel at KSh217.86/L. The mainland-TZ-vs-Kenya energy cost gap is widening.</p>\n<p><strong>🟢 STILL TRUE:</strong> Zanzibar&#x27;s US advisory holds at Level 3 (unchanged since 31 Oct 2025; UK Level 1) — no downgrade off the regional Ebola noise. Don&#x27;t pre-emptively discount (verified 4 Aug 2026).</p>\n<p><strong>💲 COST PULSE:</strong> Tanzania inflation 4.0% vs Kenya 6.4% (NBS / KNBS). KES→TZS 20.30 (CBK weekly bulletin).</p>\n<p><strong>📅 WEEK AHEAD:</strong> Africa Global PR Week, Nairobi 26–28 Aug · World Travel Awards Africa Gala, Zanzibar 28 Aug · Kwita Izina exhibition, Musanze 28 Aug–8 Sep.</p>\n<p>🔗 This edition on the web: <a href=\"https://eahospitalitypulse.com/editions/pulse-2026-08-23-evening.html\" rel=\"noopener\">eahospitalitypulse.com/editions/pulse-2026-08-23-evenin…</a><br>💼 Today&#x27;s Big Read on LinkedIn: <a href=\"https://www.linkedin.com/company/ea-hospitality-pulse/\" rel=\"noopener\">linkedin.com/company/ea-hospitality-pulse/</a></p>"
 },
 {
  "id": "foresight-2026-08-23",
  "date": "2026-08-23",
  "dateDisplay": "Sunday, 23 August 2026",
  "edition": "Sunday Foresight",
  "editionKey": "foresight",
  "summary": "Four stories this week. One argument underneath.",
  "bodyHtml": "<p><span class=\"meta-line\">🏨 EA HOSPITALITY PULSE — Sunday Foresight</span><br><span class=\"meta-line\">📅 Sunday, 23 August 2026 | 🇰🇪 🇺🇬 🇹🇿 🇷🇼</span></p>\n<p>Four stories this week. One argument underneath.<br>━━━━━━━━━<br><strong>THE TOURIST SHILLING IS BEING RE-NATIONALISED</strong></p>\n<p>On 18 August the Zanzibar Commission for Tourism, with Immigration, arrested three people for running excursions. The offence was nationality: under the Tourism Act 2009 tour operating and boat businesses are reserved for Zanzibaris, and a Kenyan and two Ugandans are, in law, foreigners (The Citizen, 21–22 Aug) — awkwardly against the EAC Common Market Protocol, as the reporting notes.</p>\n<p>Alone, a compliance story. Beside the week, something larger. Nairobi wants the Tourism Fund to keep collecting the 2% hotel levy while the CS oversees spending (Capital FM, 21 Aug). Dodoma is handing TANAPA and Ngorongoro back 51% of collected revenue (Pindi Chana, May 2026). Kigali prices a gorilla at US$1,500 on the wrong passport, about US$200 on an EAC one (RDB, 2026). None generates a visitor. Each redistributes money that already exists.</p>\n<p><strong>What everyone is missing:</strong> the perimeter is drawn at the national border, not the EAC one — exactly where the growth guest now comes from. Kenyan residents were 45% of hotel occupancy in 2025 (KNBS, Apr 2026); Uganda sent Kenya 234,556 arrivals. And your growth is migrating out of room revenue into the experience layer — permits, gates, transfers, excursions — which is the layer being nationalised. Where your margin now sits, the state is not just your tax collector but your licensor.<br>━━━━━━━━━<br><strong>THE WEEK&#x27;S SIGNALS</strong></p>\n<p><span class=\"item-head\">1️⃣ <strong>ZANZIBAR ARRESTS EAC CITIZENS AS &quot;FOREIGNERS&quot;</strong></span><br>One Kenyan, two Ugandans, detained 18 Aug for excursion work reserved for Zanzibaris (The Citizen, 21–22 Aug).<br><span class=\"sowhat\">🎯 So what: audit every excursion, transfer and boat product you sell or subcontract for the licence holder&#x27;s nationality. Liability doesn&#x27;t stop at your paperwork.</span><br><span class=\"tagline\">🏷 Beach | ZNZ/KE/UG | Confirmed | impact:risk</span></p>\n<p><span class=\"item-head\">2️⃣ <strong>NAIROBI REWRITES WHO CONTROLS THE 2% LEVY</strong></span><br>Fund keeps collecting, CS oversees management; the Bill widens the Fund into marketing and product (Capital FM, 21 Aug).<br><span class=\"sowhat\">🎯 So what: file during public participation. This decides whether your levy funds marketing you benefit from, or institutions you don&#x27;t.</span><br><span class=\"tagline\">🏷 City/Bush/Beach | KE | Confirmed | impact:margin</span></p>\n<p><span class=\"item-head\">3️⃣ <strong>TANZANIA HANDS THE PARKS BACK 51% OF THE GATE</strong></span><br>Retained in Bank of Tanzania special accounts, released with Paymaster General approval (Pindi Chana, May 2026).<br><span class=\"sowhat\">🎯 So what: a park funding its own roads has the motive to reprice them. Model an increase into 2027/28 costings now.</span><br><span class=\"tagline\">🏷 Bush | Tanzania | Confirmed | impact:watch</span></p>\n<p><span class=\"item-head\">4️⃣ <strong>UGANDA IS THE COUNTER-EXAMPLE</strong></span><br>UCAA reviewed 15 air service licence applications — 10 new — on 12 June 2026; Entebbe handled 189,130 international passengers in April.<br><span class=\"sowhat\">🎯 So what: Uganda is opening the layer everyone else closes. Build Entebbe into 2027 circuits before it prices itself.</span><br><span class=\"tagline\">🏷 City/Bush | UG | Confirmed | impact:demand</span><br>━━━━━━━━━<br><span class=\"meta-line\">📡 <strong>30/90-DAY DEMAND CALENDAR</strong></span></p>\n<p>🇰🇪 26 Aug — Cabinet takes the 2026 BROP. <strong>Check it for a named tourism charge.</strong><br>🇷🇼 4 Sep — Kwita Izina, Kinigi. <strong>Musanze tightens. Package the transfer night.</strong><br>🇰🇪 ~15 Sep — EPRA fuel review effective. <strong>Diesel above KSh217.86/L reprices every transfer.</strong><br>🇰🇪 6–8 Oct — Magical Kenya Travel Expo (10,000+, KTB). <strong>Block buyer and crew rooms now.</strong><br>🇺🇬 27 Oct / 18 Nov — Uganda Airlines opens Entebbe–Accra, then Entebbe–Kigali. <strong>Build the twin-centre first.</strong></p>\n<p><span class=\"meta-line\">💬 Are you pricing the regional guest as one market, or five?</span></p>\n<p>🔗 This edition on the web: <a href=\"https://eahospitalitypulse.com/editions/foresight-2026-08-23.html\" rel=\"noopener\">eahospitalitypulse.com/editions/foresight-2026-08-23.html</a><br>💼 This week&#x27;s Big Read on LinkedIn: <a href=\"https://www.linkedin.com/company/ea-hospitality-pulse/\" rel=\"noopener\">linkedin.com/company/ea-hospitality-pulse/</a><br>— EA Hospitality Pulse | Daily intelligence for city, bush &amp; beach properties</p>"
 },
 {
  ...
  "edition": "Evening Wrap",
  "editionKey": "evening",
  "summary": "1️⃣ 🇨🇩➡️🇺🇬 THE EBOLA VACCINE THAT WON'T LIFT UGANDA'S \"DO NOT TRAVEL\"",
  "bodyHtml": "<p>🌆 <strong>EA HOSPITALITY PULSE — Evening Wrap</strong><br>🗓 Saturday 22 August 2026 | 🇺🇬 🇷🇼<br><em>Seventy thousand Ebola vaccine doses reached the DRC this week. They read like the cavalry. They are not — and Uganda&#x27;s tourism trough is longer than the headline suggests.</em><br>━━━━━━━━━<br><strong>1️⃣ 🇨🇩➡️🇺🇬 THE EBOLA VACCINE THAT WON&#x27;T LIFT UGANDA&#x27;S &quot;DO NOT TRAVEL&quot;</strong></p>\n<p>The UN&#x27;s vaccine coordination group allocated <strong>70,000 Ervebo doses</strong> to the DRC this week — <strong>20,000</strong> for a Phase 3 clinical trial, <strong>50,000</strong> for frontline health workers (WHO &amp; Africa CDC, 20 Aug). The catch operators need to hold: <strong>Ervebo is a Zaire-strain vaccine, and its efficacy against the Bundibugyo virus driving this outbreak is unproven</strong> — that is what the trial exists to test. So this is a research event, not a containment event. The DRC epidemic is still the fastest-growing on record — <strong>5,290 cases, 2,516 deaths</strong> to 19 Aug, up 81 cases in a day, with an M23 conflict blocking the contact-tracing containment depends on (ECDC, 21 Aug).</p>\n<p><span class=\"tagline\">🏷 Bush · Uganda/Rwanda · Confirmed (WHO/Africa CDC 20 Aug; ECDC 21 Aug)</span><br><span class=\"sowhat\">🎯 <strong>So what:</strong> The reflex read — &quot;vaccines arriving → outbreak turning → advisory relief coming&quot; — is wrong. A trial gives the US State Department no basis to move <strong>Uganda off Level 4</strong> or <strong>Rwanda off Level 3</strong>. Uganda closed its own 20-case flare-up weeks ago; it carries the advisory for its neighbour&#x27;s crisis, not its own. Plan the Ugandan gorilla-tourism trough as a <strong>long tail into 2027</strong>, not a Q4 rebound — and lean on regional and non-US source markets while the US sits at &quot;Do Not Travel&quot;.</span></p>\n<p><strong>2️⃣ 🇺🇸 US COURT VOIDS THE 75-COUNTRY VISA BAN — READ THE SMALL PRINT</strong></p>\n<p>A federal judge (Jeannette Vargas, SDNY) struck down the Trump administration&#x27;s suspension of <strong>immigrant</strong> visas to nationals of 75 countries as beyond the Secretary of State&#x27;s authority (Al Jazeera / CNN, 22 Aug).</p>\n<p><span class=\"tagline\">🏷 All · Source markets · Confirmed (22 Aug)</span><br><span class=\"sowhat\">🎯 <strong>So what:</strong> It covers <strong>immigrant (permanent-residence) visas only — not tourist or student visas</strong> — so there is no direct inbound-leisure effect. Relevance is diaspora/VFR traffic and a reminder that US entry policy remains a moving target. Don&#x27;t let an agent read this as &quot;the US just reopened travel.&quot;</span><br>━━━━━━━━━<br>✅ <strong>STILL TRUE</strong> — No EA advisory moved today (radar logged only a Lebanon change). Kenya <strong>US Level 2</strong>; Uganda <strong>Level 4</strong> (DRC-Ebola grounds); Tanzania &amp; Zanzibar <strong>Level 3</strong>; Rwanda <strong>Level 3</strong>. Don&#x27;t discount on a downgrade that hasn&#x27;t happened (advisory board, verified 12 Aug).<br>⚡ <strong>COST PULSE</strong> — Nairobi diesel holds <strong>KSh 217.86/L</strong> to 14 Sep — refuse any supplier fuel surcharge (EPRA, 14 Aug).<br>🎤 <strong>MICE WATCH</strong> — <strong>Today</strong> Rwenzori Marathon, Kasese · <strong>26–28 Aug</strong> Africa Global PR Week, Nairobi · <strong>28 Aug</strong> WTA Africa Gala, Zanzibar · <strong>4 Sep</strong> Kwita Izina, Musanze.</p>\n<p>🔗 This edition on the web: <a href=\"https://eahospitalitypulse.com/editions/pulse-2026-08-22-evening.html\" rel=\"noopener\">eahospitalitypulse.com/editions/pulse-2026-08-22-evenin…</a><br>💼 Today&#x27;s Big Read on LinkedIn: <a href=\"https://www.linkedin.com/company/ea-hospitality-pulse/\" rel=\"noopener\">linkedin.com/company/ea-hospitality-pulse/</a><br>— EA Hospitality Pulse | Daily intelligence for city, bush &amp; beach properties</p>"
 },
 {
  "id": "pulse-2026-08-21-evening",
  "date": "2026-08-21",
  "dateDisplay": "Friday, 21 August 2026",
  "edition": "Evening Wrap",
  "editionKey": "evening",
  "summary": "1️⃣ 🇰🇪 MPs MOVE AGAINST THE KTB SUPER-MERGER — AND THE MINISTRY REACHES FOR THE LEVY",
  "bodyHtml": "<p>🌆 <strong>EA HOSPITALITY PULSE — Evening Wrap</strong><br>🗓 Friday 21 August 2026 | 🇰🇪 🇹🇿<br><em>Two governments moved on the tourism value chain today — Kenya over who controls its research, finance and levy money; Zanzibar over who is allowed to run the excursions.</em><br>━━━━━━━━━<br><strong>1️⃣ 🇰🇪 MPs MOVE AGAINST THE KTB SUPER-MERGER — AND THE MINISTRY REACHES FOR THE LEVY</strong></p>\n<p>The Tourism (Amendment) Bill 2026 — which folds the <strong>Tourism Research Institute (TRI)</strong> and <strong>Tourism Finance Corporation (TFC)</strong> into the <strong>Kenya Tourism Board</strong> — hit resistance in committee today. The National Assembly&#x27;s <strong>Tourism &amp; Wildlife Committee (chair Kareke Mbiuki)</strong> opposed absorbing TRI, with coastal MPs (Kisauni, Lamu East, Voi) arguing it should be <strong>funded, not merged</strong> (Capital FM, 21 Aug). Separately, the <strong>Ministry of Tourism proposed splitting collection of the 2% Tourism Fund levy from management of the fund</strong>, expanding the Cabinet Secretary&#x27;s oversight (allAfrica / Capital FM, 21 Aug).</p>\n<p><span class=\"tagline\">🏷 City/Bush/Beach · Kenya · Confirmed (Capital FM / allAfrica, 21 Aug)</span><br><span class=\"sowhat\">🎯 <strong>So what:</strong> TRI is the source of the arrivals-by-market and bed-night numbers you use to forecast yield and build DMC packages — losing its independence, or its funding, degrades the data you price on. And a levy whose collection and disbursement rules are being redrawn is a <strong>cash-flow and marketing-spend variable</strong>: Tourism Fund money underwrites destination and MICE marketing. Track the Bill&#x27;s committee stage; don&#x27;t assume either the merger or the levy mechanics land as first drafted.</span></p>\n<p><strong>2️⃣ 🇹🇿 ZANZIBAR ARRESTS THREE FOREIGNERS FOR RUNNING EXCURSIONS RESERVED FOR ZANZIBARIS</strong></p>\n<p>The <strong>Zanzibar Commission for Tourism</strong> and Immigration arrested three foreign nationals — including Kenyan businesswoman <strong>Esther Mutheu Samuka</strong> (with Mukembo Emmanuel and Karungi Scovia) — on <strong>18 August</strong> for operating tour and excursion businesses reserved for Zanzibari citizens under the <strong>Tourism Act No. 6 of 2009</strong>. A public notice was issued 17 Aug (Citizen Digital / Kenyans.co.ke, 21 Aug).</p>\n<p><span class=\"tagline\">🏷 Beach · Zanzibar · Confirmed (ZCT notice 17 Aug / press 21 Aug)</span><br><span class=\"sowhat\">🎯 <strong>So what:</strong> The ground product on Zanzibar — excursions, spice tours, transfers — is legally reserved for locals. A regional DMC selling Zanzibar packages must run those legs through a <strong>licensed Zanzibari operator</strong>, not a foreign-owned entity, or risk arrest, a stranded guest and transfer liability mid-stay. Audit your island partners&#x27; licensing before the European peak, not during it.</span><br>━━━━━━━━━<br>✅ <strong>STILL TRUE</strong> — No EA advisory moved today. Kenya <strong>US Level 2</strong>; Uganda <strong>Level 4</strong> (DRC-Ebola grounds); Tanzania &amp; Zanzibar <strong>Level 3</strong>; Rwanda <strong>Level 3</strong> (advisory board, verified 21 Aug).<br>⚡ <strong>COST PULSE</strong> — Nairobi diesel holds <strong>KSh 217.86/L</strong> to 14 Sep, ~KSh 14.28/L above landed-cost parity — refuse any supplier fuel surcharge (EPRA, 14 Aug).<br>🎤 <strong>MICE WATCH</strong> — <strong>22 Aug</strong> Rwenzori Marathon, Kasese · <strong>26–28 Aug</strong> Africa Global PR Week, Nairobi · <strong>28 Aug</strong> WTA Africa Gala, Zanzibar · <strong>4 Sep</strong> Kwita Izina, Musanze.</p>\n<p>🔗 This edition on the web: <a href=\"https://eahospitalitypulse.com/editions/pulse-2026-08-21-evening.html\" rel=\"noopener\">eahospitalitypulse.com/editions/pulse-2026-08-21-evenin…</a><br>💼 Today&#x27;s Big Read on LinkedIn: <a href=\"https://www.linkedin.com/company/ea-hospitality-pulse/\" rel=\"noopener\">linkedin.com/company/ea-hospitality-pulse/</a><br>— EA Hospitality Pulse | Daily intelligence for city, bush &amp; beach properties</p>"
 },
 {
  "id": "pulse-2026-08-21-morning",
  "date": "2026-08-21",
  "dateDisplay": "Friday, 21 August 2026",
  "edition": "Morning Brief",
  "editionKey": "morning",
  "summary": "YOUR GROWTH GUEST BOARDS IN KINSHASA, NOT LONDON",
  "bodyHtml": "<p>🌅 <strong>EA HOSPITALITY PULSE — Morning Brief</strong><br>🗓 Friday 21 August 2026 | 🇷🇼 🇺🇬 🇰🇪 🌍</p>\n<p><em>A quiet news morning — read the map, not the headlines. EA&#x27;s next guest is increasingly African, not European, and the airlines are re-basing capacity to match.</em><br>━━━━━━━━━<br><strong>1️⃣ 🌍 THE EXPERT BRIEF — YOUR GROWTH GUEST BOARDS IN KINSHASA, NOT LONDON</strong></p>\n<p>Look at who actually arrived in Rwanda in H1 2026. The <strong>DRC was the single largest source market — 185,420 visitors, 12.5% of arrivals — ahead of Kenya&#x27;s 148,320</strong> (Rwanda NISR H1 2026). Not the UK, not the US. The demand is cross-border trade, healthcare, education, family, and Kigali&#x27;s pull as a conference hub.</p>\n<p>The airlines see it. <strong>Uganda Airlines flies Entebbe–Kigali daily from 18 Nov and Entebbe–Accra 4x weekly from 27 Oct</strong> (announced 5 Aug, The EastAfrican). <strong>RwandAir has just filed to close its Monday Kigali–Paris–Brussels rotation for winter, keeping Paris</strong> (AeroRoutes, 20 Aug). Behind it: the <strong>US$2.6bn Qatar-backed Bugesera airport</strong>, built for regional and connecting volume (operational 2028). Seats are re-basing toward intra-African traffic in real time.</p>\n<p><strong>What everyone is missing:</strong> the regional African guest now topping the table behaves nothing like the European bucket-lister most EA properties price for. They book later, stay shorter, travel midweek for business and family, and anchor to regional — not European — price norms. Run long-haul rate fences, seven-night minimums and wholesale packaging against them and you leak occupancy AND rate without seeing why.</p>\n<p><span class=\"sowhat\">🎯 <strong>So what:</strong></span><br>• <strong>City:</strong> your growth guest. Build a real midweek regional-corporate rate, shorten minimum stays, cut booking and payment friction. Kigali — the DRC is now your No.1 feeder.<br>• <strong>Bush:</strong> don&#x27;t hard-code the card to the European rate. Hold a regional shoulder product; sell tight 1–2 night park add-ons off the new daily Kampala–Kigali link.<br>• <strong>Beach:</strong> feeder-hub capacity (Nairobi, Kigali, Addis, Doha) matters more than any single European route.</p>\n<p><strong>2️⃣ ✈️ RWANDAIR TRIMS A BRUSSELS FREQUENCY FOR WINTER</strong><br>The filing removes the <strong>Monday</strong> rotation on the <strong>Kigali–Paris CDG–Brussels</strong> route for NW26; <strong>Paris stays bookable</strong> (AeroRoutes, 20 Aug). A technical filing, not a route cut — but a straw in the wind.<br><span class=\"tagline\">🏷 City · Rwanda · Confirmed (AeroRoutes, 20 Aug)</span><br><span class=\"sowhat\">🎯 <strong>So what:</strong> If you sell Kigali on Brussels connectivity, re-check winter timings before quoting European agents; lead with Paris.</span><br>━━━━━━━━━<br>✅ <strong>STILL TRUE</strong> — No EA advisory moved overnight (radar logged only Caribbean/Panama/Thailand changes). Kenya <strong>US Level 2</strong>; Uganda <strong>Level 4</strong> (pinned to DRC Ebola, not Ugandan epidemiology); Tanzania &amp; Zanzibar <strong>Level 3</strong>; Rwanda <strong>Level 3</strong>. Don&#x27;t discount on a downgrade that hasn&#x27;t happened (advisory board, verified to 20 Aug).<br>⚡ <strong>COST PULSE</strong> — Nairobi diesel holds <strong>KSh 217.86/L</strong> to 14 Sep, ~KSh 14.28/L above landed-cost parity — refuse any supplier fuel surcharge this cycle (EPRA, 14 Aug).<br>🎤 <strong>MICE WATCH</strong> — <strong>22 Aug</strong> Rwenzori Marathon, Kasese · <strong>26–28 Aug</strong> Africa Global PR Week, Nairobi · <strong>4 Sep</strong> Kwita Izina, Musanze · <strong>5–12 Sep</strong> Miss Tourism EA, Kampala.<br><span class=\"meta-line\">📅 <strong>WEEK AHEAD</strong> — late-Aug KNBS/UBOS/NISR CPI prints; watch RDB/NISR for H1 2026 tourism-revenue detail.</span><br><span class=\"meta-line\">📡 <strong>RADAR</strong> — 541 in-window observations to 08:36 EAT; feed live. Surfaced the RwandAir filing; no EA advisory or outbreak change. Jambojet &amp; Airlink press pages sit behind Incapsula — a standing blind spot.</span></p>\n<p>🔗 This edition on the web: <a href=\"https://eahospitalitypulse.com/editions/pulse-2026-08-21-morning.html\" rel=\"noopener\">eahospitalitypulse.com/editions/pulse-2026-08-21-mornin…</a><br>— EA Hospitality Pulse | Daily intelligence for city, bush &amp; beach properties</p>"
 },
 {
  "id": "pulse-2026-08-20-midday",
  "date": "2026-08-20",
  "dateDisplay": "Thursday, 20 August 2026",
  "edition": "Midday Pulse",
  "editionKey": "midday",
  "summary": "1️⃣ 🌍 DRC EBOLA PASSES 5,000 CASES — WHO EMERGENCY COMMITTEE RECONVENES 18 AUG",
  "bodyHtml": "<p>🕛 <strong>EA HOSPITALITY PULSE — Midday Pulse</strong><br>🗓 Thursday 20 August 2026 | 🇺🇬 🇷🇼 🌍</p>\n<p><em>DRC&#x27;s Bundibugyo Ebola outbreak has passed 5,000 cases and 2,378 deaths, and WHO&#x27;s emergency committee reconvened on 18 August — the reason Uganda sits at US Level 4 and Rwanda at Level 3, both unchanged.</em><br>━━━━━━━━━<br><strong>1️⃣ 🌍 DRC EBOLA PASSES 5,000 CASES — WHO EMERGENCY COMMITTEE RECONVENES 18 AUG</strong></p>\n<p>WHO AFRO&#x27;s 18 August report puts the DRC Bundibugyo outbreak at <strong>5,021 confirmed cases and 2,378 deaths</strong> (data to 16 Aug), across <strong>55 health zones in six provinces</strong> — up from 4,318 cases / 2,011 deaths on 9 August. It is the largest Ebola outbreak in DRC&#x27;s history and the fastest-growing on record. Ituri stays the epicentre (4,257 cases, 1,878 deaths). The point that matters for us is the <strong>eastward creep</strong>: North Kivu now 607 cases / 428 deaths across 12 of 34 zones, and South Kivu recording its <strong>first cases</strong> (3 cases, 1 death). Both provinces border Uganda and Rwanda. WHO&#x27;s IHR Emergency Committee — first convened 22 May, when the outbreak was declared a PHEIC — <strong>met again on 18 August</strong> (WHO, 18 Aug). Tanzania this week donated medical supplies worth <strong>220m/- (~US$88,000)</strong> to the DRC response (Daily News TZ, 20 Aug): the region is treating this as a live cross-border threat, not a distant one.</p>\n<p><span class=\"tagline\">🏷 Bush/City · Uganda/Rwanda/Regional · Confirmed (WHO AFRO, 18 Aug)</span><br><span class=\"sowhat\">🎯 <strong>So what:</strong> Nothing in your guests&#x27; East African itinerary touches an affected zone — say so precisely. The outbreak is in eastern DRC, not in Uganda (which declared its own small importation over on 28 July) and not in Rwanda&#x27;s or Uganda&#x27;s tourist circuits. Three moves: (1) <strong>hold rate</strong> — this is not a reason to discount safari or gorilla product; (2) <strong>brief US- and Canada-bound guests</strong> on the rules that HAVEN&#x27;T changed — CDC&#x27;s Title 42 rerouting order runs to 11 Sep, and Canada&#x27;s 21-day quarantine for anyone in Uganda/South Sudan in the prior 21 days is stricter still; (3) <strong>keep DRC and EA firmly separate</strong> in every guest conversation — the advisory is regional-border-driven, not a comment on Kigali, Kampala, the Mara or Zanzibar.</span></p>\n<p>⚠️ <strong>Watch, don&#x27;t price:</strong> the CDC comment period (docket CDC-2026-0892) closes ~1 Sep; the next US assessment is 11 Sep. Uganda&#x27;s Level 4 is unlikely to ease before then while DRC transmission climbs — but no order has changed. Sell &quot;outbreak contained to eastern DRC&quot;, not &quot;restrictions lifted&quot;.<br>━━━━━━━━━<br>✅ <strong>STILL TRUE</strong> — Advisory levels unchanged: Kenya <strong>US Level 2</strong> (Westlands, Diani, Watamu clear); Uganda <strong>Level 4</strong> (DRC-Ebola grounds, not Ugandan epidemiology); Tanzania &amp; Zanzibar <strong>Level 3</strong> (since 31 Oct 2025); Rwanda <strong>Level 3</strong>. Don&#x27;t let a guest read an eastern-DRC outbreak as an EA-tourist-area event (advisory board, verified 12 Aug).<br>⚡ <strong>COST PULSE</strong> — Nairobi diesel holds <strong>KSh 217.86/L</strong> to 14 Sep, ~KSh 14.28/L above landed-cost parity — refuse any supplier fuel surcharge (EPRA, 14 Aug).<br>🎤 <strong>MICE WATCH</strong> — <strong>22 Aug</strong> Rwenzori Marathon, Kasese · <strong>26–28 Aug</strong> Africa Global PR Week, Nairobi · <strong>28 Aug</strong> WTA Africa Gala, Zanzibar · <strong>4 Sep</strong> Kwita Izina, Musanze.<br><span class=\"meta-line\">📅 <strong>WEEK AHEAD</strong> — CDC comment period closes ~1 Sep · next US Uganda/DRC assessment 11 Sep · late-Aug KNBS/UBOS/NISR CPI prints.</span><br><span class=\"meta-line\">📡 <strong>RADAR</strong> — 291 in-window observations to 13:53 EAT; feed live. The Ebola escalation was corroborated by hand against WHO AFRO (18 Aug); the radar surfaced Tanzania&#x27;s donation (Daily News TZ, 20 Aug). Jambojet &amp; Airlink press pages behind Incapsula — a standing blind spot.</span></p>\n<p>🔗 This edition on the web: <a href=\"https://eahospitalitypulse.com/editions/pulse-2026-08-20-midday.html\" rel=\"noopener\">eahospitalitypulse.com/editions/pulse-2026-08-20-midday…</a><br>— EA Hospitality Pulse | Daily intelligence for city, bush &amp; beach properties</p>"
 },
 {
  "id": "pulse-2026-08-20-morning",
  "date": "2026-08-20",
  "dateDisplay": "Thursday, 20 August 2026",
  "edition": "Morning Brief",
  "editionKey": "morning",
  "summary": "1️⃣ 🇰🇪 SEVEN KILLED IN SAMBURU SAFARI-HELICOPTER CRASH — KCAA INVESTIGATING",
  "bodyHtml": "<p>🌅 <strong>EA HOSPITALITY PULSE — Morning Brief</strong><br>🗓 Thursday 20 August 2026 | 🇰🇪 🇺🇬 🌍</p>\n<p><em>A fatal safari-helicopter crash puts fly-in aviation back at the centre of the premium-safari risk conversation.</em><br>━━━━━━━━━<br><strong>1️⃣ 🇰🇪 SEVEN KILLED IN SAMBURU SAFARI-HELICOPTER CRASH — KCAA INVESTIGATING</strong></p>\n<p>A Eurocopter EC130 B4 operated by Lady Lori Helicopters, carrying &amp;Beyond guests, came down near <strong>Mount Ololokwe in Samburu</strong> at about 09:13 on Wednesday 19 August, on a charter from <strong>Loisaba Conservancy to the Ewaso Nyiro area</strong>. All seven aboard died — five Americans (including a Telemundo/NBCUniversal executive), Ecuador&#x27;s national intelligence chief and his wife, and the Kenyan pilot. The <strong>KCAA has opened an investigation</strong>; the cause is undetermined (CNN, Al Jazeera, CBS, 19 Aug).</p>\n<p>This is the <strong>second fatal tourist-air crash in under a year</strong>, after the October 2025 Mombasa Air Safari crash near the Maasai Mara that killed 11. Premium fly-in safari runs on exactly this light-aircraft and helicopter airlift.</p>\n<p><span class=\"tagline\">🏷 Bush · Kenya · Confirmed (KCAA / international press, 19 Aug)</span><br><span class=\"sowhat\">🎯 <strong>So what:</strong> Do not speculate on cause — it undermines you when the report lands. Brief guest-facing teams on the facts and on your charter partners&#x27; certification and KCAA oversight; have <strong>ground-transfer contingencies</strong> ready for VIP arrivals expecting a heli/light-aircraft leg. Expect closer KCAA scrutiny of charter operators in the coming weeks.</span><br>⚠️ <strong>Early signal, unconfirmed:</strong> after two fatal incidents in ten months, upward pressure on <strong>aviation-insurance premiums</strong> for light-aircraft and helicopter charter is plausible — but we have seen no rate filing. Watch it; don&#x27;t price it into 2027 contracts yet.</p>\n<p><strong>2️⃣ 🇺🇬 KASESE ROOM CRUNCH AS RWENZORI MARATHON DRAWS 45 COUNTRIES</strong></p>\n<p>Government and organisers flag an <strong>accommodation shortfall in Kasese</strong> ahead of the Tusker Lite Mt Rwenzori Marathon on <strong>Saturday 22 August</strong>, with runners from roughly <strong>45 countries</strong> (APO/ATTA; Africa24, mid-Aug). Kasese&#x27;s bed stock is thin for the weekend.</p>\n<p><span class=\"tagline\">🏷 City/Bush · Uganda · Confirmed (organiser/govt, mid-Aug)</span><br><span class=\"sowhat\">🎯 <strong>So what:</strong> Genuine short compression. Hold rate on remaining Kasese inventory and price overflow into <strong>Queen Elizabeth NP lodges and Fort Portal</strong>; sell the marathon as a QENP/Kazinga extension rather than a one-night stay.</span><br>━━━━━━━━━<br>✅ <strong>STILL TRUE</strong> — No EA advisory moved overnight. Kenya <strong>US Level 2</strong> (core corridors, Diani, Watamu clear); Uganda <strong>Level 4</strong> (regional Ebola grounds); Tanzania &amp; Zanzibar <strong>Level 3</strong> (since 31 Oct 2025); Rwanda <strong>Level 3</strong>. An aviation accident is not an advisory event — don&#x27;t let a guest conflate them (advisory board, verified 12 Aug).<br>⚡ <strong>COST PULSE</strong> — Nairobi diesel holds <strong>KSh 217.86/L</strong> to 14 Sep, ~KSh 14.28/L above landed-cost parity — refuse any supplier fuel surcharge (EPRA, 14 Aug).<br>🎤 <strong>MICE WATCH</strong> — <strong>22 Aug</strong> Rwenzori Marathon, Kasese · <strong>26–28 Aug</strong> Africa Global PR Week, Nairobi · <strong>28 Aug</strong> WTA Africa Gala, Zanzibar · <strong>4 Sep</strong> Kwita Izina, Musanze.<br><span class=\"meta-line\">📅 <strong>WEEK AHEAD</strong> — late-Aug UBOS/KNBS/NISR CPI prints · watch KCAA for any charter-safety directive.</span><br><span class=\"meta-line\">📡 <strong>RADAR</strong> — 467 in-window observations to 08:38 EAT; feed live. Radar did not surface the Samburu crash (a non-radar international break, verified by hand). Jambojet &amp; Airlink press pages behind Incapsula — a standing blind spot.</span></p>\n<p>🔗 This edition on the web: <a href=\"https://eahospitalitypulse.com/editions/pulse-2026-08-20-morning.html\" rel=\"noopener\">eahospitalitypulse.com/editions/pulse-2026-08-20-mornin…</a><br>— EA Hospitality Pulse | Daily intelligence for city, bush &amp; beach properties</p>"
 },
 {
  "id": "pulse-2026-08-19-evening",
  "date": "2026-08-19",
  "dateDisplay": "Wednesday, 19 August 2026",
  "edition": "Evening Wrap",
  "editionKey": "evening",
  "summary": "🇺🇬 UGANDA'S HOTEL BRANDS ARE BUILDING THROUGH A LEVEL-4 TROUGH",
  "bodyHtml": "<p>🌙 <strong>EA HOSPITALITY PULSE — Evening Wrap</strong><br>🗓 Wednesday 19 August 2026 | 🇺🇬 The Big Read</p>\n<p><em>Expert Brief: the smart money is building in Uganda — while its most valuable long-haul market is told &quot;Do Not Travel.&quot;</em><br>━━━━━━━━━<br><strong>🇺🇬 UGANDA&#x27;S HOTEL BRANDS ARE BUILDING THROUGH A LEVEL-4 TROUGH</strong></p>\n<p>Read the openings and Uganda looks like a market on the way up. Marriott put its <strong>flagship brand into Kampala</strong> for the first time this year — a 277-unit twin-tower on Nsambya Hill, opened June 2026 (The Independent UG, 11 Aug). Asilia enters the country with <strong>Erebero Hills</strong>, an eight-suite gorilla lodge on the edge of Bwindi, opening this season (Travel Weekly, 2026). And the region&#x27;s investor circuit — <strong>Future Hospitality Summit Africa</strong> — has awarded Kampala its <strong>2027 edition</strong> at Speke Resort (Breaking Travel News). Three separate bets on the same city inside twelve months.</p>\n<p>Now read the demand side. Uganda sits at <strong>US State Department Level 4 — Do Not Travel</strong>, raised on Ebola grounds (travel.state.gov, via advisory board verified 12 Aug), with a US inbound restriction for anyone in Uganda in the prior 21 days.</p>\n<p><strong>What everyone is missing:</strong> the penalty is not about Uganda. Kampala declared <strong>its own Bundibugyo outbreak OVER on 28 July</strong> — 20 cases, 2 deaths, all chains closed (Uganda MoH). The Level 4 is pinned to the <strong>DRC epidemic next door</strong> — now ~5,000 cases, 2,300+ deaths, the fastest-growing on record (WHO IHR committee, 18 Aug). So the brands aren&#x27;t betting on Ugandan health recovering — it already has. They&#x27;re betting an <strong>externally imposed</strong> penalty lifts once a neighbour&#x27;s epidemic turns: a two-to-three-year call, made through the trough. Uganda barely registers in continental pipeline reports, so this is conviction by single signing, not a wave.</p>\n<p><span class=\"sowhat\">🎯 <strong>So what — by segment:</strong></span><br>🏙 <strong>City (Kampala):</strong> new branded rooms split a long-haul corporate pie Level 4 is shrinking. Win on <strong>regional corporate, NGO/UN and forward MICE</strong> (FHS 2027), not a long-haul tide that hasn&#x27;t arrived.<br>🌿 <strong>Bush (Bwindi):</strong> Asilia lifts the price ceiling — permits are capped at <strong>US$800</strong>, so hold rate — but the Level-4 traveller is the premium long-hauler you lose first. Diversify source markets.<br>🏖 <strong>Beach:</strong> Uganda has no coast; the read is competitive — Kenya-coast and Zanzibar can win the long-haul combo diverted from Entebbe.<br><span class=\"tagline\">🏷 Uganda · Confirmed (openings, advisory, MoH) / Inference (thesis)</span><br>━━━━━━━━━<br>✅ <strong>STILL TRUE</strong> — Uganda <strong>US Level 4</strong> (Ebola, regional grounds), UK Level 3 in parts of the west. Kenya <strong>Level 2</strong> (core corridors clear); Tanzania &amp; Zanzibar <strong>Level 3</strong> (since 31 Oct 2025); Rwanda <strong>Level 3</strong>. Nothing moved today (advisory board, verified 12 Aug).<br>⚡ <strong>COST PULSE</strong> — Nairobi diesel holds <strong>KSh 217.86/L</strong> to 14 Sep — ~KSh 14.28/L above landed-cost parity, so refuse any supplier fuel surcharge (EPRA, 14 Aug). Watch the <strong>8% petroleum VAT expiring 14 Oct</strong> — model a step-up.<br>🎤 <strong>MICE WATCH</strong> — <strong>FHS Africa 2027</strong>, Kampala (Speke), 2–3 Feb — bid won; six months to ready corporate/long-stay rate. <strong>AfPIF</strong> wraps in Kigali today; <strong>Hotel Expo Kenya</strong> (KICC) closes 21 Aug.<br><span class=\"meta-line\">📅 <strong>WEEK AHEAD</strong> — <strong>26–28 Aug</strong> Africa Global PR Week, Nairobi · <strong>28 Aug</strong> WTA Africa Gala, Zanzibar · <strong>4 Sep</strong> Kwita Izina, Musanze · late-Aug UBOS/KNBS/NISR CPI.</span><br><span class=\"meta-line\">📡 <strong>RADAR</strong> — 288 in-window observations to 13:58 EAT; feed live. No EA advisory level moved. Jambojet &amp; Airlink press pages behind Incapsula — a standing blind spot.</span></p>\n<p>🔗 This edition on the web: <a href=\"https://eahospitalitypulse.com/editions/pulse-2026-08-19-evening.html\" rel=\"noopener\">eahospitalitypulse.com/editions/pulse-2026-08-19-evenin…</a><br>💼 Today&#x27;s Big Read on LinkedIn: <a href=\"https://www.linkedin.com/company/ea-hospitality-pulse/\" rel=\"noopener\">linkedin.com/company/ea-hospitality-pulse/</a><br>— EA Hospitality Pulse | Daily intelligence for city, bush &amp; beach properties</p>"
 },
 {
  "id": "pulse-2026-08-19-morning",
  "date": "2026-08-19",
  "dateDisplay": "Wednesday, 19 August 2026",
  "edition": "Morning Brief",
  "editionKey": "morning",
  "summary": "YOUR FASTEST-GROWING GUEST IS YOUR NEIGHBOUR — AND YOUR GOVERNMENT IS TAXING THEM AT THE BASE",
  "bodyHtml": "<p>☀️ <strong>MORNING BRIEF — Tue 19 Aug 2026</strong><br><em>Quiet news slot — one expert read that matters more than any headline.</em></p>\n<p><strong>YOUR FASTEST-GROWING GUEST IS YOUR NEIGHBOUR — AND YOUR GOVERNMENT IS TAXING THEM AT THE BASE</strong></p>\n<p>Read the 2025 source-market tables and the story stops being about Europe. Uganda sent Kenya <strong>234,556 visitors in 2025 — 31% of all African arrivals, up 8.7%</strong>; Tanzania <strong>209,536, up 7.7%</strong> (KTB/TRI data via POATE 2026, reported by Citizen Digital &amp; New Vision). Kenya now targets <strong>300,000 Ugandan arrivals</strong>. In Rwanda it&#x27;s starker: the <strong>DRC is now the single largest source market — 185,420 visitors in H1 2026, 12.5% of all international arrivals</strong> (RDB). The regional guest is the base load now, not the overflow.</p>\n<p><strong>What most operators miss:</strong> the guest base changed but the playbook didn&#x27;t. The marginal booking now comes from a traveller who ignores Western Level-3 advisories, books short, drives or short-hauls in, and pays in a regional currency — yet we still run a long-haul-dollar operation: USD rack rates, GDS/OTA distribution, risk comms aimed at Europe. Worse, the same treasuries celebrating this demand are taxing its most price-sensitive flyer. Kenya&#x27;s JKIA passenger levy is now <strong>pledged to bondholders</strong> (Business Daily, 24 Jul) — hard to cut — with a 2% short-term-rental levy and a proposed travel-health-insurance charge stacking on top. Regional demand shrugs off advisories but is exquisitely sensitive to a $20 levy.</p>\n<p><span class=\"sowhat\">🎯 <strong>So what — by segment:</strong></span><br>🏙 <strong>City:</strong> regional corporate, VFR and events traffic is your steadiest base — build regional-agent and WhatsApp distribution, quote in regional terms, not just a USD rack. 🌿 <strong>Bush:</strong> regional guests are lower-ADR but fill shoulder/low season and hedge advisory-driven long-haul softness — watch the total trip cost, because a park-fee-plus-air-levy stack is what loses them. 🏖 <strong>Beach:</strong> the drive-and-short-haul market (Ugandans/Tanzanians to Diani &amp; Mombasa, regional flyers to Zanzibar) is now year-round base load — protect it from feeder-route fragility and levy creep.<br><span class=\"tagline\">🏷 Regional · Confirmed (KTB/TRI 2025, RDB H1 2026) / Inference on operator response.</span></p>\n<hr class=\"divider\">\n<p>✅ <strong>STILL TRUE</strong> — No EA advisory moved. Kenya <strong>US Level 2</strong> (core corridors, Diani, Watamu clear); Tanzania &amp; Zanzibar <strong>Level 3</strong> (since 31 Oct 2025); Uganda <strong>US Level 4</strong> on residual Ebola grounds despite its 28 Jul outbreak-over call (travel.state.gov, verified 12 Aug). The regional guest travels through all of it — don&#x27;t discount as though it had lifted.<br>💷 <strong>COST PULSE</strong> — Price regional in regional money: KES→UGX <strong>28.36</strong> · KES→TZS <strong>20.30</strong> · KES→RWF <strong>11.31</strong> (CBK weekly). Kenya diesel <strong>KSh 217.86/L</strong> (EPRA, 14 Aug) — refuse any supplier fuel surcharge this cycle.<br><span class=\"meta-line\">📅 <strong>WEEK AHEAD</strong> — <strong>19–21 Aug</strong> Hotel Expo Kenya, KICC · <strong>18–20 Aug</strong> AfPIF, Kigali Marriott · late Aug KNBS/UBOS/NISR CPI · <strong>26–28 Aug</strong> Africa Global PR Week, Nairobi · <strong>4 Sep</strong> Kwita Izina, Musanze.</span><br><span class=\"meta-line\">📡 <strong>RADAR</strong> — 470 in-window observations to 08:38 EAT; feed live. No EA advisory moved (only Mauritania/Netherlands/Ecuador flagged). Jambojet &amp; Airlink press pages moved behind Incapsula — a persistent blind spot, not news. Kenya Law feed heavy with court judgments, none hospitality.</span></p>\n<p>🔗 This edition on the web: <a href=\"https://eahospitalitypulse.com/editions/pulse-2026-08-19-morning.html\" rel=\"noopener\">eahospitalitypulse.com/editions/pulse-2026-08-19-mornin…</a></p>"
 },
 {
  "id": "pulse-2026-08-18-morning",
  "date": "2026-08-18",
  "dateDisplay": "Tuesday, 18 August 2026",
  "edition": "Morning Brief",
  "editionKey": "morning",
  "summary": "1️⃣ 🌍 THE AIRLIFT YOU'RE CELEBRATING IS THE LEAST PROFITABLE IN THE WORLD",
  "bodyHtml": "<p>🌅 <strong>EA HOSPITALITY PULSE — Morning Brief</strong><br>🗓 Tuesday 18 August 2026 | 🌍 🇰🇪 🇺🇬 🇷🇼 🇹🇿</p>\n<p><em>Expert Brief: East Africa is adding air routes faster than its airlines can afford to fly them.</em><br>━━━━━━━━━<br><strong>1️⃣ 🌍 THE AIRLIFT YOU&#x27;RE CELEBRATING IS THE LEAST PROFITABLE IN THE WORLD</strong></p>\n<p>Every route launch lands as good news in this business. Uganda Airlines opens Entebbe–Accra on 27 Oct and daily Entebbe–Kigali on 18 Nov (announced 5 Aug, The EastAfrican); Airlink starts Cape Town–Zanzibar on 3 Oct. Read the balance sheet underneath and the mood changes.</p>\n<p>IATA&#x27;s December outlook put African carriers at <strong>US$1.30 of profit per passenger</strong> for 2026 against a <strong>US$7.90</strong> global average — a <strong>1.3% margin, the thinnest of any region</strong> (IATA, 9 Dec 2025). By its June AGM it had cut the 2026 line again: profit per passenger down to <strong>40 US cents</strong> from US$2.10 in 2025, and the continent&#x27;s total net profit halved to <strong>~US$100m</strong> (IATA &quot;Energy in Crisis&quot; outlook, 8 Jun 2026). East Africa&#x27;s recovery is riding on the most fragile airlift economics on the planet.</p>\n<p><strong>What everyone is missing:</strong> a new-route press release reads as demand arriving. It is actually thin-margin capacity being <strong>lent</strong> — and thin-margin capacity is the first thing cut when a season underperforms. Turkish suspended 18 routes for summer 2026, Istanbul–Dar es Salaam among them, final flights in May/June (reported 2026). The route you don&#x27;t help fill in its first two seasons is the route that isn&#x27;t there in year three. Airlift is not infrastructure you inherit; it&#x27;s a trade relationship you keep alive.</p>\n<p><span class=\"tagline\">🏷 City/Bush/Beach · Regional · Confirmed (IATA figures &amp; schedules) / Inference (fragility read)</span><br><span class=\"sowhat\">🎯 <strong>So what — by segment:</strong> <strong>City</strong> (Nairobi/Kigali/Kampala): put corporate blocks and MICE contracts onto the new regional frequencies so they survive to a third season. <strong>Bush:</strong> the luxury pivot means fewer, higher-value guests who still need a long-haul seat — cultivate the carriers that actually serve your source markets. <strong>Beach:</strong> feeder routes are the most fragile of all — a trial like Cape Town–Zanzibar lives or dies on load factor. Fill it or lose it.</span></p>\n<p>━━━━━━━━━<br>✅ <strong>STILL TRUE</strong> — Tanzania &amp; Zanzibar remain US <strong>Level 3</strong> (unchanged since 31 Oct 2025); Kenya <strong>Level 2</strong>, core tourist corridors clear (travel.state.gov, verified 12 Aug). Nothing moved overnight. Don&#x27;t discount as though it had.</p>\n<p>⚡ <strong>COST PULSE</strong> — Nairobi diesel holds at <strong>KSh 217.86/L</strong> to 14 Sep; operators are carrying roughly <strong>KSh 14.28/L above landed-cost parity</strong> — refuse any supplier fuel surcharge this cycle (EPRA / Business Daily, 14 Aug).</p>\n<p>🎤 <strong>MICE WATCH</strong> — <strong>AfPIF</strong> (300–500 delegates) fills the Kigali Marriott cluster <strong>18–20 Aug</strong>; <strong>Hotel Expo Kenya</strong> at KICC, <strong>19–21 Aug</strong>. Hold corporate rate, don&#x27;t discount into the shoulder.</p>\n<p><span class=\"meta-line\">📅 <strong>WEEK AHEAD</strong> — <strong>18 Aug</strong> WHO IHR Committee on the Bundibugyo PHEIC · <strong>22 Aug</strong> Julius Nyerere hydropower inauguration, TZ · <strong>26–28 Aug</strong> Africa Global PR Week, Mövenpick Nairobi · <strong>28 Aug</strong> WTA Africa Gala, Zanzibar · <strong>late Aug</strong> KNBS/UBOS/NISR CPI prints.</span></p>\n<p><span class=\"meta-line\">📡 <strong>RADAR</strong> — 593 in-window observations to 08:17 EAT; feed live. Jambojet and Airlink press pages moved again behind Incapsula — a persistent blind spot, not a quiet night. Kenya Law feed heavy with court judgments, none hospitality. No advisory level moved.</span></p>\n<p><span class=\"meta-line\">💬 Which inbound route would you actually miss — and are you filling it, or just watching it?</span></p>\n<p>🔗 This edition on the web: <a href=\"https://eahospitalitypulse.com/editions/pulse-2026-08-18-morning.html\" rel=\"noopener\">eahospitalitypulse.com/editions/pulse-2026-08-18-mornin…</a><br>— EA Hospitality Pulse | Daily intelligence for city, bush &amp; beach properties</p>"
 },
 {
  "id": "pulse-2026-08-18-special",
  "date": "2026-08-18",
  "dateDisplay": "Tuesday, 18 August 2026",
  "edition": "Morning Brief",
  "editionKey": "morning",
  "summary": "1️⃣ 🇰🇪 THE COAST IS OUTGROWING THE GATEWAY — AND THE NATIONAL NUMBER HIDES IT",
  "bodyHtml": "<p>📊 <strong>EA HOSPITALITY PULSE — Special Edition</strong><br>🗓 Tuesday 18 August 2026 | 🇰🇪 KNBS data drop</p>\n<p><em>Kenya&#x27;s arrivals are up — but not where the headline says. Read the map before the margin.</em><br>━━━━━━━━━<br><strong>1️⃣ 🇰🇪 THE COAST IS OUTGROWING THE GATEWAY — AND THE NATIONAL NUMBER HIDES IT</strong></p>\n<p>Official visitor arrivals now run through April. Jan–Apr 2026: <strong>828,830, up 9.5%</strong> on the same months of 2025 (757,245) — Kenya Leading Economic Indicators, June 2026, KNBS, released 14 Aug.</p>\n<p>The headline is real. The distribution is the story. Mombasa&#x27;s Moi International (MIA) took <strong>96,701 arrivals, up 19.7%</strong> year-on-year, while JKIA grew <strong>8.5%</strong> and land borders <strong>7.5%</strong>. The coast is recovering over twice as fast as the Nairobi gateway.</p>\n<p><strong>What everyone is missing:</strong> the +9.5% is not evenly yours. In April — the long-rains trough — national arrivals rose just 2.9% and <strong>JKIA fell 1.0%</strong> YoY. Strip the coast out and the city-gateway recovery is modest and seasonal. A Nairobi GM reading &quot;+9.5%&quot; as their own demand is reading the wrong line. Backing it: SGR passengers ran <strong>~12% ahead</strong> in Q1 — the Nairobi–Mombasa corridor is carrying this (KNBS).</p>\n<p><span class=\"tagline\">🏷 City/Beach · Kenya · Confirmed (KNBS arrivals &amp; SGR) / Inference (regional read)</span><br><span class=\"sowhat\">🎯 <strong>So what:</strong> <strong>Coast</strong> — demand is arriving; hold rate through the Sep–Oct build and stop discounting. <strong>Nairobi</strong> — treat H1 as flat-to-soft on your own gateway; win share through corporate, MICE and regional traffic, not a rising tide.</span></p>\n<p><strong>2️⃣ 🇰🇪 THE CURRENCY IS QUIETLY REPRICING YOUR EUROPEAN GUEST</strong></p>\n<p>Over H1 2026 the shilling <strong>firmed</strong> against sterling (174.32→<strong>172.72</strong>) and the euro (151.37→<strong>149.22</strong>), flat against the dollar at <strong>~129.5</strong> (KNBS, June). Inflation sat at <strong>6.4%</strong>, the CBR held at <strong>8.75%</strong>.</p>\n<p>Read together: a European operator&#x27;s fixed FX budget now buys <strong>fewer shillings</strong> than in January — mild pressure on any KES-cost property selling into Europe, while dollar-priced lodges keep their spread intact.</p>\n<p><span class=\"tagline\">🏷 City/Bush/Beach · Kenya · Confirmed (KNBS forex/CPI) / Inference (pricing read)</span><br><span class=\"sowhat\">🎯 <strong>So what:</strong> If you cost in shillings and sell in euros or pounds, revisit 2027 contract rates now — the FX drift is against you. Price in USD and you&#x27;re insulated.</span></p>\n<p>━━━━━━━━━<br>🍲 <strong>SUPPLY-CHAIN SIDEBAR — where your southern-circuit kitchen shops</strong></p>\n<p>Informal cross-border trade <strong>fell 16.7%</strong> in 2025 (KSh 299.0m→249.1m), and <strong>Tanzania became the top source of informal imports at 47.2%</strong>, overwhelmingly <strong>food and live animals (78.5%)</strong> — KNBS Informal Cross-Border Trade Survey 2025, released 17 Aug. Main entry points: <strong>Namanga, Isebania, Malaba</strong> — the Amboseli, Mara and Uganda corridors.</p>\n<p><span class=\"sowhat\">🎯 <strong>So what:</strong> Southern-circuit lodges run partly on this informal Tanzanian fresh-food flow. A contracting, Tanzania-concentrated supply line is a produce-cost and continuity risk — worth a word with your F&amp;B suppliers before high season. 🏷 Bush · Confirmed (KNBS ICBT) / Inference.</span></p>\n<p>━━━━━━━━━<br>✅ <strong>STILL TRUE</strong> — Kenya remains US <strong>Level 2</strong>; core corridors (Nairobi, Diani, Watamu) sit in no Level 4 area (travel.state.gov, verified 12 Aug). Don&#x27;t discount on a story that hasn&#x27;t moved.</p>\n<p>⚡ <strong>COST PULSE</strong> — Nairobi diesel holds <strong>KSh 217.86/L</strong> to 14 Sep, ~KSh 14.28/L above landed-cost parity (EPRA / Business Daily, 14 Aug).</p>\n<p><span class=\"meta-line\">📅 <strong>WEEK AHEAD</strong> — <strong>19–21 Aug</strong> Hotel Expo Kenya, KICC · <strong>26–28 Aug</strong> Africa Global PR Week, Nairobi. Watch the <strong>May–June arrivals</strong> print to confirm the coast trend.</span></p>\n<p>🔗 This edition on the web: <a href=\"https://eahospitalitypulse.com/editions/pulse-2026-08-18-special.html\" rel=\"noopener\">eahospitalitypulse.com/editions/pulse-2026-08-18-specia…</a><br>— EA Hospitality Pulse | Daily intelligence for city, bush &amp; beach properties</p>"
 },
 {
 ...
 },
 {
  ...
  "edition": "Evening Wrap",
  "editionKey": "evening",
  "summary": "1️⃣ 🌍 THE VACCINE LINE IS NO LONGER SUPPORTABLE — AND THE RELEASE NUMBER ROSE",
  "bodyHtml": "<p>🌙 <strong>EA HOSPITALITY PULSE — Evening Wrap</strong><br>🗓 Sunday 16 August 2026 | 🌍 🇺🇬 🇰🇪</p>\n<p><em>Africa&#x27;s own scientists have put a number on the outbreak that decides Uganda&#x27;s US restriction. It went the wrong way — and the vaccine line is no longer supportable.</em><br>━━━━━━━━━<br><strong>1️⃣ 🌍 THE VACCINE LINE IS NO LONGER SUPPORTABLE — AND THE RELEASE NUMBER ROSE</strong></p>\n<p>At midday we said the condition freeing Uganda from the US entry order is a DRC number. Tonight we have it. Africa CDC&#x27;s Emergency Consultative Group, chaired by Prof. Salim Abdool Karim, reports <strong>4,449 confirmed cases, 2,061 deaths, 46.3% fatality</strong> in DRC, <strong>~100 new cases a day</strong>, <strong>R(t) consistently above 1</strong> (Africa CDC statement, <strong>14 August</strong>). Its words: the epidemic is &quot;still growing rapidly, and faster than previous Ebola epidemics.&quot; Against the US order&#x27;s 4,318 and WHO AFRO&#x27;s 4,381 for 9 August, the curve has not turned.</p>\n<p><strong>What everyone is missing: the vaccine sentence.</strong> On Ervebo against Bundibugyo the ECG is blunt — <strong>&quot;no reliable evidence of its clinical efficacy&quot;</strong>, and &quot;a reasonable chance the vaccine is not effective.&quot; It recommends use under <strong>trial protocol</strong>, not rollout.</p>\n<p>Since 2019 the reassurance script has been &quot;Ebola is vaccine-preventable.&quot; For this strain, Africa&#x27;s own experts say that is not established. And <strong>63% of deaths in the last fortnight occurred in the community</strong>, not treatment centres — detection, not capacity, is the constraint.</p>\n<p><span class=\"tagline\">🏷 Regional · Bush/City · Confirmed (Africa CDC ECG statement, 14 Aug) / Inference (release-condition read)</span><br><span class=\"sowhat\">🎯 <strong>So what:</strong> Strike the vaccine line from every agent script and insurer letter tonight. Use transmission facts instead — no Ugandan case since 21 June, none outside Kampala, no community spread. Brief 11 September as continuation, not release.</span></p>\n<p><strong>2️⃣ 🌍 TWO CDC PAGES, TWO DIFFERENT MAPS</strong></p>\n<p>We checked both tonight; we haven&#x27;t seen this reported anywhere.</p>\n<p>CDC&#x27;s <strong>Travel Health Notices index</strong> (read 16 Aug, ~19:00 EAT) states under Level 4: <em>&quot;Currently there are no Travel Health Notices at this level.&quot;</em> Its Ebola notices — Level 3 for <strong>Ituri, North and South Kivu</strong>, Level 2 for <strong>DRC and Uganda</strong> — are dated <strong>15 June 2026</strong>.</p>\n<p>CDC&#x27;s <strong>Ebola situation summary</strong> (page dated <strong>updated 12 August 2026</strong>) instead <em>&quot;recommends avoiding all travel to Ituri and Nord-Kivu... and avoiding nonessential travel to Haut-Uele and Tshopo.&quot;</em></p>\n<p>Not the same map. Risk vendors and insurers ingest the index because it is machine-readable — so a client&#x27;s system sees June while their risk officer reads August.</p>\n<p><span class=\"tagline\">🏷 Regional · City/Bush · Confirmed (both pages, with their own dates) / Inference (vendor-ingestion read)</span><br><span class=\"sowhat\">🎯 <strong>So what:</strong> When an account cites &quot;CDC guidance&quot;, ask which page, dated when. Neither names Kenya, Tanzania, Zanzibar or Rwanda — lead with that.</span></p>\n<p>━━━━━━━━━<br>✅ <strong>STILL TRUE</strong> — The live CDC index confirms our midday reading: <strong>Uganda at Level 2</strong>. Tanzania and Zanzibar remain US <strong>Level 3</strong>, unchanged since 31 Oct 2025 (travel.state.gov, verified 4 Aug). Don&#x27;t discount as though something moved.</p>\n<p>⚡ <strong>COST PULSE</strong> — Nairobi diesel holds at <strong>KSh 217.86/L</strong> to 14 Sep — ~<strong>KSh 14.28/L</strong> above landed-cost parity (EPRA / Business Daily, 14 Aug).</p>\n<p><span class=\"meta-line\">📅 <strong>WEEK AHEAD</strong> — <strong>17 Aug</strong> CDC comment window opens · <strong>18 Aug</strong> WHO IHR Committee on the PHEIC · <strong>18–20 Aug</strong> AfPIF, Kigali · <strong>19–21 Aug</strong> Hotel Expo Kenya, KICC · <strong>~28 Aug</strong> Uganda&#x27;s 42-day all-clear · <strong>28 Aug</strong> WTA Africa Gala, Zanzibar · <strong>11 Sep</strong> CDC decision.</span></p>\n<p><span class=\"meta-line\">💬 Which CDC page does your biggest corporate account read — have you asked?</span></p>\n<p>🔗 This edition on the web: <a href=\"https://eahospitalitypulse.com/editions/pulse-2026-08-16-evening.html\" rel=\"noopener\">eahospitalitypulse.com/editions/pulse-2026-08-16-evenin…</a><br>💼 Today&#x27;s Big Read on LinkedIn: <a href=\"https://www.linkedin.com/company/ea-hospitality-pulse/\" rel=\"noopener\">linkedin.com/company/ea-hospitality-pulse/</a><br>— EA Hospitality Pulse</p>"
 },
 {
  "id": "foresight-2026-08-16",
  "date": "2026-08-16",
  "dateDisplay": "Sunday, 16 August 2026",
  "edition": "Sunday Foresight",
  "editionKey": "foresight",
  "summary": "THE THEME: YOUR PACE REPORT ONLY SEES THE CHANNEL THAT'S SHRINKING",
  "bodyHtml": "<p><span class=\"meta-line\">🏨 <strong>EA HOSPITALITY PULSE — Sunday Foresight</strong></span><br>🗓 Sunday 16 August 2026 | 🇹🇿 🇰🇪 🇺🇬 🇷🇼</p>\n<p><strong>THE THEME: YOUR PACE REPORT ONLY SEES THE CHANNEL THAT&#x27;S SHRINKING</strong></p>\n<p>Two numbers landed three days apart. On <strong>12 Aug</strong> TUI reported Summer 2026 booked revenue <strong>down 6%</strong> season-to-date (TUI Q3 FY26). On <strong>14 Aug</strong> Zanzibar posted July arrivals of <strong>107,801</strong> — an all-time record, <strong>+9.6%</strong> year on year (OCGS via The Citizen). Both true, and compatible only one way: the growth arrives through channels that produce no forward booking. Europe&#x27;s share fell from <strong>61.9% in June to 56.4% in July</strong>; on our calculation non-European arrivals grew about <strong>+77%</strong> month-on-month against Europe&#x27;s <strong>+41%</strong>.</p>\n<p><strong>What everyone is missing:</strong> this is a measurement failure before it is a demand story. Pace and allocation were built on the shrinking channel and barely see the growing one, so the pace report shows a hole that isn&#x27;t there — and the reflex is to discount into it. The short-window channel also cancels at double the rate: <strong>21.8% OTA vs 10.6% direct</strong> (Cloudbeds, 25 Mar 2026).</p>\n<p>━━━━━━━━━<br><strong>THE WEEK&#x27;S SIGNALS</strong></p>\n<p><strong>1️⃣ 🇹🇿 THE OPERATOR ISN&#x27;T LEAVING — IT&#x27;S ARRIVING LATE</strong><br>TUI&#x27;s Q3 revenue fell 5.6% to €5.8bn, yet it <strong>reaffirmed FY EBIT guidance of €1.1–1.4bn</strong>, last four weeks <strong>+7%</strong> (12 Aug). Its Winter 2027 programme centres on Zanzibar: first UK direct package flights, Gatwick twice weekly from <strong>3 Nov 2027</strong> (TUI newsroom, 2 Jul 2026).<br><span class=\"sowhat\">🎯 <strong>So what:</strong> Don&#x27;t sign multi-year allocation on 2026 terms. A low net rate locked now expires exactly when pricing power returns.</span><br><span class=\"tagline\">🏷 Beach · Zanzibar/Global · Confirmed</span></p>\n<p><strong>2️⃣ 🇹🇿 A RECORD MONTH THAT WASN&#x27;T EUROPEAN</strong><br>July&#x27;s 107,801 was <strong>2.68× May&#x27;s 40,151</strong> — a wider peak-to-trough swing than a year ago, not a narrower one (OCGS, 14 Aug).<br><span class=\"sowhat\">🎯 <strong>So what:</strong> Split pace into two lines with two lead times — allocation, and direct+OTA. A blended line measures a shrinking share of the book and calls it the whole book.</span><br><span class=\"tagline\">🏷 Beach · Tanzania/Zanzibar · Confirmed (OCGS) / Inference</span></p>\n<p><strong>3️⃣ 🇺🇬 WASHINGTON KEEPS UGANDA RESTRICTED ON A CONGOLESE NUMBER</strong><br>The US entry order signed 12 Aug publishes <strong>17 Aug</strong> (FR Doc 2026-16706, docket CDC-2026-0892): it logs Uganda&#x27;s 28 July all-clear, then keeps Uganda listed on cross-border grounds. Expiry <strong>11 Sep</strong>, comments close ~<strong>1 Sep</strong>. WHO AFRO put DRC at <strong>4,381 confirmed, CFR 45.9%</strong> as of 9 Aug (SitRep 13, 11 Aug).<br><span class=\"sowhat\">🎯 <strong>So what:</strong> Brief agents to 11 Sep, not 28 Aug — and file on the docket before ~1 Sep. This industry never has.</span><br><span class=\"tagline\">🏷 Uganda/Regional · Bush/City · Confirmed</span></p>\n<p><strong>4️⃣ ✅ LEDGER — P062 CORRECT</strong> — we called Europe ≥55% in the next OCGS release (10 Aug); it printed <strong>56.4%</strong> (14 Aug). A ceiling, not a floor.</p>\n<p>━━━━━━━━━<br><span class=\"meta-line\">📡 <strong>30/90-DAY DEMAND CALENDAR</strong></span></p>\n<p>🌍 <strong>18 Aug</strong> — WHO IHR Committee on the PHEIC. <strong>Don&#x27;t pre-brief a downgrade.</strong><br>🇰🇪 <strong>19 Aug</strong> — Kenya Draft 2026 BROP comment closes. <strong>File via your association.</strong><br>🇹🇿 <strong>28 Aug</strong> — WTA Africa Gala, Zanzibar. <strong>Coast compression that week.</strong><br>🌍 <strong>11 Sep</strong> — US entry order decision. <strong>Brief US agents to this date, not 28 Aug.</strong><br>🇰🇪 <strong>~15 Sep</strong> — EPRA fuel review. <strong>No cushion left; model a step-up.</strong><br>🇹🇿 <strong>~mid-Sep</strong> — OCGS Zanzibar August arrivals. <strong>Europe under 60% = structural.</strong><br>🇹🇿 <strong>3 Oct</strong> — Airlink&#x27;s first Cape Town–Zanzibar non-stop. <strong>Get SA trade on your rate sheet.</strong><br>🇰🇪 <strong>6–8 Oct</strong> — MKTE Nairobi, 10,000+ delegates. <strong>Close out standard rate now.</strong></p>\n<p><span class=\"meta-line\">💬 Split your pace report by channel tomorrow — would it change a rate decision you&#x27;ve already made?</span></p>\n<p>🔗 This edition on the web: <a href=\"https://eahospitalitypulse.com/editions/foresight-2026-08-16.html\" rel=\"noopener\">eahospitalitypulse.com/editions/foresight-2026-08-16.html</a><br>💼 This week&#x27;s Big Read on LinkedIn: <a href=\"https://www.linkedin.com/company/ea-hospitality-pulse/\" rel=\"noopener\">linkedin.com/company/ea-hospitality-pulse/</a><br>— EA Hospitality Pulse | Daily intelligence for city, bush &amp; beach properties</p>"
 },
 {
  "id": "pulse-2026-08-16-midday",
  "date": "2026-08-16",
  "dateDisplay": "Sunday, 16 August 2026",
  "edition": "Midday Pulse",
  "editionKey": "midday",
  "summary": "1️⃣ 🇺🇬 WASHINGTON ALREADY WRITES UGANDA IN THE PAST TENSE — AND KEEPS IT RESTRICTED ANYWAY",
  "bodyHtml": "<p><span class=\"meta-line\">🏨 <strong>EA HOSPITALITY PULSE — Midday Pulse</strong></span><br>🗓 Sunday 16 August 2026 | 🇺🇬 🇰🇪 🌍</p>\n<p><em>The order that keeps Uganda restricted was filed on Friday and publishes tomorrow. We&#x27;ve read it. Uganda&#x27;s 28 August all-clear is not what releases it.</em><br>━━━━━━━━━<br><strong>1️⃣ 🇺🇬 WASHINGTON ALREADY WRITES UGANDA IN THE PAST TENSE — AND KEEPS IT RESTRICTED ANYWAY</strong></p>\n<p>The full text of the US entry order signed on <strong>12 August</strong> went on public inspection at the Federal Register on <strong>14 August, 08:45</strong> and publishes <strong>17 August</strong> (FR Doc <strong>2026-16706</strong>, docket <strong>CDC-2026-0892</strong>). We read it this morning on public inspection; we haven&#x27;t seen it reported anywhere yet.</p>\n<p>Two things in it matter more than the renewal we covered on 13 August.</p>\n<p><strong>First, the operative finding.</strong> The determination reads that Ebola is <em>&quot;confirmed currently present in DRC and <strong>recently present in Uganda</strong>.&quot;</em> Past tense — in a document that keeps Uganda on the restricted list. The order records Uganda&#x27;s last confirmed case as <strong>21 June</strong>, 20 confirmed cases and two deaths in total, and the Ministry of Health declaration of <strong>28 July</strong>. It then keeps Uganda in on a stated ground that has nothing to do with Uganda&#x27;s epidemiology: <em>&quot;continued overland travel from DRC poses an ongoing risk of cross-border transmission, particularly among healthcare workers and in western Ugandan districts.&quot;</em></p>\n<p><strong>What everyone is missing:</strong> the release condition is a DRC number, not a Ugandan one. The order names contact tracing at <strong>~78% nationwide against a 95% operational threshold</strong>, says the true outbreak size may be <em>&quot;two to four times greater&quot;</em> than reported, and puts DRC at <strong>4,318 confirmed cases and 2,011 deaths across 53 health zones</strong> as of 9 August — against <strong>1,873 and 672 across 41 zones</strong> when the July order was signed. Uganda&#x27;s 42-day clock completing around <strong>28 August</strong> does not move any of those. Expiry is <strong>4:59pm EDT, Friday 11 September</strong>.</p>\n<p><strong>Second, there is a door, and nobody has walked through it.</strong> Publication on 17 August opens a <strong>15-day comment period</strong> on docket CDC-2026-0892 — closing on or about <strong>1 September</strong>, ahead of the 11 September call. The order records the comments received so far: <strong>three</strong> on the original, <strong>five</strong> in June, and on the July renewal, <em>none</em>. The East African trade has never filed.</p>\n<p><span class=\"tagline\">🏷 Uganda/Regional · Bush/City · Confirmed (FR Doc 2026-16706, public inspection 14 Aug) / Inference (release-condition read)</span><br><span class=\"sowhat\">🎯 <strong>So what:</strong> Stop selling 28 August as the turning point — brief agents that the US rule is priced to run to 11 September, and rebook US arrivals accordingly. If you want Uganda decoupled, the comment docket is the only formal channel into the risk assessment that decides it, it costs nothing, and it closes ~1 September.</span></p>\n<p><strong>2️⃣ 🌍 TWO OFFICIAL CASE COUNTS FOR THE SAME DAY — 63 APART</strong></p>\n<p>Worth knowing before you quote a number to an agent or an insurer. For <strong>9 August</strong>, the US order states DRC at <strong>4,318 confirmed cases</strong> across <strong>53 health zones</strong>. WHO AFRO&#x27;s Weekly External Situation Report 13, same reporting date, states <strong>4,381 confirmed cases and 2,011 deaths, a case fatality ratio of 45.9%</strong>, with Ituri accounting for 85.8% of cumulative cases (afro.who.int, posted 11 Aug).</p>\n<p>Deaths agree exactly. Cases differ by 63. Neither is wrong — the US figure is a snapshot taken for an American risk assessment; WHO AFRO&#x27;s is the regional surveillance line. But they will be quoted against each other in the coming fortnight, and being caught with the lower one looks like minimising.</p>\n<p><span class=\"tagline\">🏷 Regional · Bush/City · Confirmed (both documents, dated)</span><br><span class=\"sowhat\">🎯 <strong>So what:</strong> Standardise on WHO AFRO for any client-facing figure, cite it with the report number and date, and never quote an outbreak number without one.</span></p>\n<p>━━━━━━━━━<br>✅ <strong>STILL TRUE</strong> — The order leaves the CDC travel health notice for <strong>all of Uganda at Level 2</strong> (practice enhanced precautions), with Level 4 confined to <strong>Ituri and North Kivu in DRC</strong> (escalated 4 Aug) and Level 3 to South Kivu, Haut-Uélé and Tshopo. Also unchanged since the July order: <strong>Nairobi JKIA is named as a transit corridor of concern and Kenya itself is not restricted</strong>. Nothing here has moved. Don&#x27;t discount as though it had — and don&#x27;t let a risk team read old text as new.</p>\n<p>⚡ <strong>COST PULSE</strong> — Uganda inflation <strong>3.7%</strong> annual (UBOS, June 2026), but liquid energy fuels ran <strong>+26.2% year-on-year</strong>, pushing passenger transport to 11.9%. Ugandan lodge transfer and generator lines are rising faster than the headline suggests.</p>\n<p><span class=\"meta-line\">📅 <strong>WEEK AHEAD</strong> — <strong>17 Aug</strong> FR publication opens the CDC comment window · <strong>~17 Aug</strong> WHO AFRO SitRep 14 · <strong>18 Aug</strong> WHO IHR Committee on the Bundibugyo PHEIC · <strong>18–20 Aug</strong> AfPIF, Kigali Marriott · <strong>19–21 Aug</strong> Hotel Expo Kenya, KICC · <strong>~1 Sep</strong> comment deadline · <strong>11 Sep</strong> CDC decision.</span></p>\n<p><span class=\"meta-line\">💬 Has anyone in your market actually filed a comment on a US entry order — or have we all just briefed around it?</span></p>\n<p>🔗 This edition on the web: <a href=\"https://eahospitalitypulse.com/editions/pulse-2026-08-16-midday.html\" rel=\"noopener\">eahospitalitypulse.com/editions/pulse-2026-08-16-midday…</a><br>— EA Hospitality Pulse | Daily intelligence for city, bush &amp; beach properties</p>"
 },
 {
  "id": "pulse-2026-08-16-morning",
  "date": "2026-08-16",
  "dateDisplay": "Sunday, 16 August 2026",
  "edition": "Morning Brief",
  "editionKey": "morning",
  "summary": "1️⃣ 🇹🇿 ZANZIBAR'S RECORD JULY WIDENED THE GAP IT SHOULD HAVE CLOSED",
  "bodyHtml": "<p>🌅 <strong>EA HOSPITALITY PULSE — Morning Brief</strong><br>🗓 Sunday 16 August 2026 | 🇹🇿 🇰🇪 🇷🇼</p>\n<p><em>Zanzibar just posted its best July on record. The number that should worry you is May&#x27;s.</em><br>━━━━━━━━━<br><strong>1️⃣ 🇹🇿 ZANZIBAR&#x27;S RECORD JULY WIDENED THE GAP IT SHOULD HAVE CLOSED</strong></p>\n<p><strong>107,801</strong> visitors in July — an all-time monthly record, <strong>+9.6%</strong> on July 2025&#x27;s 98,370 (OCGS, via The Citizen, 14 Aug). It was also <strong>+54.9%</strong> on June&#x27;s 69,605, and <strong>2.68× May&#x27;s 40,151</strong>.</p>\n<p>A year earlier that same step was +45.7%. The swing didn&#x27;t narrow. It widened by nine points. The Maldives, on months published so far in 2026, ran 247,722 in February to 123,552 in June — <strong>2.01×</strong> (Maldives Monetary Authority). Definitions differ, but the direction isn&#x27;t in doubt: Zanzibar is getting better at selling ten weeks and no better at selling the other forty-two.</p>\n<p><strong>What everyone is missing:</strong> the record was disproportionately <strong>not</strong> European. Europe supplied 60,754, yet its share fell from <strong>61.9%</strong> in June to <strong>56.4%</strong> in July. Back out the residual and non-European arrivals grew <strong>+77.5%</strong> month-on-month, against Europe&#x27;s +40.9%. The marginal guest is increasingly African, Gulf and Asian — booking shorter, later, outside European tour-operator rails. That is the only demand that doesn&#x27;t obey a European school calendar, and the only demand that can flatten this curve.</p>\n<p><span class=\"tagline\">🏷 Beach · Tanzania/Zanzibar · Confirmed (OCGS &amp; MMA figures) / Inference (amplitude read)</span><br><span class=\"sowhat\">🎯 <strong>So what:</strong> Price April–May as an unbuilt product, not a failed season. Aim shoulder inventory at the segment that just grew 77.5% — regional and Gulf, direct, short-stay, own-channel.</span></p>\n<p><strong>2️⃣ 🇹🇿 THE ROUTE EVERYONE IS FILING UNDER &#x27;NICE TO HAVE&#x27;</strong></p>\n<p>Airlink starts the first-ever non-stop Cape Town–Zanzibar service on <strong>3 October 2026</strong> — Saturdays, year-round, E195-E2, 124 seats (Airlink, via TATO/Tourism Update, Aug 2026).</p>\n<p>Reported as a leisure route. Read it as a seasonality instrument: year-round regional airlift from a market whose holiday calendar doesn&#x27;t track Europe&#x27;s. One rotation won&#x27;t flatten a 2.68× curve — but it&#x27;s the <strong>shape</strong> of the thing that does.</p>\n<p><span class=\"tagline\">🏷 Beach · Tanzania/South Africa · Confirmed (schedule) / Inference (read)</span><br><span class=\"sowhat\">🎯 <strong>So what:</strong> If you sell Zanzibar, get South African trade and Cape Town connecting traffic onto your rate sheet before October.</span></p>\n<p>━━━━━━━━━<br>✅ <strong>STILL TRUE</strong> — Tanzania and Zanzibar remain US <strong>Level 3</strong>, unchanged since 31 Oct 2025 (travel.state.gov, verified 4 Aug 2026); the UK has no advisory against travel to Zanzibar. Nothing changed. Don&#x27;t discount as though it had.</p>\n<p>⚡ <strong>COST PULSE</strong> — Nairobi diesel holds at <strong>KSh 217.86/L</strong> to 14 Sep; operators carry roughly <strong>KSh 14.28/L</strong> above landed-cost parity (EPRA / Business Daily, 14 Aug).</p>\n<p><span class=\"meta-line\">📅 <strong>WEEK AHEAD</strong> — <strong>~17 Aug</strong> WHO AFRO Ebola SitRep 14 · <strong>18 Aug</strong> WHO IHR Committee on the Bundibugyo PHEIC · <strong>18–20 Aug</strong> AfPIF, Kigali Marriott · <strong>19–21 Aug</strong> Hotel Expo Kenya, KICC · <strong>28 Aug</strong> WTA Africa Gala, Zanzibar.</span></p>\n<p><span class=\"meta-line\">📡 <strong>RADAR</strong> — 178 in-window observations to 06:16 EAT. Jambojet&#x27;s press page moved twice overnight, Airlink&#x27;s once, all behind Incapsula — a persistent blind spot, not a quiet night. No advisory level moved.</span></p>\n<p><span class=\"meta-line\">💬 What does your April–May calendar actually sell — or does it just close?</span></p>\n<p>🔗 This edition on the web: <a href=\"https://eahospitalitypulse.com/editions/pulse-2026-08-16-morning.html\" rel=\"noopener\">eahospitalitypulse.com/editions/pulse-2026-08-16-mornin…</a><br>— EA Hospitality Pulse | Daily intelligence for city, bush &amp; beach properties</p>"
 },
 {
  "id": "pulse-2026-08-15-morning",
  "date": "2026-08-15",
  "dateDisplay": "Saturday, 15 August 2026",
  "edition": "Morning Brief",
  "editionKey": "morning",
  "summary": "1️⃣ 🇰🇪 YOU GOT SH5 OFF DIESEL. THE MARKET GAVE SH19.28",
  "bodyHtml": "<p>🌅 <strong>EA HOSPITALITY PULSE — Morning Brief</strong><br>🗓 Saturday 15 August 2026 | 🇰🇪 🇷🇼 🇹🇿</p>\n<p><em>Your diesel got Sh5 cheaper today. The market said it should have been Sh19.28. The gap is the story.</em><br>━━━━━━━━━<br><strong>1️⃣ 🇰🇪 YOU GOT SH5 OFF DIESEL. THE MARKET GAVE SH19.28</strong></p>\n<p>EPRA&#x27;s schedule takes effect <strong>today</strong>, to 14 September: Nairobi diesel <strong>Sh217.86/L</strong> (–Sh5), petrol held at <strong>Sh214.03</strong>, kerosene <strong>Sh191.38</strong>.</p>\n<p>But landed diesel fell <strong>13.08%</strong> last month — US$855.59/m³ from US$984.37 — while landed petrol <strong>rose 6.9%</strong>. On the regulator&#x27;s own disclosures diesel should have dropped <strong>Sh19.28, to Sh203.58</strong>. The State used diesel to cross-subsidise petrol, plus <strong>Sh938m</strong> of stabilisation (Business Daily, 14 Aug, quoting acting EPRA DG Joseph Oketch).</p>\n<p><strong>What everyone is missing:</strong> the Sh5 isn&#x27;t relief. Diesel is the safari cost line — game drives, transfers, generators, boreholes, laundry — and operators are carrying <strong>Sh14.28/L</strong> above market so Nairobi&#x27;s motorists don&#x27;t feel the Iran-war spike. The funding is running out: the Petroleum Development Levy kitty is nearly depleted, the Exchequer is behind on arrears to marketers, and MPs have called the cross-subsidy illegal. It is in court.</p>\n<p><span class=\"tagline\">🏷 Kenya · Bush/Beach/City · Confirmed (EPRA + BD, 14 Aug) / Inference (next-cycle read)</span><br><span class=\"sowhat\">🎯 <strong>So what:</strong> (1) <strong>Refuse any supplier fuel surcharge this cycle</strong> — global diesel fell 13.08%; cite the number. (2) Don&#x27;t budget the Sh5 forward. With the PDL kitty empty and the 8% fuel-VAT concession expiring <strong>14 October</strong>, the September cycle has no cushion. Lock transfer and generator contracts now.</span></p>\n<p><strong>2️⃣ 🇰🇪 TREASURY&#x27;S SUMS DON&#x27;T ADD UP — COMMENTS CLOSE TUESDAY</strong></p>\n<p>The <strong>Draft 2026 Budget Review and Outlook Paper</strong> is open for public participation, <strong>comments due close of business Tue 19 August</strong>, Cabinet by 26 August (Treasury notice; Mwango Capital, 14 Aug). It cuts the FY2026/27 KRA target <strong>Sh81.4bn to Sh2.777tn</strong> — VAT –Sh18.9bn, excise –Sh17.4bn — then projects FY2027/28 revenue of <strong>Sh3.943tn</strong> against <strong>Sh5.323tn</strong> spending: a <strong>Sh1.321tn</strong> deficit, 5.7% of GDP (Business Daily, 11 Aug; People Daily, 14 Aug).</p>\n<p>Revenue must climb roughly <strong>Sh1.17tn in one year</strong> off a base just revised <strong>down</strong>. Growth of 5.0% doesn&#x27;t deliver that. The BROP&#x27;s stated answer is compliance and <strong>a broader tax base</strong> — enforcement, not headline rates.</p>\n<p><span class=\"tagline\">🏷 Kenya · City/Bush/Beach · Confirmed (BROP + BD) / Inference (base-broadening read)</span><br><span class=\"sowhat\">🎯 <strong>So what:</strong> Cash-heavy F&amp;B, fragmented STR supply, a levy base nobody has mapped — hospitality is a textbook base-broadening target. Get your association&#x27;s submission in by <strong>Tuesday</strong>. Budget for tighter eTIMS enforcement, not a new rate.</span></p>\n<p>━━━━━━━━━<br>✅ <strong>STILL TRUE</strong> — Rwanda&#x27;s gorilla permit holds at <strong>US$1,500</strong> (RDB, 2026); Uganda&#x27;s low-season permit stays <strong>US$600</strong> in April, May and November (UWA). Sell the discount that already exists rather than cutting your own rate.</p>\n<p>⚡ <strong>COST PULSE</strong> — Kenya&#x27;s electricity pass-throughs: fuel-energy-cost <strong>KSh 3.20/unit</strong> plus forex <strong>KSh 1.48/unit</strong> (July 2026 billing, EPRA).</p>\n<p><span class=\"meta-line\">📅 <strong>WEEK AHEAD</strong> — <strong>18 Aug</strong> WHO IHR Committee on the Bundibugyo PHEIC · <strong>18–20 Aug</strong> AfPIF, Kigali Marriott · <strong>19–21 Aug</strong> Hotel Expo Kenya, KICC · <strong>28 Aug</strong> WTA Africa Gala, Zanzibar · <strong>29 Aug</strong> Canada&#x27;s quarantine measures expire.</span></p>\n<p><span class=\"meta-line\">📡 <strong>RADAR</strong> — 421 in-window observations to 07:55 EAT. Jambojet&#x27;s press page changed four times in 38 hours but sits behind Incapsula: a live blind spot. Next fuel decision <strong>~14 Sep</strong>; next CDC Ebola cycle <strong>~10–11 Sep</strong>.</span></p>\n<p><span class=\"meta-line\">💬 Has a supplier tried a fuel surcharge on you this month?</span></p>\n<p>🔗 This edition on the web: <a href=\"https://eahospitalitypulse.com/editions/pulse-2026-08-15-morning.html\" rel=\"noopener\">eahospitalitypulse.com/editions/pulse-2026-08-15-mornin…</a><br>— EA Hospitality Pulse | Daily intelligence for city, bush &amp; beach properties</p>"
 },
 {
  "id": "pulse-2026-08-13-midday",
  "date": "2026-08-13",
  "dateDisplay": "Thursday, 13 August 2026",
  "edition": "Midday Pulse",
  "editionKey": "midday",
  "summary": "1️⃣ 🇷🇼 RWANDA IS BUYING YIELD, NOT VOLUME — AND AIRLIFT IS THE CATCH",
  "bodyHtml": "<p><span class=\"meta-line\">🏨 <strong>EA HOSPITALITY PULSE — Midday Pulse</strong></span><br>🗓 Thursday 13 August 2026 | 🇷🇼 🇿🇦 🌍</p>\n<p><em>A quiet news day, so a longer look: Rwanda is doubling down on yield-per-guest. The catch is one everyone keeps forgetting.</em><br>━━━━━━━━━<br><strong>1️⃣ 🇷🇼 RWANDA IS BUYING YIELD, NOT VOLUME — AND AIRLIFT IS THE CATCH</strong></p>\n<p>Two signings a fortnight apart tell one story. The Lux Collective is bringing a *<strong>five-property LUX</strong>/SALT circuit<strong> to Rwanda with Cleo Capital and </strong>RSSB<strong> — inked at the Africa CEO Forum in Kigali, announced </strong>31 July 2026<strong>. Phase one (mid-2026) rebrands Cleo Lake Kivu as </strong>LUX* Lake Kivu<strong> and Akagera Game Lodge as </strong>SALT of Akagera*<strong>; phase two adds three greenfield LUX</strong> at Volcanoes, Nyungwe and Akagera for <strong>2028</strong>. Alongside it, the <strong>15th AfPIF</strong> brings 300–500 delegates to the <strong>Kigali Marriott, 18–20 August</strong> — one node in an RDB <strong>MICE revenue target of US$156m for 2026</strong> ($130m in 2025, $187m projected 2027, per RDB). Kigali has held <strong>Africa&#x27;s No.2 meetings city</strong> for five straight years behind Cape Town (2024 ICCA rankings).</p>\n<p><strong>What everyone is missing:</strong> both bets land into the same constraint — thin, expensive intra-African airlift. Rwanda issues just <strong>112 gorilla permits a day</strong> (RDB); five new branded properties add rooms, not seats and not permits. The near-term effect of new supply is <strong>yield pressure on existing premium camps</strong>, not net new demand — more branded beds chasing a permit-capped, seat-capped market. South Africa&#x27;s headline &quot;arrivals&quot; push is a volume play; the real rival threat isn&#x27;t its visitor number, it&#x27;s Southern Africa and Morocco <strong>buying long-haul lift</strong>. Lift, not brand, is the battleground.</p>\n<p><span class=\"tagline\">🏷 Rwanda/Regional · Bush/City · Confirmed (deals + figures) / Inference (yield read)</span><br><span class=\"sowhat\">🎯 <strong>So what — bush:</strong> The Lux pipeline is a 2028 supply shock into a market capped at 112 permits/day. Lock DMC allocations and rate parity for 2028 peak <strong>now</strong>, before branded supply resets the anchor. Watch construction-phase generator and utility load near Kivu, Volcanoes and Nyungwe sites.</span><br><span class=\"sowhat\">🎯 <strong>So what — city:</strong> Hold corporate rate through AfPIF week (18–21 Aug) rather than discounting into association-conference compression — but right-size it: 300–500 delegates fills the Marriott and its near neighbours, not all of Kigali.</span><br><span class=\"sowhat\">🎯 <strong>So what — Kenya/Tanzania:</strong> Rwanda&#x27;s yield-per-guest model is the template. Sell the multi-country EA itinerary Southern Africa structurally can&#x27;t match — gorillas <strong>plus</strong> savannah <strong>plus</strong> beach — because the rival fight is over airlift, and EA&#x27;s answer is a bundled product, not a price war.</span></p>\n<p>━━━━━━━━━<br><span class=\"meta-line\">📅 <strong>MICE WATCH</strong> — <strong>15th AfPIF</strong>, Kigali Marriott, <strong>18–20 Aug</strong> (300–500 delegates, af-ix.org). One entry in Rwanda&#x27;s <strong>US$156m</strong> 2026 MICE target (RDB).</span></p>\n<p>✅ <strong>STILL TRUE</strong> — Rwanda gorilla permit holds at <strong>US$1,500</strong> for foreign non-residents (RDB, 2026): the region&#x27;s priciest single wildlife ticket, and the pricing anchor the new LUX* supply is built around. Don&#x27;t model a discount into 2028.</p>\n<p><span class=\"meta-line\">📅 <strong>WEEK AHEAD</strong> — EPRA Kenya fuel review <strong>~14 Aug</strong>; <strong>WHO IHR Emergency Committee 18 Aug</strong>; <strong>Hotel Expo Kenya 19–21 Aug</strong> (KICC); <strong>WTA Africa Gala</strong>, Zanzibar, <strong>28 Aug</strong>.</span></p>\n<p><span class=\"meta-line\">💬 If new branded supply lands into fixed permits and fixed seats, does it grow the market — or just re-price it?</span></p>\n<p>🔗 This edition on the web: <a href=\"https://eahospitalitypulse.com/editions/pulse-2026-08-13-midday.html\" rel=\"noopener\">eahospitalitypulse.com/editions/pulse-2026-08-13-midday…</a><br>— EA Hospitality Pulse | Daily intelligence for city, bush &amp; beach properties</p>"
 },
 {
  "id": "pulse-2026-08-13-morning",
  "date": "2026-08-13",
  "dateDisplay": "Thursday, 13 August 2026",
  "edition": "Morning Brief",
  "editionKey": "morning",
  "summary": "1️⃣ 🇺🇸→🇺🇬 THE US RENEWED, AND UGANDA STAYED COUPLED",
  "bodyHtml": "<p>🌅 <strong>EA HOSPITALITY PULSE — Morning Brief</strong><br>🗓 Thursday 13 August 2026 | 🇺🇬 🇨🇦 🇺🇸</p>\n<p><em>Yesterday we said the framework was being re-decided. It was. Uganda stayed coupled — and the harder rule isn&#x27;t American.</em><br>━━━━━━━━━<br><strong>1️⃣ 🇺🇸→🇺🇬 THE US RENEWED, AND UGANDA STAYED COUPLED</strong></p>\n<p>CDC&#x27;s returning-travellers page, updated <strong>12 August 2026</strong>, cites the agency&#x27;s &quot;renewed August 12 order, under 42 CFR 71.40&quot; continuing restrictions for travellers recently in <strong>DRC, Uganda or South Sudan</strong>. The signed order landed on CDC&#x27;s server as `August-T42-Order_08.11.2026-signed.pdf` — our radar first saw it at <strong>22:51 EAT on 12 August</strong>. CDC&#x27;s own legal-authorities page still reads &quot;July 20, 2026&quot; and still names 13 July as current: the renewal is real, the canonical page hasn&#x27;t caught up.</p>\n<p>Substance unchanged. DRC is a hard 21-day block on everyone, US citizens included. From Uganda or South Sudan, US citizens aren&#x27;t restricted but are <strong>rerouted to Dulles, Atlanta, Houston or JFK</strong> for screening. Green Card holders are named as restricted.</p>\n<p><span class=\"tagline\">🏷 Uganda/Regional · Bush/City · Confirmed (CDC pages, 12 Aug)</span><br><span class=\"sowhat\">🎯 <strong>So what:</strong> The decoupling didn&#x27;t happen. Brief agents that the rule is <strong>unchanged</strong>, not lifted — the 28 July Ebola-free declaration bought nothing at the US border. Next decision ~10–11 September.</span></p>\n<p><strong>2️⃣ 🇨🇦 CANADA IS THE HARDER RULE — AND NOBODY IS QUOTING IT</strong></p>\n<p>Per travel.gc.ca (notice modified <strong>23 July 2026</strong>), since 20 July anyone who has been in <strong>Uganda or South Sudan</strong> in the past 21 days may travel to Canada but <strong>must quarantine 21 days on arrival</strong> unless exempt. DRC arrivals are barred outright. The measures run under the Quarantine Act to <strong>29 August 2026, 23:59 EDT</strong>.</p>\n<p><span class=\"tagline\">🏷 Uganda/Rwanda · Bush · Confirmed (Government of Canada, 23 Jul)</span><br><span class=\"sowhat\">🎯 <strong>So what:</strong> For a US guest the rule is a nuisance; for a Canadian it eats three weeks of annual leave on the way home. Audit your North American book and split the comms — one line covering &quot;North America&quot; is wrong. And 29 August is a stated expiry, not a rolling renewal.</span></p>\n<p><strong>3️⃣ 🇺🇬 KAMPALA KEEPS THE BORDER MARKETS SHUT</strong></p>\n<p>Health Minister Dr Chris Baryomunsi told Parliament on <strong>12 August</strong> that markets and large gatherings stay closed in DRC-border communities despite the 28 July declaration: <em>&quot;We are seeing that the infection rates are quickly approaching the borders of Uganda.&quot;</em> DRC has passed 2,000 deaths and 4,300 cases. The task force reviews the measures <strong>next week</strong> (New Vision, 12 Aug).</p>\n<p><span class=\"tagline\">🏷 Uganda · Bush/City · Confirmed</span><br><span class=\"sowhat\">🎯 <strong>So what:</strong> Kampala isn&#x27;t acting as though the threat has passed — precisely the argument foreign advisory desks will cite to hold Level 4. Don&#x27;t build a September push on &quot;Uganda is Ebola-free.&quot;</span></p>\n<p>━━━━━━━━━<br>✅ <strong>STILL TRUE</strong> — Uganda US <strong>Level 4</strong>; Kenya <strong>Level 2</strong> (Eastleigh and Kibera L4); Tanzania &amp; Zanzibar <strong>Level 3</strong>.</p>\n<p><span class=\"meta-line\">📅 <strong>WEEK AHEAD</strong> — EPRA fuel review <strong>~14 Aug</strong>, effective 15 Aug; <strong>WHO IHR Emergency Committee 18 Aug</strong>; <strong>Hotel Expo Kenya 19–21 Aug</strong> (KICC); <strong>WTA Africa Gala</strong>, Zanzibar, <strong>28 Aug</strong>.</span></p>\n<p><span class=\"meta-line\">📡 <strong>RADAR</strong> — 516 in-window observations to 08:51 EAT. Four dates now decide Uganda&#x27;s autumn: <strong>18 Aug</strong> WHO IHR committee · <strong>~28 Aug</strong> Uganda&#x27;s 42-day all-clear completes · <strong>29 Aug</strong> Canada&#x27;s measures expire · <strong>~10–11 Sept</strong> next CDC cycle. Uganda&#x27;s best case for decoupling lands in the same fortnight Ottawa must decide whether to renew.</span></p>\n<p><span class=\"meta-line\">💬 Have you split your US and Canadian agent comms — or is it still one &quot;North America&quot; line?</span></p>\n<p>🔗 This edition on the web: <a href=\"https://eahospitalitypulse.com/editions/pulse-2026-08-13-morning.html\" rel=\"noopener\">eahospitalitypulse.com/editions/pulse-2026-08-13-mornin…</a><br>— EA Hospitality Pulse | Daily intelligence for city, bush &amp; beach properties</p>"
 },
 {
  "id": "pulse-2026-08-12-midday",
  "date": "2026-08-12",
  "dateDisplay": "Wednesday, 12 August 2026",
  "edition": "Midday Pulse",
  "editionKey": "midday",
  "summary": "1️⃣ 🇰🇪 EASTLEIGH AND KIBERA ARE NOW \"DO NOT TRAVEL\"",
  "bodyHtml": "<p><span class=\"meta-line\">🏨 <strong>EA HOSPITALITY PULSE — Midday Pulse</strong></span><br>🗓 Wednesday 12 August 2026 | 🇰🇪 🌍 🇪🇺</p>\n<p><em>The US hardened its Nairobi geography a fortnight ago. We caught it today, and can&#x27;t find anyone who has reported it.</em><br>━━━━━━━━━<br><strong>1️⃣ 🇰🇪 EASTLEIGH AND KIBERA ARE NOW &quot;DO NOT TRAVEL&quot;</strong></p>\n<p>The rendered travel.state.gov Kenya advisory, re-read at midday today, carries <strong>&quot;Date issued: July 28, 2026&quot;</strong> — not the 17 March 2025 date that stood when we last verified on 2 August — and lists the <strong>Nairobi neighbourhoods of Eastleigh and Kibera under Level 4, Do Not Travel</strong>, for crime and kidnapping. A sixth risk indicator, <strong>&quot;Other (O)&quot;</strong>, has been added. Kenya&#x27;s country level is unchanged at <strong>Level 2</strong>. State&#x27;s own note: <em>&quot;There was no change to the advisory level. The &#x27;other&#x27; risk indicator was added. Advisory summary was updated.&quot;</em> (travel.state.gov, checked 12 Aug; US Embassy Nairobi, 30 July.)</p>\n<p><strong>Correction:</strong> our board carried those neighbourhoods as Reconsider Travel. Fixed today.</p>\n<p><span class=\"tagline\">🏷 Kenya · City · Confirmed (page text) / Inference (that the 28 July action was substantive)</span><br><span class=\"sowhat\">🎯 <strong>So what:</strong> Nothing here touches Westlands, Upper Hill, Gigiri, the CBD or Karen. But corporate travel-risk desks parse advisory text as strings, not maps, and &quot;Nairobi&quot; plus &quot;Do Not Travel&quot; is what an automated flag returns. Rewrite duty-of-care and pre-arrival wording this week — name both neighbourhoods, state that no routing touches them — before Hotel Expo buyer traffic on 19–21 August.</span></p>\n<p><strong>2️⃣ 🌍 DRC EBOLA PASSES 2,000 DEATHS AS THE US ORDER EXPIRES</strong></p>\n<p>DRC officials reported <strong>2,011 deaths from 4,381 confirmed cases</strong> as of Tuesday, at least 1,000 of them in the past three weeks — the fastest-growing outbreak on record (AP/Al Jazeera, 11 Aug; UN News, 11 Aug). OCHA is preparing <strong>Rwanda</strong> for possible spread; Rwanda has no confirmed cases. Israel is testing a citizen who returned from the DRC with a fever. As of 13:30 EAT the CDC order page still shows the 13 July order as latest — <strong>no renewal published</strong>, expiry 4:59pm EDT tonight.</p>\n<p><span class=\"tagline\">🏷 Regional · Bush/City · Confirmed</span><br><span class=\"sowhat\">🎯 <strong>So what:</strong> The case for renewal strengthened in the last 24 hours. Don&#x27;t brief agents on a lapse. Watch Israel&#x27;s result — a first confirmed export outside Africa is what moves European advisories.</span></p>\n<p><strong>3️⃣ 🇪🇺 TUI: THE EUROPEAN GUEST IS BOOKING LATE, NOT BOOKING LESS</strong></p>\n<p>TUI&#x27;s Q3, out this morning: underlying EBIT <strong>€234m</strong> against €321m a year ago, summer booked revenue <strong>6% below</strong> last year — but bookings <strong>up 7% over the past four weeks</strong>, FY26 guidance held (TUI Group, 12 Aug).</p>\n<p><span class=\"tagline\">🏷 Zanzibar / Kenya coast · Beach · Confirmed (figures) / Inference (EA read)</span><br><span class=\"sowhat\">🎯 <strong>So what:</strong> A thinner book filling later. If you&#x27;re contracting winter 2026/27 for Zanzibar or Diani, don&#x27;t read a light September position as a weak season and pre-discount into it. Hold allocation; keep a short-lead offer in reserve.</span></p>\n<p>━━━━━━━━━<br>✅ <strong>STILL TRUE</strong> — Uganda <strong>L4</strong>; Kenya <strong>L2</strong>; Tanzania &amp; Zanzibar <strong>L3</strong>. Coastal geography unchanged: Kilifi north of the C103 and areas north of Malindi stay L4; Diani and Watamu are not in it.</p>\n<p><span class=\"meta-line\">📅 <strong>WEEK AHEAD</strong> — EPRA fuel review <strong>~14 Aug</strong> (diesel held KSh222.86/L), effective 15 Aug; <strong>Hotel Expo Kenya 19–21 Aug</strong> (KICC); WHO IHR Emergency Committee on the Bundibugyo PHEIC <strong>18 Aug</strong>; <strong>WTA Africa Gala</strong>, Zanzibar, <strong>28 Aug</strong>.</span></p>\n<p><span class=\"meta-line\">💬 Has a corporate account ever flagged your property over a geography nobody actually read?</span></p>\n<p>🔗 This edition on the web: <a href=\"https://eahospitalitypulse.com/editions/pulse-2026-08-12-midday.html\" rel=\"noopener\">eahospitalitypulse.com/editions/pulse-2026-08-12-midday…</a><br>— EA Hospitality Pulse | Daily intelligence for city, bush &amp; beach properties</p>"
 },
 {
 ...
 },
 {
  ...
  "edition": "Morning Brief",
  "editionKey": "morning",
  "summary": "The airlift East Africa is banking its 2026 arrivals on is being flown by carriers earning 40 US cents a passenger. Read the balance sheet behind the route map, not just the route map.",
  "bodyHtml": "<p>🌅 <strong>EA HOSPITALITY PULSE — Tue 11 Aug, Morning</strong><br><em>Quiet news morning. One Expert Brief, then the board.</em></p>\n<p><strong>1️⃣ THE ROUTE MAP LOOKS LIKE GROWTH. THE MARGIN BEHIND IT LOOKS LIKE FRAGILITY.</strong></p>\n<p>Every new frequency into Nairobi, Entebbe, Kigali and Zanzibar reads to an owner as free demand. More seats, more guests, plan the rooms around them. That is the wrong thing to be watching.</p>\n<p>The carriers flying those seats are the least profitable in the world. IATA&#x27;s outlook (December 2025, revised down through 2026) puts <strong>African airlines&#x27; 2026 net profit at about US$100m — a 0.2% margin, and roughly US$0.40 per passenger, down from US$2.10 in 2025</strong>. Africa is simultaneously the <strong>fastest-growing</strong> aviation market on earth (demand up ~10%) and the thinnest-margin one, carrying the highest unit costs globally — near 140 US-cents per ATK, about double the industry average (IATA/AFRAA).</p>\n<p><strong>What everyone is missing:</strong> a route launch is not a demand guarantee — it&#x27;s a bet made by an operator with no buffer. At a 0.2% margin, the first thing a carrier trims when fuel, FX or bookings wobble is the newest, thinnest route. And those are precisely the frequencies feeding secondary safari and beach gateways. Airlift you didn&#x27;t build, you can&#x27;t defend.</p>\n<p><span class=\"sowhat\">🎯 <strong>So what, by segment</strong></span><br>🦁 <strong>Bush:</strong> most exposed. A safari season hung on one newly launched or seasonal regional frequency is a fragile plan — keep multi-gateway routing and push direct/advance bookings so a schedule cut doesn&#x27;t empty your season.<br>🏖 <strong>Beach:</strong> single-carrier leisure and charter routes (e.g. RwandAir&#x27;s Zanzibar/Mombasa services resumed Dec 2025) are the classic first-to-be-trimmed in a squeeze. Hold rate, but keep a source-market and routing spread.<br>🏙 <strong>City:</strong> trunk routes on the strongest balance sheets are your safest airlift — but don&#x27;t bank every new frequency straight into corporate-rate assumptions.</p>\n<p><span class=\"tagline\">🏷 Regional · All segments · Confidence: High (figures dated &amp; sourced)</span></p>\n<hr class=\"divider\">\n<p><strong>📋 THE BOARD</strong></p>\n<p>✅ <strong>STILL TRUE</strong> — Uganda US <strong>Level 4 &quot;Do Not Travel&quot;</strong> unchanged (State Dept, 5 Aug); Kenya <strong>Level 2</strong>; TZ &amp; Zanzibar <strong>Level 3</strong>. The Uganda/DRC decoupling question resolves tomorrow, not today — don&#x27;t price a US-market rebound you can&#x27;t yet see.</p>\n<p><span class=\"meta-line\">📅 <strong>WEEK AHEAD</strong> — US <strong>CDC Section 362 entry order</strong> lapses or renews <strong>~12 Aug</strong> (4:59pm EDT decision point); <strong>EPRA</strong> Kenya fuel review <strong>~14 Aug</strong> (petrol held KSh214.03/L, diesel KSh222.86/L to 14 Aug, EPRA Jul review), new schedule effective 15 Aug; <strong>Hotel Expo Kenya 19–21 Aug</strong> (KICC).</span></p>\n<p>🎤 <strong>MICE WATCH</strong> — Hotel Expo Kenya, Nairobi/KICC, 19–21 Aug (city midweek bump). WTA Africa Gala, Zanzibar, 28 Aug (north/east coast compression, last week of Aug).</p>\n<p><span class=\"meta-line\">📡 <strong>RADAR</strong> — Upstream source poll returned nothing new in-window this slot; edition built from a manual upstream scan (advisories, WHO/Africa CDC, IATA/AFRAA, EPRA). Advisory board and outbreak status unchanged since the weekend. No exclusive to report.</span></p>\n<p>🔗 This edition on the web: <a href=\"https://eahospitalitypulse.com/editions/pulse-2026-08-11-morning.html\" rel=\"noopener\">eahospitalitypulse.com/editions/pulse-2026-08-11-mornin…</a></p>\n<hr class=\"divider\">"
 },
 {
 ...
 },
 {
  ...
  "edition": "Morning Brief",
  "editionKey": "morning",
  "summary": "East Africa keeps announcing record arrivals. The number that should worry owners is where those guests come from — not how many there are.",
  "bodyHtml": "<p>🌅 <strong>EA HOSPITALITY PULSE — Mon 10 Aug, Morning</strong><br><em>Quiet news morning. One Expert Brief, then the board.</em></p>\n<p><strong>1️⃣ THE RECORD THAT HIDES A RISK — READ YOUR SOURCE-MARKET MIX, NOT YOUR ARRIVALS LINE</strong></p>\n<p>Every headline this year says the same thing: records. Zanzibar cleared 917,167 arrivals in 2025 (OCGS). Tanzania banked US$4.41bn in tourism earnings, up 13% (NBS, 2025). Kenya reports ~7.9m visitors. The applause is deserved. It is also the wrong thing to be watching.</p>\n<p>Look underneath Zanzibar&#x27;s boom and you find a single load-bearing pillar: Europe supplied <strong>61.9% of June arrivals (43,105 of 69,605)</strong> and <strong>69.5% in January</strong> (OCGS, June figure released ~12 Jul). One region, most of your bookings. That is not a franchise — it&#x27;s a bet on one continent&#x27;s disposable income and one continent&#x27;s risk appetite.</p>\n<p><strong>What everyone is missing:</strong> a record-arrivals headline is not validation, it&#x27;s a concentration warning. And you don&#x27;t have to imagine the shock — it&#x27;s live. Uganda sits at <strong>US Level 4 &quot;Do Not Travel&quot;</strong> (State Dept, 5 Aug) and the <strong>US CDC Section 362 entry order</strong> (renewed 13 Jul, next call ~12 Aug) has effectively frozen one Western source market for the Uganda/DRC corridor overnight. A single government notice did that. A European recession would do the same to a coast that leans 62–70% on Europe.</p>\n<p><strong>The hedge already works — someone&#x27;s proven it.</strong> Tanzania grew Chinese arrivals from <strong>33,000 to 82,000 in two years</strong> through Mandarin-language outreach. Deliberate diversification, not luck.</p>\n<p><span class=\"sowhat\">🎯 <strong>So what, by segment</strong></span><br>🏖 <strong>Beach:</strong> most exposed. Build Gulf/India/intra-Africa shoulder fill now — language, OTA and payment rails ready before the next Western wobble, not after.<br>🦁 <strong>Bush:</strong> the Uganda freeze shows how fast one advisory empties a source market. Court Gulf/India feeder demand on the new Doha/Dubai lift; hold rate through a Western gap rather than discounting.<br>🏙 <strong>City:</strong> MICE and intra-African business travel are your natural diversifier — MKTE (Oct), FHS Africa Uganda 2027, ICCA Kigali 2027 are demand that doesn&#x27;t depend on Western leisure sentiment.</p>\n<p><span class=\"tagline\">🏷 Regional · All segments · Confidence: High (data dated &amp; sourced)</span></p>\n<hr class=\"divider\">\n<p><strong>📋 THE BOARD</strong></p>\n<p>✅ <strong>STILL TRUE</strong> — Uganda US <strong>Level 4</strong> unchanged (State Dept, 5 Aug); TZ &amp; Zanzibar US <strong>Level 3</strong> since 31 Oct 2025. Uganda&#x27;s 42-day Ebola all-clear completes ~28 Aug, but no entry rule has changed. Don&#x27;t price a US-market rebound you can&#x27;t yet see.</p>\n<p><span class=\"meta-line\">📅 <strong>WEEK AHEAD</strong> — CDC Section 362 order decision <strong>~12 Aug</strong>; EPRA Kenya fuel review <strong>~14 Aug</strong> (petrol held at KSh214.03/L to 14 Aug, EPRA Jul review); Hotel Expo Kenya <strong>19–21 Aug</strong> (KICC).</span></p>\n<p>🎤 <strong>MICE WATCH</strong> — Hotel Expo Kenya, Nairobi/KICC, 19–21 Aug (city midweek bump). WTA Africa Gala, Zanzibar, 28 Aug (north/east coast compression, last week of Aug).</p>\n<p><span class=\"meta-line\">📡 <strong>RADAR</strong> — Upstream source poll returned nothing new in-window this slot; advisory board and outbreak status unchanged since the weekend. No exclusive to report.</span></p>\n<p>🔗 This edition on the web: <a href=\"https://eahospitalitypulse.com/editions/pulse-2026-08-10-morning.html\" rel=\"noopener\">eahospitalitypulse.com/editions/pulse-2026-08-10-mornin…</a></p>\n<hr class=\"divider\">"
 },
 {
 ...
 },
 {
  ...
  "edition": "Sunday Foresight",
  "editionKey": "foresight",
  "summary": "Uganda beat Ebola. Its recovery is still hostage to a border it doesn't control.",
  "bodyHtml": "<p><span class=\"meta-line\">🏨 EA HOSPITALITY PULSE — Sunday Foresight</span><br>🗓 9 August 2026</p>\n<p><strong>Uganda beat Ebola. Its recovery is still hostage to a border it doesn&#x27;t control.</strong></p>\n<p>Uganda was declared Ebola-free on 28 July and completes its 42-day all-clear around 28 August. Yet after the US CDC&#x27;s entry-order decision this week — due on or about 12 August — Uganda will almost certainly still carry a Level 4 &quot;Do Not Travel&quot; advisory. Read day-to-day, the daily briefs kept reporting the same non-news: the advisory board hasn&#x27;t moved. Read as a pattern, that stasis is the single most important fact of the quarter. Nothing Uganda did to earn a clean bill changed its traveller-facing risk label, because the label is set by decision cycles in Washington coupled to DRC&#x27;s outbreak — now past 4,000 confirmed cases, the largest in DRC&#x27;s history, with no vaccine for the Bundibugyo strain.</p>\n<p>Here&#x27;s what the market is missing. The CDC entry order was never what suppressed Uganda&#x27;s most valuable source market. The order bars certain <strong>foreign nationals from entering the US</strong>; it explicitly exempts US citizens — who are ~18–20% of Uganda&#x27;s non-African visitors and free to fly to Kampala today. The instrument that actually stalls US leisure demand is the State Department Level 4 advisory, which drives insurance exclusions and corporate no-go policies — and it runs on its own clock, welded to DRC and to non-Ebola factors, not to Uganda&#x27;s epidemiology. Operators waiting for &quot;the ban to lift&quot; to restart marketing are watching the wrong dial. The dial that matters won&#x27;t move on 12 August, and it may not move for months.</p>\n<p>So stop selling to the timeline of an all-clear that isn&#x27;t coming. Move budget to the demand that no Western risk desk governs.</p>\n<p><strong>THE WEEK&#x27;S SIGNALS</strong></p>\n<p><span class=\"item-head\">1️⃣ DRC&#x27;s Bundibugyo outbreak topped 4,000 confirmed cases — now the largest in DRC&#x27;s history and second-largest ever recorded, across 49 health zones, ~44% fatality, no approved vaccine.</span><br><span class=\"sowhat\">🎯 So what: Uganda&#x27;s recovery clock is set by this number, not its own. Assume the coupling persists through Q3 and plan around it.</span><br><span class=\"tagline\">🏷 Al Jazeera / WHO, 7 Aug 2026</span></p>\n<p><span class=\"item-head\">2️⃣ The US CDC Section 362 entry order (renewed 13 July, 30-day cycle) faces its next decision on or about 12 August — and it exempts US citizens.</span><br><span class=\"sowhat\">🎯 So what: the legal bar never touched your American leisure guest. Brief agents that the barrier is perception and duty-of-care policy, not law — and arm them accordingly.</span><br><span class=\"tagline\">🏷 Fragomen / CDC port-health order, effective to 12 Aug 2026</span></p>\n<p><span class=\"item-head\">3️⃣ Uganda remains Level 4 despite being declared Ebola-free (28 July); the 42-day all-clear completes ~28 August.</span><br><span class=\"sowhat\">🎯 So what: have &quot;Uganda is Ebola-free&quot; collateral built and dated now, ready to fire to trade and non-US markets the moment the countdown closes.</span><br><span class=\"tagline\">🏷 ChimpReports / Uganda MoH, late July–Aug 2026</span></p>\n<p>🔭 THE DEEP DIVE — Source-market shifts<br>East Africa&#x27;s most defensible demand is the demand no G7 risk desk designates: intra-African travel, now a structural pillar rather than a fallback, plus Gulf and European markets whose advisories move independently of Washington&#x27;s. Regional arrivals rebuilt Africa&#x27;s tourism past pre-pandemic levels by 2024, helped by visa-free momentum and added airlift. A blunt US regional instrument is a marketing gift to whoever segments beneath it.<br><span class=\"sowhat\">🎯 So what: during a designation freeze, weight spend toward markets that don&#x27;t read a US advisory before booking — and sell the specificity the blunt instrument can&#x27;t capture (Ebola-free status, park distance from any affected zone).</span><br><span class=\"tagline\">🏷 GlobalData / regional arrivals context, 2026</span></p>\n<p><span class=\"meta-line\">📡 30/90-DAY DEMAND CALENDAR</span></p>\n<p>• ~12 Aug — US CDC s.362 order decision. → Don&#x27;t gate marketing on it; assume renewal with Uganda still listed.<br>• 15 Aug — EPRA fuel review (Kenya). → Lock August transfer &amp; generator quotes before the 15th.<br>• 18 Aug — WHO IHR Emergency Committee on the PHEIC. → Keep &quot;Uganda is clear&quot; messaging factual, not triumphal.<br>• 19–21 Aug — Hotel Expo Kenya (Nairobi, KICC). → Hold corporate rate near KICC midweek.<br>• ~28 Aug — Uganda completes 42-day all-clear. → Fire dated &quot;Ebola-free&quot; collateral to trade and non-US markets.<br>• 28 Aug — World Travel Awards Africa Gala (Zanzibar). → Hold north/east coast rate that week.<br>• Early Sept — KNBS/UBOS/NBS August CPI. → Your cost-gap negotiating number.<br>• 6–8 Oct — Magical Kenya Travel Expo (10,000+). → Close out standard Nairobi rate now.<br>• 25 Oct — Yas Zanzibar Marathon. → Release event rates and minimum-stays.</p>\n<p>If the US won&#x27;t lift Uganda&#x27;s label on Uganda&#x27;s timeline, whose demand are you still building your Q4 around? Reply and tell us.</p>\n<p>🔗 This edition on the web: <a href=\"https://eahospitalitypulse.com/editions/foresight-2026-08-09.html\" rel=\"noopener\">eahospitalitypulse.com/editions/foresight-2026-08-09.html</a><br>💼 This week&#x27;s Big Read on LinkedIn: <a href=\"https://www.linkedin.com/company/ea-hospitality-pulse/\" rel=\"noopener\">linkedin.com/company/ea-hospitality-pulse/</a></p>\n<p>— EA Hospitality Pulse | Daily intelligence for city, bush &amp; beach properties</p>"
 },
 {
  ...
  "edition": "Morning Brief",
  "editionKey": "morning",
  "summary": "1️⃣ THE GUESTS ARE ALREADY ACROSS THE BORDER",
  "bodyHtml": "<p><span class=\"meta-line\">🏨 EA HOSPITALITY PULSE — Morning Brief</span><br><span class=\"meta-line\">📅 Sunday, 9 August 2026 | 🇰🇪🇹🇿🇺🇬🇷🇼</span></p>\n<p>No fresh wire this morning — so here is the thing the H1 numbers are telling every operator, and most are still not pricing for.<br>━━━━━━━━━<br><span class=\"item-head\">1️⃣ THE GUESTS ARE ALREADY ACROSS THE BORDER</span><br>The half-year data is in, and it points one way. South Africa took 5.58m international arrivals in H1 2026, up 12.3% — but the split matters more than the headline: arrivals from the rest of Africa rose 14.3%, while overseas arrivals grew just 5.6% (Statistics South Africa, released 30 July). More than 70% of monthly arrivals came from the SADC region. The same pattern shows in our own backyard: Rwanda&#x27;s single largest source market in H1 was not Europe or America but the DRC — 185,420 visitors, 12.5% of arrivals — with Kenya (10%) and Tanzania (9%) next (Rwanda Development Board, H1 2026).<br>Regional demand is growing two to three times faster than long-haul, and it is the base that holds when a Western advisory lands or the dollar turns. Yet it is still treated as walk-in: undifferentiated rate, no product, no campaign.<br><span class=\"sowhat\">🎯 So what: build a deliberate regional book, don&#x27;t wait for it. City hotels — price a weekday cross-border corporate and long-stay rate for the trade, health and education travel that already fills midweek. Bush — sell the shoulder season on the African-resident and EAC tariff you already have (Uganda gorilla permits run US$500 for Africans and UGX 300,000 for EAC citizens vs US$800 foreign; low-season US$600). Beach — court the Gulf and India charter demand that fills the European off-months.</span><br><span class=\"tagline\">🏷 All | Regional/Rwanda/EA | Reported</span><br>━━━━━━━━━<br>📌 STILL TRUE (context, unchanged)<br>• Advisory board: US — Kenya L2, Uganda L4, Tanzania/Zanzibar L3, Rwanda L3. No weekend move.<br>• Cost: Kenya diesel KSh 222.86/L, super KSh 214.03/L held only through 14 Aug (EPRA July review). Lock transfer/generator contracts this week.</p>\n<p><span class=\"meta-line\">📡 THE WATCH</span><br>• Tue 12 Aug — US CDC §362 Ebola entry order expires; watch renewal + whether Uganda is decoupled<br>• Thu–Fri 14–15 Aug — EPRA fuel review reprices the cycle<br>• 19–21 Aug — Hotel Expo Kenya, KICC Nairobi — city-hotel midweek compression</p>\n<p><span class=\"meta-line\">💬 Are you quoting a distinct regional rate, or letting the border trade walk in at rack?</span></p>\n<p>🔗 This edition on the web: <a href=\"https://eahospitalitypulse.com/editions/pulse-2026-08-09-morning.html\" rel=\"noopener\">eahospitalitypulse.com/editions/pulse-2026-08-09-mornin…</a><br>— EA Hospitality Pulse | Daily intelligence for city, bush &amp; beach properties</p>"
 },
 {
 ...
 },
 {
  ...
  "edition": "Morning Brief",
  "editionKey": "morning",
  "summary": "1️⃣ FORECAST CHECK-IN — FOUR DAYS TO 12 AUGUST, AND THE REAL QUESTION IS UGANDA",
  "bodyHtml": "<p><span class=\"meta-line\">🏨 EA HOSPITALITY PULSE — Morning Brief</span><br><span class=\"meta-line\">📅 Saturday, 8 August 2026 | 🇰🇪🇹🇿🇺🇬🇷🇼</span></p>\n<p>No new wire this morning — so here is the ledger audit nobody else runs, now four days out from the call that matters, with a fresh number behind it.<br>━━━━━━━━━<br><span class=\"item-head\">1️⃣ FORECAST CHECK-IN — FOUR DAYS TO 12 AUGUST, AND THE REAL QUESTION IS UGANDA</span><br>The US CDC&#x27;s §362 Ebola entry suspension (DRC, Uganda, South Sudan) still expires Tuesday 12 August. Re-checked this morning: the latest CDC order remains the one published 16 July (effective 13 July) — no early renewal, no early lapse. The DRC epidemiology behind it hardened again: 4,053 confirmed cases and 1,850 deaths to 5 August (ECDC, updated 7 Aug), up from 3,874 a week earlier.<br>But watch the split. DRC&#x27;s numbers argue for renewal (P044/P047). Uganda&#x27;s argue the other way — Ebola-free since 28 July, last case 21 June, now 48 days clear. The operator question on 12 Aug is not &quot;renew or lift&quot; — it&#x27;s whether CDC decouples Uganda from DRC and drops it from the list (P035, our early signal).<br><span class=\"sowhat\">🎯 So what: keep the ban in your base case past 12 Aug — but if you run Uganda bush or Entebbe city rooms, 12 Aug is the date a US-source recovery could get its first green light. Have your trade-partner note drafted for either outcome.</span><br><span class=\"tagline\">🏷 All | Regional/Uganda | Reported</span></p>\n<p><span class=\"item-head\">2️⃣ STILL TRUE — THE ADVISORY BOARD HASN&#x27;T MOVED</span><br>US: Kenya L2, Tanzania L3, Zanzibar L3, Uganda L4, Rwanda L3. UK: Kenya L2, Tanzania/Zanzibar L1, Uganda L3, Rwanda L2. Uganda&#x27;s US Level 4 stands — the 5 Aug State Department commendation of Uganda&#x27;s own Ebola response is goodwill, not a downgrade. No government moved a level overnight.<br><span class=\"sowhat\">🎯 So what: a confirmed &quot;no change&quot; tells you not to discount on advisory grounds. Hold rate and hold your security messaging.</span><br><span class=\"tagline\">🏷 All | Regional | Confirmed</span></p>\n<p><span class=\"item-head\">3️⃣ COST PULSE — THE PUMP-PRICE WINDOW CLOSES IN SIX DAYS</span><br>Kenya diesel is held at KSh 222.86/L and super at KSh 214.03/L only through 14 August (EPRA July review) — propped by a KSh 945m levy draw and the 8% petroleum VAT rate extended to 14 Oct. KES steady at 129.30/USD; reserves 6.0 months&#x27; cover. The quiet killer stands: electricity pass-through charges now top KSh 5/kWh.<br><span class=\"sowhat\">🎯 So what: lock safari-transfer and generator-fuel contracts this week, before the ~14–15 Aug review reprices the cycle. Read the pass-through line on the power bill, not the tariff band.</span><br><span class=\"tagline\">🏷 Bush | Kenya | Confirmed</span><br>━━━━━━━━━<br><span class=\"meta-line\">📡 WEEK AHEAD</span><br>• Tue 12 Aug — US CDC §362 entry order expires; watch renewal + whether Uganda is dropped (P035/P044/P047/P056/P057 resolve)<br>• Thu–Fri 14–15 Aug — EPRA fuel review (P025/P028 resolve)<br>• Mon 18 Aug — WHO IHR Emergency Committee on Bundibugyo — could adjust the PHEIC (P052)<br>• 19–21 Aug — Hotel Expo Kenya, KICC Nairobi — a city-hotel midweek compression window</p>\n<p><span class=\"meta-line\">📡 RADAR: 374 in-window observations since 7 Aug 18:00 EAT. Top signal was again a Federal Register CDC page-change (first seen 07:19 EAT) — opened and cleared: no new Ebola order behind it. The rest was Kenyan gazette cause-lists and a global airline schedule filing (Delta Seattle–Tokyo) — noise for our market.</span></p>\n<p>🔗 This edition on the web: <a href=\"https://eahospitalitypulse.com/editions/pulse-2026-08-08-morning.html\" rel=\"noopener\">eahospitalitypulse.com/editions/pulse-2026-08-08-mornin…</a><br>— EA Hospitality Pulse | Daily intelligence for city, bush &amp; beach properties</p>"
 },
 {
  "id": "pulse-2026-08-07-evening",
  "date": "2026-08-07",
  "dateDisplay": "Friday, 7 August 2026",
  "edition": "Evening Wrap",
  "editionKey": "evening",
  "summary": "US: Kenya L2, Tanzania L3, Zanzibar L3, Uganda L4, Rwanda L3.",
  "bodyHtml": "<p><span class=\"meta-line\">🏨 EA HOSPITALITY PULSE — Evening Wrap</span><br><span class=\"meta-line\">📅 Friday, 7 August 2026 | 🇰🇪🇹🇿🇺🇬🇷🇼</span></p>\n<p><em>Automated cloud brief — repo-backed, verified data only. A fuller edited edition may follow.</em><br>━━━━━━━━━<br><span class=\"item-head\">1️⃣ ADVISORY BOARD — STILL TRUE</span><br>US: Kenya L2, Tanzania L3, Zanzibar L3, Uganda L4, Rwanda L3.<br>UK: Kenya L2, Tanzania L1, Zanzibar L1, Uganda L3, Rwanda L2.<br><span class=\"sowhat\">🎯 So what: no verified change to act on right now; a confirmed &#x27;no change&#x27; tells you not to discount on advisory grounds. (Board verified against travel.state.gov / gov.uk.)</span><br><span class=\"tagline\">🏷 All | Regional | Confirmed</span></p>\n<p><span class=\"item-head\">2️⃣ FORECAST CHECK-IN — CALLS RESOLVING SOON</span><br>• 10 Aug — P030: No East African tourism body|airline|hotel group or national tourism authority from Kenya|<br>• 11 Aug — P057: The US CDC will not post a new or renewed Section 362 Ebola entry order on its port-health<br>• 12 Aug — P034: Neither the US State Department nor the UK FCDO will lower its Uganda travel advisory leve<br><span class=\"sowhat\">🎯 So what: these are our falsifiable calls coming due — we grade ourselves in public.</span><br><span class=\"tagline\">🏷 All | Regional | Reported</span></p>\n<p><span class=\"meta-line\">📡 RADAR FLAGGED (unread upstream — open before relying)</span><br>• [page changed] Federal Register — CDC notices — Federal Register — CDC notices, first seen 2026-08-07 [OPEN THIS]<br><a href=\"https://www.federalregister.gov/api/v1/documents.rss?conditions%5Bagencies%5D%5B%5D=centers-for-disease-control-and-prevention&amp;order=newest\" rel=\"noopener\">federalregister.gov/api/v1/documents.rss?conditions%5Ba…</a><br>• [page changed] Federal Register — CDC notices — Federal Register — CDC notices, first seen 2026-08-07 [OPEN THIS]<br><a href=\"https://www.federalregister.gov/api/v1/documents.rss?conditions%5Bagencies%5D%5B%5D=centers-for-disease-control-and-prevention&amp;order=newest\" rel=\"noopener\">federalregister.gov/api/v1/documents.rss?conditions%5Ba…</a><br>• [page changed] Jambojet media — Jambojet media, first seen 2026-08-07 [OPEN THIS]<br><a href=\"https://www.jambojet.com/en/press-release\" rel=\"noopener\">jambojet.com/en/press-release</a><br>━━━━━━━━━<br>🔗 This edition on the web: <a href=\"https://eahospitalitypulse.com/editions/pulse-2026-08-07-evening.html\" rel=\"noopener\">eahospitalitypulse.com/editions/pulse-2026-08-07-evenin…</a><br>— EA Hospitality Pulse | Automated cloud brief</p>"
 },
 {
  ...
  "editionKey": "midday",
  "summary": "US: Kenya L2, Tanzania L3, Zanzibar L3, Uganda L4, Rwanda L3.",
  "bodyHtml": "<p><span class=\"meta-line\">🏨 EA HOSPITALITY PULSE — Midday Pulse</span><br><span class=\"meta-line\">📅 Friday, 7 August 2026 | 🇰🇪🇹🇿🇺🇬🇷🇼</span></p>\n<p><em>Automated cloud brief — repo-backed, verified data only. A fuller edited edition may follow.</em><br>━━━━━━━━━<br><span class=\"item-head\">1️⃣ ADVISORY BOARD — STILL TRUE</span><br>US: Kenya L2, Tanzania L3, Zanzibar L3, Uganda L4, Rwanda L3.<br>UK: Kenya L2, Tanzania L1, Zanzibar L1, Uganda L3, Rwanda L2.<br><span class=\"sowhat\">🎯 So what: no verified change to act on right now; a confirmed &#x27;no change&#x27; tells you not to discount on advisory grounds. (Board verified against travel.state.gov / gov.uk.)</span><br><span class=\"tagline\">🏷 All | Regional | Confirmed</span></p>\n<p><span class=\"item-head\">2️⃣ FORECAST CHECK-IN — CALLS RESOLVING SOON</span><br>• 10 Aug — P030: No East African tourism body|airline|hotel group or national tourism authority from Kenya|<br>• 11 Aug — P057: The US CDC will not post a new or renewed Section 362 Ebola entry order on its port-health<br>• 12 Aug — P034: Neither the US State Department nor the UK FCDO will lower its Uganda travel advisory leve<br><span class=\"sowhat\">🎯 So what: these are our falsifiable calls coming due — we grade ourselves in public.</span><br><span class=\"tagline\">🏷 All | Regional | Reported</span></p>\n<p><span class=\"meta-line\">📡 RADAR FLAGGED (unread upstream — open before relying)</span><br>• [page changed] Federal Register — CDC notices — Federal Register — CDC notices, first seen 2026-08-07 [OPEN THIS]<br><a href=\"https://www.federalregister.gov/api/v1/documents.rss?conditions%5Bagencies%5D%5B%5D=centers-for-disease-control-and-prevention&amp;order=newest\" rel=\"noopener\">federalregister.gov/api/v1/documents.rss?conditions%5Ba…</a><br>• [page changed] Federal Register — CDC notices — Federal Register — CDC notices, first seen 2026-08-07 [OPEN THIS]<br><a href=\"https://www.federalregister.gov/api/v1/documents.rss?conditions%5Bagencies%5D%5B%5D=centers-for-disease-control-and-prevention&amp;order=newest\" rel=\"noopener\">federalregister.gov/api/v1/documents.rss?conditions%5Ba…</a><br>• [page changed] Airlink news — Airlink news, first seen 2026-08-07 [OPEN THIS]<br><a href=\"https://www.flyairlink.com/\" rel=\"noopener\">flyairlink.com/</a><br>━━━━━━━━━<br>🔗 This edition on the web: <a href=\"https://eahospitalitypulse.com/editions/pulse-2026-08-07-midday.html\" rel=\"noopener\">eahospitalitypulse.com/editions/pulse-2026-08-07-midday…</a><br>— EA Hospitality Pulse | Automated cloud brief</p>"
 },
 {
 ...
 },
 {
  ...
  "edition": "Midday Pulse",
  "editionKey": "midday",
  "summary": "Since this morning's Ebola brief — so here's what we re-checked at midday, and what's moving underneath.",
  "bodyHtml": "<p><span class=\"meta-line\">🏨 EA HOSPITALITY PULSE — Midday Pulse</span><br><span class=\"meta-line\">📅 Wednesday, 5 August 2026 | 🇰🇪🇹🇿🇺🇬🇷🇼</span></p>\n<p>Since this morning&#x27;s Ebola brief — so here&#x27;s what we re-checked at midday, and what&#x27;s moving underneath.<br>━━━━━━━━━<br><span class=\"item-head\">1️⃣ FORECAST CHECK-IN: KENYA&#x27;S AIR-TRAVEL TAXES POINT UP, NOT DOWN</span><br>Our standing call P016 — Kenya will not cut the air passenger service levy before end-2027 — isn&#x27;t just holding, the direction is the opposite. Kenya has spent the past year RAISING, not trimming, the cost of flying in: the Air Passenger Service Charge (Amendment) Act, signed 15 Oct 2025, handed the Transport CS standing power to vary the charge and put the international levy on a path toward US$50 and domestic to KSh600 (per ATTA / Kenyan Wall Street). The 2026 fiscal debate over removing VAT relief on aircraft parts pushes landed and fare costs the same way. This is structure, not breaking news — but it&#x27;s the structure your guests&#x27; airfares sit on.<br><span class=\"sowhat\">🎯 So what: for city and safari properties whose guests fly in, budget airlift-linked costs — fares, transfers, connecting-flight fees — as flat-to-rising into the Sept–Oct peak. Don&#x27;t model a cheaper-ticket tailwind into demand; if anything, the tax base is working against lead-in fares. Call stays open, thesis strengthening.</span><br><span class=\"tagline\">🏷 City/Bush | Kenya | Reported</span></p>\n<p><span class=\"item-head\">2️⃣ STILL TRUE AT MIDDAY: THE ADVISORY BOARD HASN&#x27;T MOVED</span><br>Overnight the US State Department re-issued its entire advisory feed at once (04 Aug 23:54 EAT) — but re-issue is not re-rating. The Rwanda notice records it plainly: &quot;no change to the advisory level,&quot; the three risk areas merely consolidated into one. US board stands: Kenya L2, Tanzania L3, Zanzibar L3, Uganda L4, Rwanda L3. UK unchanged: Kenya L2, Tanzania/Zanzibar L1, Uganda L3, Rwanda L2.<br><span class=\"sowhat\">🎯 So what: a bulk re-stamp that reads as &quot;breaking&quot; in a search feed is exactly the trap that moves nobody&#x27;s booking. No basis to change security messaging or discount on advisory grounds today.</span><br><span class=\"tagline\">🏷 All | Regional | Confirmed</span></p>\n<p><span class=\"item-head\">3️⃣ MICE WATCH: THE NEXT CITY COMPRESSION IS TWO WEEKS OUT</span><br>Hotel Expo Kenya lands 19–21 Aug at KICC Nairobi — a three-day city-centre trade event (100+ exhibitors in 2025, organiser figure) sitting just ahead of the Sept–Oct peak. It&#x27;s a midweek exhibitor-and-buyer window, not a citywide sell-out, but it&#x27;s real demand into the CBD and Upper Hill.<br><span class=\"sowhat\">🎯 So what: Nairobi city hotels near KICC should hold corporate rate through 19–21 Aug rather than discounting into the shoulder. The bigger compression — MKTE, 10,000+ delegates, 6–8 Oct — is the one to be closing out standard rate against now.</span><br><span class=\"tagline\">🏷 City | Kenya | Confirmed</span><br>━━━━━━━━━<br><span class=\"meta-line\">📡 WEEK AHEAD</span><br>• Fri 8 Aug — CBK weekly bulletin (FX, reserves)<br>• Tue 12 Aug — US CDC §362 entry order expires; watch renewal + Uganda listing (P044/P023/P031/P032 resolve)<br>• Fri 15 Aug — EPRA fuel review (P025/P028 resolve)<br>• Mon 18 Aug — WHO IHR Emergency Committee on Bundibugyo<br>• 19–21 Aug — Hotel Expo Kenya, KICC Nairobi</p>\n<p><span class=\"meta-line\">📡 RADAR: 603 in-window observations since 4 Aug 18:00. Top of the feed was a full US advisory re-issue — all no-change, noise for our market. Local scan health read 0/0 (a post-restore artifact, not a dead pipeline). at midday.</span></p>\n<p>🔗 This edition on the web: <a href=\"https://eahospitalitypulse.com/editions/pulse-2026-08-05-midday.html\" rel=\"noopener\">eahospitalitypulse.com/editions/pulse-2026-08-05-midday…</a><br>— EA Hospitality Pulse | Daily intelligence for city, bush &amp; beach properties</p>"
 },
 {
 ...
 },
 {
  ...
  "edition": "Sunday Foresight",
  "editionKey": "foresight",
  "summary": "The week the risk map flipped — from contagion to cost.",
  "bodyHtml": "<p><span class=\"meta-line\">🏨 EA HOSPITALITY PULSE — Sunday Foresight</span><br>🗓 2 August 2026</p>\n<p><strong>The week the risk map flipped — from contagion to cost.</strong></p>\n<p>Read the daily briefs back-to-back and it looks like a health-and-security week: Ebola, a US entry ban, a Kenya advisory re-issue. But those are the <strong>fading</strong> risks. Uganda was declared Ebola-free on 28 July, 30 days early. The Kenya advisory that spooked agents turned out to be a feed-level re-issue of a March 2025 page. These are demand-side scares with a short half-life.</p>\n<p>The story that <strong>firmed up</strong> this week is quieter and far more durable: your cost base. Kenya&#x27;s inflation hit a two-year high, and it is diverging from a benign Tanzania and Uganda. That divergence lands at the exact moment a weak-rand South Africa is selling the same Big Five experience 30–60% cheaper. The headline risk is transient. The margin risk is structural — and nobody put those two side by side day-to-day.</p>\n<p><strong>THE WEEK&#x27;S SIGNALS</strong></p>\n<p><span class=\"item-head\">1️⃣ Kenya inflation rose to 6.5% in July — a near two-year high, driven by electricity, transport (15.6%) and food (9.0%).</span><br><span class=\"sowhat\">🎯 So what: your single biggest 2027 threat isn&#x27;t a headline, it&#x27;s a cost base climbing toward the CBK&#x27;s 7.5% ceiling. Model wage and utility creep now.</span><br><span class=\"tagline\">🏷 KNBS via Bloomberg / The Star, 31 July 2026</span></p>\n<p><span class=\"item-head\">2️⃣ Uganda declared Ebola-free (28 July) — yet DRC&#x27;s outbreak hit 3,605 confirmed cases, 1,587 deaths, 44% CFR across 49 health zones.</span><br><span class=\"sowhat\">🎯 So what: the US ban won&#x27;t decouple Uganda from DRC on epidemiology. Treat the 12 Aug renewal as a regional-contagion tax, not a Uganda verdict.</span><br><span class=\"tagline\">🏷 WHO AFRO Situation Report 11 / Uganda MoH, 28–30 July 2026</span></p>\n<p><span class=\"item-head\">3️⃣ Airlift keeps expanding: RwandAir went to a 4th weekly Kigali–Paris–Brussels rotation from 1 August; Kenya Airways took Nairobi–Gatwick from 3 to 5 weekly.</span><br><span class=\"sowhat\">🎯 So what: seats are growing faster than rate discipline. More capacity into the same demand pool pressures lead-in fares — protect ADR before it&#x27;s competed away.</span><br><span class=\"tagline\">🏷 RwandAir / Kenya Airways schedules, effective July–1 Aug 2026</span></p>\n<p>🔭 THE DEEP DIVE — Competing destinations<br>With the rand weak, comparable Big Five safari runs 30–60% cheaper in South Africa than in Kenya or Tanzania for the same lodge tier; Kruger&#x27;s day fee sits near US$33. As EA&#x27;s cost base rises, that price gap widens on its own.<br><span class=\"sowhat\">🎯 So what: you are not only competing with the camp down the river — you&#x27;re competing with a currency. Sell scarcity, guiding and access, not a rate card that can&#x27;t win on price.</span><br><span class=\"tagline\">🏷 2026 operator cost guides / ZAR-USD</span></p>\n<p><span class=\"meta-line\">📡 30/90-DAY DEMAND CALENDAR</span></p>\n<p>• 12–13 Aug — US CDC s.362 Ebola order renewal decision. → Brief agents now; assume the ban persists.<br>• 15 Aug — EPRA fuel price review (Kenya). → Lock August transfer &amp; generator quotes before the 15th.<br>• ~28 Aug — Uganda completes its 42-day EVD all-clear. → Have &quot;Uganda is clear&quot; collateral ready to fire.<br>• Early Sept — KNBS &amp; UBOS August CPI land. → This is the cost-gap number to quote in rate negotiations.<br>• 25–27 Sept — Uganda park free-entry days. → Package add-on nights around the waiver.<br>• 25 Oct — Yas Zanzibar Marathon (~10,000 runners). → Release event rates and minimum-stays now.<br>• Aug–Oct — Mara/Serengeti peak crossing. → Hold rate discipline; don&#x27;t discount into peak.</p>\n<p>Which is the bigger threat to your 2027 rate card — the next advisory headline, or a cost base quietly diverging from your Tanzanian competitor&#x27;s? Reply and tell us.</p>\n<p>🔗 This edition on the web: <a href=\"https://eahospitalitypulse.com/editions/foresight-2026-08-02.html\" rel=\"noopener\">eahospitalitypulse.com/editions/foresight-2026-08-02.html</a><br>💼 This week&#x27;s Big Read on LinkedIn: <a href=\"https://www.linkedin.com/company/ea-hospitality-pulse/\" rel=\"noopener\">linkedin.com/company/ea-hospitality-pulse/</a></p>\n<p>— EA Hospitality Pulse | Daily intelligence for city, bush &amp; beach properties</p>"
 },
 {
 ...
 },
 {
  ...
  "bodyHtml": "<p><span class=\"meta-line\">🏨 EA HOSPITALITY PULSE — Evening Wrap</span><br><span class=\"meta-line\">📅 Thursday, 30 July 2026 | 🇺🇬🇨🇩🌍</span></p>\n<p>Uganda is clean. The number that governs the American ban is not — and it just moved the wrong way.<br>━━━━━━━━━<br><span class=\"item-head\">1️⃣ Uganda&#x27;s Ebola-free — but the ban tracks Congo, not Kampala</span><br>Uganda declared its Bundibugyo outbreak over on 28 July (Ministry of Health): 20 confirmed cases, two deaths, every transmission chain closed. Next door, WHO&#x27;s Weekly External Situation Report 11 (data to 26 July) puts DR Congo at 3,262 confirmed cases and 1,437 deaths — Ituri alone spread across 28 of 36 health zones, with under 80% of identified contacts traced. The US CDC entry suspension, renewed 13 July and running to roughly 12 August, names Uganda alongside DRC and South Sudan. It keys off the regional caseload — and that caseload is still climbing.<br><span class=\"sowhat\">🎯 So what: Do not sell &quot;Ebola-free Uganda&quot; as reopened access to US-origin guests. The declaration is a reassurance asset, not a border change — hold any &quot;restrictions lifted&quot; line in pre-arrival comms until CDC republishes.</span><br><span class=\"tagline\">🏷 Bush/City | Uganda/DRC/Regional | Confirmed (declaration &amp; data); inference on ban timing</span><br>━━━━━━━━━<br><span class=\"item-head\">2️⃣ Airlines fight border-data charges — at your guests&#x27; expense</span><br>IATA, AFRAA and AASA jointly urged African governments (30 July) to align Advance Passenger Information and PNR systems with ICAO standards, and opposed states charging airlines for border-security data. Fragmented, fee-loaded schemes raise the cost and friction of the long-haul seats East African resorts depend on.<br><span class=\"sowhat\">🎯 So what: A watch item, not an action. Uncoordinated API/PNR = pricier tickets and slower immigration lines — track it before it reaches your ADR.</span><br><span class=\"tagline\">🏷 City/Beach | Regional | Confirmed</span><br>━━━━━━━━━<br><span class=\"meta-line\">💬 Would you quote &quot;Ebola-free&quot; to a US client this week, or wait for CDC?</span></p>\n<p>🔗 This edition on the web: <a href=\"https://eahospitalitypulse.com/editions/pulse-2026-07-30-evening.html\" rel=\"noopener\">eahospitalitypulse.com/editions/pulse-2026-07-30-evenin…</a><br>💼 Today&#x27;s Big Read on LinkedIn: <a href=\"https://www.linkedin.com/company/ea-hospitality-pulse/\" rel=\"noopener\">linkedin.com/company/ea-hospitality-pulse/</a><br>— EA Hospitality Pulse | Daily intelligence for city, bush &amp; beach properties</p>"
 },
 {
  "id": "pulse-2026-07-29-morning",
  "date": "2026-07-29",
  "dateDisplay": "Wednesday, 29 July 2026",
  "edition": "Morning Brief",
  "editionKey": "morning",
  "summary": "We told you 27 August. Kampala said 28 July.",
  "bodyHtml": "<p><span class=\"meta-line\">🏨 EA HOSPITALITY PULSE — Morning Brief</span><br><span class=\"meta-line\">📅 Wednesday, 29 July 2026 | 🇺🇬 🇰🇪 🇷🇼 🇹🇿</span></p>\n<p>We told you 27 August. Kampala said 28 July.<br>━━━━━━━━━<br><span class=\"item-head\">1️⃣ UGANDA IS EBOLA-FREE — THIRTY DAYS EARLY</span></p>\n<p>Health Minister Dr Chris Baryomunsi declared the 2026 Bundibugyo outbreak over in Kampala yesterday morning (Uganda Ministry of Health / Uganda Media Centre, 28 July): 20 confirmed cases, 18 recovered, two deaths, 15 imported from DRC and five secondary — every one of them inside Kampala and Wakiso. &quot;The country is open for business, tourism and all socio-economic activities.&quot;</p>\n<p>The declaration did not wait for the calendar. WHO AFRO&#x27;s release of 16 July said Uganda had &quot;today entered the 42-day countdown&quot; — which lands around 27 August, the date we and everyone else had diarised. Uganda instead counted from 16 June, the discharge of the last Ugandan national, and rested the declaration on what the Ministry calls a <strong>fully documented importation event</strong>: source patient identified, every transmission chain reconstructed, all 836 contacts closed out. Two clocks, one outbreak.<br><span class=\"sowhat\">🎯 So what: Replace the countdown language in every pre-arrival email, agent FAQ and website health notice today with &quot;declared over on 28 July 2026&quot; and the Ministry link. You have a government document now, not a diary date.</span><br><span class=\"tagline\">🏷 Bush/City | 🇺🇬 | Confirmed</span></p>\n<p><span class=\"item-head\">2️⃣ NOBODY ABROAD HAS SIGNED OFF ON IT</span></p>\n<p>As at 08:00 EAT this morning we can find no WHO statement endorsing the declaration — WHO AFRO&#x27;s newsroom still carries the 16 July countdown release as its most recent Uganda Ebola item. Washington has not moved either: the CDC order under PHS Act ss.362/365 (91 FR 43636, 16 July) still suspends entry for anyone present in Uganda in the previous 21 days and runs to 4:59pm EDT on 12 August, with returning travellers funnelled through Dulles, Atlanta, Houston and JFK. Across the border, DRC stood at over 3,200 confirmed cases and 1,405 deaths as at 26 July (ECDC).<br><span class=\"sowhat\">🎯 So what: Sell &quot;outbreak over&quot;, not &quot;restrictions lifted&quot;. A guest who books a US-return itinerary on yesterday&#x27;s headline still cannot fly home for 21 days. Keep the warning in every American quote.</span><br><span class=\"tagline\">🏷 Bush/City | 🇺🇬 🇰🇪 | Confirmed</span></p>\n<p><span class=\"item-head\">3️⃣ THE DOCKET SHUTTING ON FRIDAY NOW HAS A DECLARATION TO PUT IN IT</span></p>\n<p>Comment on docket CDC-2026-0892 closes on 31 July. CDC refused the previous round of requests to assess Uganda separately from DRC because &quot;the outbreak remains interconnected across national borders.&quot; A formal end-of-outbreak declaration landed three days before the window shuts. That reasoning is now testable in writing.<br><span class=\"sowhat\">🎯 So what: If you sell Uganda to Americans, file at regulations.gov by Friday — attach the 28 July declaration and your own cancellation numbers. Last formal channel before the 12 August decision.</span><br><span class=\"tagline\">🏷 Bush/City | 🇺🇬 | Confirmed</span></p>\n<p><span class=\"meta-line\">📡 RADAR: 300 overnight observations, 40 ranked candidates — almost entirely a bulk US State Department advisory refresh with no East African content. The lead came from the manual upstream scan, not the feed.</span></p>\n<p>✍️ OUR OWN CALL, CORRECTED: on 25, 27 and 28 July we put the all-clear &quot;around 27 August&quot;. Right on outcome, a month wrong on the date. Logged.</p>\n<p>🔗 This edition on the web: <a href=\"https://eahospitalitypulse.com/editions/pulse-2026-07-29-morning.html\" rel=\"noopener\">eahospitalitypulse.com/editions/pulse-2026-07-29-mornin…</a><br>— EA Hospitality Pulse | Daily intelligence for city, bush &amp; beach properties</p>"
 },
 {
  "id": "pulse-2026-07-28-evening",
  "date": "2026-07-28",
  "dateDisplay": "Tuesday, 28 July 2026",
  "edition": "Evening Wrap",
  "editionKey": "evening",
  "summary": "Washington left a door open for East Africa. It shuts on Friday, and nobody in this industry has walked through it.",
  "bodyHtml": "<p><span class=\"meta-line\">🏨 EA HOSPITALITY PULSE — Evening Wrap</span><br><span class=\"meta-line\">📅 Tuesday, 28 July 2026 | 🇺🇬 🇰🇪 🇷🇼 🇹🇿</span></p>\n<p>Washington left a door open for East Africa. It shuts on Friday, and nobody in this industry has walked through it.<br>━━━━━━━━━<br><span class=\"item-head\">1️⃣ THE COMMENT WINDOW ON THE UGANDA ENTRY BAN CLOSES FRIDAY</span></p>\n<p>The CDC order suspending entry to the US of anyone present in DRC, Uganda or South Sudan in the previous 21 days was published in the Federal Register on 16 July (91 FR 43636, docket CDC-2026-0892). It carries a 15-day public comment period that closes <strong>31 July</strong>. In the same document CDC answers the comments it received last round — and two of them asked for exactly what Ugandan tourism needs: that Uganda be assessed independently of DRC. CDC refused, in writing: &quot;the outbreak remains interconnected across national borders.&quot; We have not seen a single East African tourism body, airline or destination marketing organisation on that docket.<br><span class=\"sowhat\">🎯 So what: If you sell Uganda to Americans, file a comment at regulations.gov under docket CDC-2026-0892 before Friday, with your own cancellation and rebooking numbers in it. Evidence beats sentiment, and this is the only formal channel that exists.</span><br><span class=\"tagline\">🏷 Bush/City | 🇺🇬 🇰🇪 🇷🇼 | Confirmed</span></p>\n<p><span class=\"item-head\">2️⃣ THE BAN NOW CATCHES US GREEN CARD HOLDERS</span></p>\n<p>Quietly, the exemption that let US lawful permanent residents through was deleted. 42 CFR 71.40(f) was amended on 27 May (91 FR 31362) and the 13 July order applies &quot;including lawful permanent residents of the United States.&quot; A green card holder who treks Bwindi cannot go home for 21 days. That is a distinct, high-value segment — diaspora, US-based professionals, repeat gorilla clients — and most of them do not know.<br><span class=\"sowhat\">🎯 So what: Put a one-line non-US-citizen warning into every American-market quote and pre-arrival email tonight. Offer a free date change rather than lose the booking to a surprise at the airport.</span><br><span class=\"tagline\">🏷 Bush/City | 🇺🇬 | Confirmed</span></p>\n<p><span class=\"item-head\">3️⃣ UGANDA&#x27;S CONTACT-TRACING CHAIN IS NOW EMPTY</span></p>\n<p>Uganda&#x27;s Ministry of Health EVD dashboard, updated today: 20 confirmed cases, 0 current admissions, 0 active contacts under follow-up, 821 of 831 listed contacts having completed 21 days. 2,482 people tested, 5,465 travellers screened at points of entry. That is day 12 of a 42-day countdown that started 16 July and finishes around 27 August.<br><span class=\"sowhat\">🎯 So what: Uganda&#x27;s epidemiological case is now genuinely strong. The problem is that the US decision point is 12 August — a fortnight before Uganda can be declared clear. Sell the data, but do not promise clients an August lift.</span><br><span class=\"tagline\">🏷 Bush/City | 🇺🇬 | Confirmed</span></p>\n<p><span class=\"meta-line\">💬 Has anyone in East African tourism actually filed on a US federal docket before? If you have, tell us how it went.</span></p>\n<p>🔗 This edition on the web: <a href=\"https://eahospitalitypulse.com/editions/pulse-2026-07-28-evening.html\" rel=\"noopener\">eahospitalitypulse.com/editions/pulse-2026-07-28-evenin…</a><br>💼 Today&#x27;s Big Read on LinkedIn: <a href=\"https://www.linkedin.com/company/ea-hospitality-pulse/\" rel=\"noopener\">linkedin.com/company/ea-hospitality-pulse/</a><br>— EA Hospitality Pulse | Daily intelligence for city, bush &amp; beach properties</p>"
 },
 {
  "id": "pulse-2026-07-28-morning",
  "date": "2026-07-28",
  "dateDisplay": "Tuesday, 28 July 2026",
  "edition": "Morning Brief",
  "editionKey": "morning",
  "summary": "The strike that was due to hit JKIA this morning isn't happening. That's a reprieve, not a settlement.",
  "bodyHtml": "<p><span class=\"meta-line\">🏨 EA HOSPITALITY PULSE — Morning Brief</span><br><span class=\"meta-line\">📅 Tuesday, 28 July 2026 | 🇰🇪 🇺🇬 🇹🇿 🇷🇼</span></p>\n<p>The strike that was due to hit JKIA this morning isn&#x27;t happening. That&#x27;s a reprieve, not a settlement.<br>━━━━━━━━━<br><span class=\"item-head\">1️⃣ JKIA STRIKE CALLED OFF — 24 HOURS BEFORE IT STARTED</span><br>The Kenya Aviation Workers Union withdrew the nationwide strike it had scheduled to begin today, after signing a framework agreement on Monday 27 July with the Ministry of Roads and Transport, Kenya Airways, KAA, KCAA and Jambojet (The Star and Capital FM, 27 July). The 20 July strike notice is withdrawn; KAWU–airline talks open today, and the harder round — KAWU with KAA — begins tomorrow, 29 July. Core demands are unresolved: withdrawal of NYS and KDF personnel from the JKIA fire station, and reinstatement of four dismissed employees.<br><span class=\"sowhat\">🎯 So what: Don&#x27;t stand down your contingency. Keep the airport-transfer buffer and the flexible-rebooking wording live through 29 July, and only tell agents &quot;resolved&quot; when a CBA is signed, not when a strike is suspended.</span><br><span class=\"tagline\">🏷 City/Bush/Beach | 🇰🇪 | Confirmed</span></p>\n<p><span class=\"item-head\">2️⃣ OIL ROUND-TRIPPED — AND THE AUGUST FUEL NUMBER SURVIVED IT</span><br>Brent went above US$100 on 23 July after Houthi attacks on two Saudi tankers in the Red Sea, then fell to US$90.28 on Monday 27 July — down 8.2% in a session — as the US and Iran paused strikes (Bloomberg and Trading Economics, 23–27 July). The Standard put the intraday peak higher, above US$112, before easing to US$88 (Financial Standard, 28 July). Context on the cost side: CBK&#x27;s weekly bulletin for the week to 23 July showed reserves at US$13.854bn, 5.9 months of import cover, down from 6.0, with the shilling at 129.53 from 129.34.<br><span class=\"sowhat\">🎯 So what: EPRA prices off the previous month&#x27;s landed cargo costs, so the spike lands in your September pump price, not the 15 August one — our inference, not EPRA&#x27;s word. Fix diesel and LPG supply contracts this week while the market is calm, and don&#x27;t rebase transfer surcharges off a four-day panic.</span><br><span class=\"tagline\">🏷 All segments | 🇰🇪 (regional read-across) | Confirmed / inference flagged</span></p>\n<p><span class=\"item-head\">3️⃣ THE WRECK OFF NYALI STAYS PUT UNTIL MID-AUGUST</span><br>KMA Director General Omae Nyarandi confirmed the refloating of MV Adan — aground off Nyali since 18 May while sailing Dar es Salaam to Mombasa — will only begin in mid-August 2026, timed to favourable weather and tides (The Standard, 27 July). Yaa Holdings Limited is the appointed salvage contractor; the plan is still in regulatory review. The Coast Guard is running round-the-clock security against vandalism, and maritime sources warn of fuel discharge risk.<br><span class=\"sowhat\">🎯 So what: North-coast resorts get a wreck on the horizon through the whole August peak. Brief front desk today with one honest line, put it in pre-arrival comms before a guest photographs it, and confirm your pollution-event cover with your insurer this week.</span><br><span class=\"tagline\">🏷 Beach | 🇰🇪 | Confirmed</span><br>━━━━━━━━━<br><span class=\"meta-line\">📡 RADAR</span><br>• 29 Jul — KAWU–KAA negotiations open. This is the table that decides whether the strike returns.<br>• 30–31 Jul — KNBS July CPI. June ran at 6.4%.<br>• 12 Aug — US CDC decision point on renewing Ebola-related entry restrictions for DRC, Uganda and South Sudan.<br>• 14–15 Aug — EPRA monthly fuel review. Also the MV Adan refloating window.<br>• 27 Aug — Uganda&#x27;s 42-day Ebola countdown ends.</p>\n<p><span class=\"meta-line\">💬 Did you hold rooms back for a strike that never came? Reply and tell us what it cost you.</span></p>\n<p>🔗 This edition on the web: <a href=\"https://eahospitalitypulse.com/editions/pulse-2026-07-28-morning.html\" rel=\"noopener\">eahospitalitypulse.com/editions/pulse-2026-07-28-mornin…</a><br>— EA Hospitality Pulse | Daily intelligence for city, bush &amp; beach properties</p>"
 },
 {
  "id": "pulse-2026-07-27-midday",
  "date": "2026-07-27",
  "dateDisplay": "Monday, 27 July 2026",
  "edition": "Midday Pulse",
  "editionKey": "midday",
  "summary": "Friday's licence row has become a relocation. Laikipia's most reliable off-season bed base is now Tanzania's.",
  "bodyHtml": "<p><span class=\"meta-line\">🏨 EA HOSPITALITY PULSE — Midday Pulse</span><br><span class=\"meta-line\">📅 Monday, 27 July 2026 | 🇰🇪🇹🇿</span></p>\n<p>Friday&#x27;s licence row has become a relocation. Laikipia&#x27;s most reliable off-season bed base is now Tanzania&#x27;s.</p>\n<p>━━━━━━━━━<br><span class=\"item-head\">1️⃣ TANZANIA TAKES BRITAIN&#x27;S £58M LAIKIPIA TRAINING BUSINESS</span><br>This is what changed. Friday it was one exercise delayed by paperwork; today The Standard (27 July) reports the UK has moved it to Tanzania after Kenya withheld the licences, effectively halting BATUK operations in Laikipia. The exercise is Haraka Storm, due to run in Laikipia September to November. BATUK rotates up to 10,000 British soldiers through Nanyuki a year, and British military activity puts roughly £58m — about Sh10bn — into the local economy annually (per The Standard, 24 July).<br><span class=\"sowhat\">🎯 So what: Nanyuki, Timau and Laikipia properties should treat September–November military and contractor room-nights as gone, not deferred, and resell that block this week into migration overflow and domestic conference business. Northern Tanzania operators: British MoD accommodation and logistics demand is now a live tender — get on the supplier list.</span><br><span class=\"tagline\">🏷 Bush/City | KE 🇰🇪 TZ 🇹🇿 | Reported</span></p>\n<p><span class=\"item-head\">2️⃣ THE AUGUST FUEL NUMBER IS BEING SET THIS FORTNIGHT</span><br>Brent traded at US$90.28 today, down 8.23% on the day on reports of revived US–Iran talks — but still up 22.15% over the month (per Trading Economics, 27 July). Houthi forces claimed attacks on Aramco facilities at Jizan and Yanbu over the weekend. EPRA held the 14 June–14 August cycle flat: Super Ksh214.03, diesel Ksh222.86, kerosene Ksh191.38 in Nairobi. EPRA averages landing costs of cargoes arriving up to the 10th of the month — so the next number is being priced right now (per Kenyans.co.ke, 24 July, quoting Prime CS Musalia Mudavadi).<br><span class=\"sowhat\">🎯 So what: the fact is a 22% monthly move in crude with the window still open. The inference is ours: 15 August diesel is more likely up than down. Cost your Q4 transfer and generator lines at Ksh240 diesel and see what breaks. Any 2027 contract on your desk this week needs a fuel-surcharge clause before you sign it, not after.</span><br><span class=\"tagline\">🏷 All segments | KE 🇰🇪 regional | Confirmed (price) / inference flagged</span></p>\n<p><span class=\"item-head\">3️⃣ TANZANIA PUTS AN EL NIÑO CONTINGENCY PLAN ON THE BOOKS</span><br>The Prime Minister&#x27;s Office is preparing a costed national contingency plan for El Niño, with expanded early warning, disaster risk coordinator Yona Benjamin told The Citizen (27 July). The forecast beneath it is older and should be read as such: TMA projected in May a 90% probability of El Niño conditions developing October to December 2026. TMA director Dr Ladislaus Chang&#x27;a urged operators to use the remaining dry months to finish construction.<br><span class=\"sowhat\">🎯 So what: that last line is an instruction, not advice. If you have a refurbishment, a new wing or an access road running on the southern circuit, Rufiji, Selous or the coast, pull completion forward into September. Then re-read your green-season cancellation terms — a 90% flood probability across your Oct–Dec window is an underwriting question, not a weather one.</span><br><span class=\"tagline\">🏷 Bush/Beach | TZ 🇹🇿 ZNZ | Reported</span></p>\n<p><span class=\"meta-line\">💬 Nanyuki and Laikipia owners — how much of your Sept–Nov book was BATUK-linked? Reply; we&#x27;ll aggregate it anonymously.</span></p>\n<p>🔗 This edition on the web: <a href=\"https://eahospitalitypulse.com/editions/pulse-2026-07-27-midday.html\" rel=\"noopener\">eahospitalitypulse.com/editions/pulse-2026-07-27-midday…</a><br>— EA Hospitality Pulse | Daily intelligence for city, bush &amp; beach properties</p>"
 },
 {
 ...
 },
 {
  ...
  "bodyHtml": "<p><span class=\"meta-line\">🏨 EA HOSPITALITY PULSE — Sunday Foresight</span><br><span class=\"meta-line\">📅 Sunday, 26 July 2026 | 🇰🇪 🇺🇬 🇹🇿 🇷🇼</span></p>\n<p><strong>The week the region&#x27;s best growth market and its worst health risk turned out to be the same country.</strong><br>━━━━━━━━━</p>\n<p><strong>THE THEME: YOUR NEW GROWTH ENGINE HAS A HEALTH PROBLEM</strong></p>\n<p>Read the daily briefs back and the week looks like good news. Uganda counting down to an Ebola all-clear. Uganda Airlines committing to eight Boeing jets. Emirates going triple-daily into Nairobi. Kampala winning FHS Africa 2027. Mombasa clearing 20,000 visitors in seven days.</p>\n<p>Now put one more number beside them. Rwanda&#x27;s largest single source market in the first half of 2026 was not Europe, not the United States, not Kenya — it was the Democratic Republic of Congo, with 185,420 visitors, 12.5% of all arrivals (reported 18 July). Add Uganda, Kenya and Tanzania and roughly 42% of Rwanda&#x27;s arrivals now come from four neighbours. That is the shape of this cycle&#x27;s growth right across the region: regional, repeat, cheap to acquire, weakly branded.</p>\n<p>And on 24 July the ECDC&#x27;s weekly threats report put DRC&#x27;s Bundibugyo outbreak at 2,473 confirmed cases and 999 deaths, spread across 47 of 140 health zones in five provinces. The region has been watching Uganda&#x27;s 42-day clock. The clock that matters is the one nobody is timing — in the country that is now Rwanda&#x27;s biggest customer. European leisure demand takes months to leave and months to return. Regional demand can be switched off in an afternoon by a border notice, and Rwanda has already done exactly that with its 30-day DRC travel-history rule. Cheap demand is fragile demand. Price it that way.</p>\n<p>━━━━━━━━━<br><strong>THE WEEK&#x27;S SIGNALS</strong></p>\n<p><span class=\"item-head\">1️⃣ <strong>DRC&#x27;S OUTBREAK IS GROWING, NOT SHRINKING</strong></span><br>The ECDC&#x27;s Communicable Disease Threats Report for week 30 (published 24 July) and its outbreak page (updated 22 July) cite DRC&#x27;s INSP situation report of 21 July: 2,473 confirmed cases and 999 deaths, with 50 new confirmed cases and 32 deaths in a single day. Ituri alone accounts for 2,202 cases. Uganda, by contrast, has had no new case since 21 June. We have not seen this translated for operators anywhere in the trade press.<br><span class=\"sowhat\">🎯 <strong>So what:</strong> Stop budgeting for a &quot;post-declaration bounce&quot; in late August. Uganda&#x27;s all-clear resolves Uganda&#x27;s outbreak, not the region&#x27;s risk file. Brief your agents now that the Ugandan and Congolese situations are separate — because the advisory desks in Washington, London and Berlin are modelling DRC&#x27;s curve, not Uganda&#x27;s.</span><br><span class=\"tagline\">🏷 Bush/City | 🇺🇬 🇷🇼 Regional | Confirmed | ECDC, 24 July</span></p>\n<p><span class=\"item-head\">2️⃣ <strong>UGANDA AIRLINES BUYS FOR A DECADE IT HASN&#x27;T UNDERWRITTEN</strong></span><br>At Farnborough on 21 July, Uganda Airlines ordered four Boeing 737-8 MAX and four 787-9 Dreamliners — its first direct purchase from Boeing (New Vision, 22 July). The 787-9s are for Europe, Asia and the Middle East; the MAXs for Africa, the Middle East and India. The carrier currently serves 17 destinations in 13 countries from Entebbe.<br><span class=\"sowhat\">🎯 <strong>So what:</strong> This is a long-haul bet placed by a country sitting at US Level 4 with Q1 Entebbe arrivals down 7.9%. Seats, not brand, will set 2027–28 Kampala rates. If you own Kampala rooms, model a scenario where lift arrives twelve months before the advisory lifts: high volume, low rate, heavy regional and Indian mix. Start building corporate and MICE contracts now while you still have pricing power.</span><br><span class=\"tagline\">🏷 City/Bush | 🇺🇬 | Confirmed | New Vision, 22 July</span></p>\n<p><span class=\"item-head\">3️⃣ <strong>KENYA&#x27;S COAST IS RUNNING HOT WHILE THE INTERIOR ARGUES</strong></span><br>Tourism CS Rebecca Miano said on Friday 24 July that more than 20,000 visitors arrived through Mombasa in the previous week. That is peak-season strength holding through a fortnight of political noise, a UK training-exercise withdrawal from Laikipia and an unresolved Mara licensing case.<br><span class=\"sowhat\">🎯 <strong>So what:</strong> Coast demand is not the problem this quarter; conversion is. Hold rate through August rather than discounting into a full house, and shift any spend into September–November, where the coast is thinner than the bush.</span><br><span class=\"tagline\">🏷 Beach/Bush | 🇰🇪 | Confirmed | Ministry of Tourism via Kenyan press, 24 July</span></p>\n<p>━━━━━━━━━<br><span class=\"meta-line\">📡 <strong>30/90-DAY DEMAND CALENDAR</strong></span></p>\n<p>🇰🇪 <strong>14 Aug</strong> — EPRA monthly fuel review. Pump prices are frozen until this date (EPRA, 14 July). <strong>Lock transfer and generator pricing for September now, before the review.</strong><br>🇹🇿 <strong>~13 Aug</strong> — Zanzibar Commission for Tourism July arrivals (June&#x27;s 69,605 landed 13 July). <strong>If July growth again prints under 10%, treat the supply wave as a rate problem, not a demand story.</strong><br>🇺🇬 <strong>~27 Aug</strong> — Uganda&#x27;s 42-day countdown ends; earliest date for an end-of-outbreak declaration. <strong>Have the &quot;we are open, here is the evidence&quot; agent pack drafted by 20 August — not written on the day.</strong><br>🇰🇪 <strong>31 Aug</strong> — KNBS monthly CPI. <strong>The wage and laundry cost line for your Q4 budget.</strong><br>🇺🇬 <strong>25–27 Sept</strong> — Three days of free national park entry (UWA). <strong>Package a shoulder-season lodge stay against it now; entry fees only — game drives and permits still bill.</strong><br>🇹🇿 <strong>24–27 Sept</strong> — TIMEXPO, Dar es Salaam. <strong>Corporate room-night demand; quote group rates before the end of August.</strong><br>🌍 <strong>Every Friday</strong> — ECDC Communicable Disease Threats Report. <strong>The cleanest weekly read on DRC&#x27;s trajectory. Next: 31 July.</strong><br>🇹🇿 <strong>by 31 Oct</strong> — Our outer date for the Fair Competition Commission&#x27;s ruling on A Squared Holding&#x27;s acquisition of Nawiri/Asilia. <strong>If it clears unconditionally, expect consolidation pricing across the northern circuit into 2027.</strong></p>\n<p>━━━━━━━━━<br>📓 <strong>THE LEDGER</strong><br>Nothing resolved this week. Seventeen calls open. The two that matter most are P001 (Uganda declared clear on or about 27 August) and P002 (the US does not lower Uganda from Level 4 within 30 days of that declaration). This week&#x27;s DRC numbers make us more confident in P002, not less.</p>\n<p><span class=\"meta-line\">💬 What share of your 2027 forecast depends on guests from a neighbouring country — and have you ever stress-tested that line against a border notice?</span></p>\n<p>🔗 This edition on the web: <a href=\"https://eahospitalitypulse.com/editions/foresight-2026-07-26.html\" rel=\"noopener\">eahospitalitypulse.com/editions/foresight-2026-07-26.html</a><br>💼 This week&#x27;s Big Read on LinkedIn: <a href=\"https://www.linkedin.com/company/ea-hospitality-pulse/\" rel=\"noopener\">linkedin.com/company/ea-hospitality-pulse/</a></p>\n<p>— EA Hospitality Pulse | Daily intelligence for city, bush &amp; beach properties</p>"
 },
 {
 ...
 },
 {
  ...
  "edition": "Shock Playbook",
  "editionKey": "playbook",
  "summary": "Uganda's Ebola clock ends around 27 August. Most operators will plan the wrong recovery — here's the 72-hour playbook.",
 ...
 {
  "id": "pulse-2026-07-24-evening-1",
  "date": "2026-07-24",
  "dateDisplay": "Friday, 24 July 2026",
  "edition": "Evening Wrap",
  "editionKey": "evening",
  "summary": "Kenya's numbers just called the bluff on its politics — and there's a lesson in it for every owner heading into the 2027 cycle.",
  "bodyHtml": "<p><span class=\"meta-line\">🏨 EA HOSPITALITY PULSE — Evening Wrap</span><br><span class=\"meta-line\">📅 Friday, 24 July 2026 | 🇰🇪🇷🇼</span></p>\n<p>Kenya&#x27;s numbers just called the bluff on its politics — and there&#x27;s a lesson in it for every owner heading into the 2027 cycle.</p>\n<hr class=\"divider\">\n<p><span class=\"item-head\">1️⃣ KENYA DEMAND HOLDS FIRM DESPITE POLITICAL NOISE</span><br>Tourism CS Rebecca Miano confirmed today that Mombasa alone received 20,000+ visitors in the past week, with strong volumes across all major entry points — five days after former DP Rigathi Gachagua publicly urged tourists to stay away from Kenya until a change of government. Canada also issued a cautionary note on Kenya this week (per Tuko). The data says the market is shrugging: domestic, regional and international arrivals are landing ahead of the August high season.<br><span class=\"sowhat\">🎯 So what: hold your peak-season rates — the demand is real. But treat this as your first taste of 2027 election-cycle noise: build flexible cancellation terms into Q3-Q4 2027 contracts now, and brief your overseas agents proactively before advisories do it for you.</span><br><span class=\"tagline\">🏷 City / Bush / Beach | KE | Confirmed</span></p>\n<p><span class=\"item-head\">2️⃣ NAIROBI&#x27;S 3,650-ROOM PIPELINE SHARPENS THE STAKES</span><br>Context for city operators: W Hospitality Group counts ~20 branded hotels (~3,650 rooms) in Nairobi&#x27;s pipeline, with ~10 hotels (~1,500 rooms) opening in 2026 alone — after occupancy already fell nearly 10 points as 2,000 rooms landed in 2023-25 (per Tourism Update). Strong arrivals weeks like this one are what must absorb that supply.<br><span class=\"sowhat\">🎯 So what: differentiate or discount. If your product looks like the new stock, start building extended-stay, lifestyle or MICE packaging before the 2026 openings hit your comp set.</span><br><span class=\"tagline\">🏷 City | KE | Confirmed</span></p>\n<p><span class=\"item-head\">3️⃣ DRC IS NOW RWANDA&#x27;S LARGEST SOURCE MARKET</span><br>RDB data shows 185,420 DRC visitors in H1 2026 — 12.5% of all arrivals, overtaking every overseas market (per Travel and Tour World).<br><span class=\"sowhat\">🎯 So what: Kigali city properties should be selling in French and courting Congolese corporate and family segments directly — not just waiting on European leisure.</span><br><span class=\"tagline\">🏷 City | RW | Reported</span></p>\n<hr class=\"divider\">\n<p><span class=\"meta-line\">💬 Which of these hits your property hardest? Reply and tell us.</span><br>— EA Hospitality Pulse | Daily intelligence for city, bush &amp; beach properties</p>"
 },
 {
  "id": "pulse-2026-07-24-evening",
  "date": "2026-07-24",
  "dateDisplay": "Friday, 24 July 2026",
  "edition": "Evening Wrap",
  "editionKey": "evening",
  "summary": "The US has moved Uganda to \"do not travel\". Tonight's wrap is about what advisory shocks do to booking curves — and what to do in the first 72 hours.",
 ...
 },
 {
  ...
  "edition": "Midday Pulse",
  "editionKey": "midday",
  "summary": "Kenya's coast is outrunning the political noise, and Uganda is weeks from an official Ebola all-clear.",
  "bodyHtml": "<p><span class=\"meta-line\">🏨 EA HOSPITALITY PULSE — Midday Pulse</span><br><span class=\"meta-line\">📅 Friday, 24 July 2026 | 🇰🇪🇺🇬</span></p>\n<p>Kenya&#x27;s coast is outrunning the political noise, and Uganda is weeks from an official Ebola all-clear.</p>\n<hr class=\"divider\">\n<p><span class=\"item-head\">1️⃣ MOMBASA CLEARS 20,000 VISITORS IN A WEEK</span><br>Tourism CS Rebecca Miano reports strong numbers across Kenya&#x27;s major entry points this past week, with Mombasa leading at 20,000+ visitors — days after Rigathi Gachagua&#x27;s remarks discouraging visitors drew a ministry warning that KSh1.7tn in tourism value is at stake (per The Star, Tuko).<br><span class=\"sowhat\">🎯 So what: Coastal properties — hold rate through August. Don&#x27;t let political noise talk you into discounting a peak season that is physically arriving at your door.</span><br><span class=\"tagline\">🏷 Beach/City | KE | Reported</span></p>\n<p><span class=\"item-head\">2️⃣ UGANDA STARTS 42-DAY EBOLA COUNTDOWN</span><br>WHO confirms Uganda&#x27;s last Ebola patient has been discharged, with no new confirmed cases since 21 June (20 cases, 2 deaths in total). If the 42-day countdown holds, the outbreak is formally declared over around end-August. The DRC outbreak next door continues, per UN News.<br><span class=\"sowhat\">🎯 So what: UG operators — build recovery marketing now for the Sep–Dec gorilla and MICE window. The official all-clear is your cue to push long-window international bookings; brief your trade partners before it lands.</span><br><span class=\"tagline\">🏷 Bush/City | UG | Confirmed</span></p>\n<p><span class=\"item-head\">3️⃣ JW MARRIOTT OPENS SAFARI CAMP IN SOLIO</span><br>Reservations are open for JW Marriott Mount Kenya Rhino Reserve Safari Camp in Solio Game Reserve, welcoming guests this month (per Hospitality Net). Branded competition in the Laikipia conservancy belt deepens.<br><span class=\"sowhat\">🎯 So what: Laikipia and Mt Kenya lodges — benchmark your 2027 rate card against branded newcomers now, and sharpen the conservation story only independents can tell.</span><br><span class=\"tagline\">🏷 Bush | KE | Confirmed</span></p>\n<hr class=\"divider\">\n<p><span class=\"meta-line\">💬 Which of these hits your property hardest? Reply and tell us.</span><br>— EA Hospitality Pulse | Daily intelligence for city, bush &amp; beach properties</p>"
 },
 {
  "id": "pulse-2026-07-24-midday",
  "date": "2026-07-24",
  "dateDisplay": "Friday, 24 July 2026",
  "edition": "Midday Pulse",
  "editionKey": "midday",
  "summary": "Kenya's security optics take another knock; Zanzibar's branded-luxury supply race accelerates.",
  "bodyHtml": "<p><span class=\"meta-line\">🏨 EA HOSPITALITY PULSE — Midday Pulse</span><br><span class=\"meta-line\">📅 Friday, 24 July 2026 | 🇰🇪🇹🇿🇺🇬</span></p>\n<p>Kenya&#x27;s security optics take another knock; Zanzibar&#x27;s branded-luxury supply race accelerates.</p>\n<hr class=\"divider\">\n<p><span class=\"item-head\">1️⃣ UK PULLS LAIKIPIA TRAINING EXERCISE OUT OF KENYA</span><br>The UK has cancelled Exercise Haraka Storm, scheduled for Laikipia in September–November, after the required Kenyan licences &quot;have not been forthcoming&quot; — the training moves outside Kenya, though BATUK itself stays, per The Star. It lands days after Tourism PS Julius Bitok warned that alarmist security rhetoric puts a Sh1.7 trillion sector and nearly 2 million jobs at risk.<br><span class=\"sowhat\">🎯 So what: Laikipia-area lodges and Nanyuki/Nairobi hotels carrying defence-linked block business should re-forecast Q4 group demand now and chase replacement corporate and MICE volume — don&#x27;t discount leisure off the back of headlines.</span><br><span class=\"tagline\">🏷 City, Bush | KE | Confirmed</span></p>\n<p><span class=\"item-head\">2️⃣ MARRIOTT PARTNERS CATALONIA FOR ZANZIBAR ALL-INCLUSIVES</span><br>Marriott International announced a tie-up with Spain&#x27;s Catalonia Hotels &amp; Resorts on 24 July to develop upscale all-inclusive resorts in Zanzibar, per Travel And Tour World — stacking onto the Ritz-Carlton Nungwi debut slated for late 2026. Zanzibar arrivals reached 917,167 in 2025, up roughly 24% on 2024.<br><span class=\"sowhat\">🎯 So what: independent beach resorts should lock 2027 charter and tour-operator allocations before branded all-inclusive inventory resets rate benchmarks — and sharpen a differentiation story the brands can&#x27;t copy (dhow, Stone Town, community access).</span><br><span class=\"tagline\">🏷 Beach | ZNZ | Reported</span></p>\n<p><span class=\"item-head\">3️⃣ UGANDA AIRLINES DEEPENS REGIONAL SCHEDULE</span><br>Uganda Airlines&#x27; July 2026 schedule spans 14 destinations from Entebbe, with daily Nairobi rotations and three weekly Zanzibar flights, per KATA. Intra-EA connectivity keeps widening the regional corporate and leisure pool.<br><span class=\"sowhat\">🎯 So what: Kampala city hotels should court transit corporate traffic; Zanzibar resorts should build UG-origin weekend packages around the 3x weekly rotation.</span><br><span class=\"tagline\">🏷 City, Beach | UG, ZNZ | Reported</span></p>\n<hr class=\"divider\">\n<p><span class=\"meta-line\">💬 Which of these hits your property hardest? Reply and tell us.</span><br>— EA Hospitality Pulse | Daily intelligence for city, bush &amp; beach properties</p>"
 },
 {
  "id": "pulse-2026-07-24-inaugural",
  "date": "2026-07-24",
  "dateDisplay": "Friday, 24 July 2026",
...
window.INSIGHTS = [
 ...
 },
 {
  ...
  "sowhat": "🎯 **So what:** Count your licensable entities before you budget one fee — a lodge with a transport arm and a tour-operating arm is three applications, not one. Then get a written submission to the committee naming the public-participation defect specifically. Verbal evidence on Thursday is not a filing.",
  "segments": [
   "city",
   "bush",
   "beach"
  ...
  "countries": "🇰🇪",
  "confidence": "Confirmed (instrument & hearing) · Reported (fee bands)",
  "impact": "-margin",
  "impactClass": "margin",
  "intensity": 3,
  "impactSet": "author",
  "source": "pulse-2026-09-18-evening",
  "date": "2026-09-18",
  "dateDisplay": "Friday, 18 September 2026",
  "edition": "Evening Wrap",
  "editionKey": "evening"
 ...
 },
 {
  ...
  "countries": "🇰🇪 🇹🇿",
  "confidence": "Confirmed (events) · Inference (pass-through)",
  "impact": "-margin",
  "impactClass": "margin",
  "intensity": 3,
  "impactSet": "author",
 ...
 {
  "headline": "86 DAYS EBOLA-FREE. STILL BANNED. THE RISK IS THE MAP, NOT THE VIRUS.",
  "body": "DRC now stands at **7,200 confirmed cases and 3,475 deaths** on data to 12 September — up **258 cases and 126 deaths in two days** — with **62 of 167 health zones** affected across **seven** provinces *(DRC INSP SitRep N°122/MVEBDB/13/09/2026, via ECDC, page updated 14 September 2026)*. WHO's DON617 of **10 September** had it at 6,757 and 3,267 across **six** provinces on 7 September data. North Kivu, the province that touches Uganda and Rwanda, carries the outbreak's **highest case fatality ratio at 65.4%** and added **453 confirmed cases in 21 days** *(WHO DON617)*. Now the part operators miss. You are tracking your own country's case count. What prices your rooms is the granularity of somebody else's map. Every restriction written in this outbreak was written at **country** resolution. Rwanda denies entry to any foreign national who transited DRC within 30 days *(Ministry of Health, Kigali, 22 May 2026)*. Bahrain, Jordan, Kuwait, Lebanon, Mauritius, Taiwan, Canada and the UAE all named DRC, Uganda and South Sudan as **countries** *(Fragomen, 9 June 2026)*. None of them separates Ituri from Kinshasa, 1,600km apart. Uganda has had no confirmed case since **21 June** and was declared outbreak-free on **25 August** *(WHO AFRO)* — **86 days clean** on our arithmetic. It is still named.",
  "sowhat": "🎯 **So what:** stop asking your DMC whether cases are falling. Ask one question instead — *has any ministry moved from country-level to province-level language?* That, not epidemiology, is the recovery signal. Restrictions arrive at the speed of news and leave at the speed of bureaucracy.",
  "segments": [
   "city",
   "bush"
  ],
  "countries": "🇺🇬 🇷🇼",
  "confidence": "Confirmed (data) · Inference (transmission)",
  "impact": "risk",
  "impactClass": "risk",
  "intensity": 3,
  "impactSet": "author",
  "source": "pulse-2026-09-15-evening",
  "date": "2026-09-15",
  "dateDisplay": "Tuesday, 15 September 2026",
  "edition": "Evening Wrap",
  "editionKey": "evening"
 ...
 },
 {
  ...
  "sowhat": "🎯 **So what:** stop burying transfers in the rate. If road transfers, game drives and airport runs sit inside an inclusive price, you are absorbing a 9–24% input rise inside a 2.5–3.0% price. Break them out as a quoted line with a fuel-adjustment clause — you are contracting 2027 rates *now*.",
  "segments": [
   "city",
   "bush",
   "beach"
  ...
  "intensity": 3,
  "impactSet": "author",
  "source": "pulse-2026-09-11-morning",
  "date": "2026-09-11",
  "dateDisplay": "Friday, 11 September 2026",
  "edition": "Morning Brief",
  "editionKey": "morning"
 ...
 {
  "headline": "AND KENYA IS ABSORBING THE MOST OF ANYONE.",
  "body": "Subtract headline inflation from the hospitality line and you get the real price of a room: **Kenya −3.6pp · Uganda −1.6pp · Tanzania −1.3pp · Rwanda −0.1pp** *(our calculation from the four releases)*.",
  "sowhat": "🎯 **So what:** if you held Nairobi or coast rate flat this year \"to stay competitive\", you did not hold it. You cut it about 3.6% in real terms while your transport bill rose 15.7%. Take that number into the October budget round instead of a gut feel.",
  "segments": [
   "city",
   "beach"
  ],
  "countries": "🇰🇪",
  "confidence": "Confirmed (inputs) / Our calculation (the spread)",
  "impact": "-margin",
  "impactClass": "margin",
  "intensity": 3,
  "impactSet": "author",
 ...
 {
  "headline": "RWANDA HAS LEFT THE REGION'S PRICE BAND.",
  "body": "Urban CPI **15.7%** y/y, from 14.5% in July and 9.2% in March — up every month since. Rural 16.0%. Housing and utilities **20.4%**, food 16.3%, core 11.5% *(NISR, 10 Sep 2026)*. Kigali's hospitality line is up **15.6%**: Rwandan operators have passed the shock through, Kenyan and Tanzanian ones have not.",
  "sowhat": "🎯 **So what:** a Kigali conference gets dearer against Dar and Kampala every month, and RDB is chasing a US$156m MICE target into that. Selling Rwanda: quote in hard currency, shorten rate-validity windows. Selling Kampala or Dar against Kigali: your relative price has never been better — tell buyers now.",
  "segments": [
   "city",
   "bush"
  ],
 ...
 {
  "headline": "UGANDA IS THE CHEAP SEAT — BUT NOT AT THE PUMP.",
  "body": "Headline **4.1%**, the region's softest hospitality line at **2.5%** (from 3.2%). But petrol **+28.5%**, kerosene **+31.2%**, energy/fuel/utilities **+14.3%**. One easing: international flights **+17.0%**, from 24.1% *(UBOS, Aug 2026)*.",
  "sowhat": "🎯 **So what:** Uganda is the value play and its airfare drag is loosening. Price Bwindi–Queen Elizabeth against Kenyan equivalents in the Q4 deck — but fuel-index vehicle costs.",
  "segments": [
   "city",
   "bush"
  ],
 ...
 },
 {
  ...
  "sowhat": "🎯 **So what:** that is a resourcing plan, not an epidemiological forecast — but nobody provisions 2,071 beds for an outbreak they expect to close in October *(our inference, labelled)*. Washington raised Uganda to Level 4 on 17 May over this outbreak, and the PHEIC declared the same day names DRC **and Uganda**. Uganda's own outbreak ended 28 July, certified 26 August — yet Uganda sits inside a live PHEIC while the DRC side expands. If your Q4 plan assumes a US downgrade, rebuild it without one.",
  "segments": [
   "city",
   "bush"
  ],
  "countries": "🇺🇬 🇷🇼",
  "confidence": "Confirmed (facts) / Inference (read)",
  "impact": "risk",
  "impactClass": "risk",
  "intensity": 3,
  "impactSet": "author",
  "source": "pulse-2026-09-08-morning",
  "date": "2026-09-08",
  "dateDisplay": "Tuesday, 8 September 2026",
  "edition": "Morning Brief",
  "editionKey": "morning"
 ...
 {
  "headline": "ZANZIBAR ADDED TWO RESORTS ON SATURDAY — AND THE PRESIDENT ASKED THEM TO BUY LOCAL",
  "body": "President Hussein Ali Mwinyi inaugurated Anaya Hotels & Resorts Zanzibar and Kappa Senses Zanzibar at Pwani Mchangani, North Unguja, on 6 September. Combined investment above **US$52m**; **371 jobs** for Zanzibaris, per the President. Kappa Senses lists 85 villas and suites on its own booking pages. Mwinyi said Zanzibar now takes more than 100,000 visitors a month — his figure, not an OCGS release, and we have not yet matched it to the statistics office. He pressed hotels to buy more locally produced goods and open supply chains to local entrepreneurs.",
  "sowhat": "🎯 **So what:** north-east coast stock is thickening at the top end. Treat the procurement message as direction of travel — document your local-sourcing share before someone asks for it.",
  "segments": [
   "beach"
  ],
  "countries": "🇹🇿 Zanzibar",
  "confidence": "Confirmed (The Respondent, Zanzibar, 7 September 2026)",
  "impact": "watch",
  "impactClass": "watch",
  "intensity": 3,
  "impactSet": "author",
 ...
 {
  "headline": "STILL TRUE — THE US HAS TANZANIA AT LEVEL 3. IGNORE THE FEED SAYING LEVEL 1.",
  "body": "Our radar caught a US State Department feed item at 18:04 EAT last night headed \"Tanzania – Level 1\". We opened the rendered page this morning: **\"Travel Advisory October 31, 2025 — Tanzania Level 3: Reconsider Travel\"**, on unrest, crime, terrorism (highest risk in Mtwara) and targeting of gay and lesbian individuals. Unchanged 312 days. The feed and the page disagree; the page is what State stands behind.",
  "sowhat": "🎯 **So what:** don't discount against a rumoured upgrade. When an agent says Tanzania is cleared, send the page.",
  "segments": [
   "city",
   "bush",
   "beach"
 ...
 {
  "headline": "EAST AFRICA NO LONGER HAS ONE COST BASE. RWANDA'S HOTEL PRICES ROSE 14.2% THIS YEAR. TANZANIA'S ROSE 2.7%.",
  "body": "Same month, same statistical category. In the year to July 2026, restaurants and accommodation services rose **14.2%** in Rwanda *(NISR CPI, released 10 Aug 2026)* and **2.7%** in Tanzania *(NBS, July 2026)*. Behind it: Rwandan headline inflation **14.5%** in July — transport +24.2%, housing/electricity/gas/fuels +21.0%, food +13.1%. BNR's MPC on 26 Aug put Q2 core at 12.3% and **energy inflation at 45.7%**, then took the policy rate to **8.75%** on 27 Aug — a third straight rise, per Bloomberg a 17-year high. BNR forecasts 13.1% average this year, ~7.9% next, back inside its 2–8% band only in H2 2027. **What got missed: the currency has stopped paying for it.** Dollar-earning operators used to be carried by the franc — Governor Rwangombwa told Parliament in Nov 2024 it had fallen **16.3%** in FY2023/24. BNR reports it depreciated **0.5%** in Q1 2026, on exports up 63%. So a dollar rate card held flat now buys roughly **14% less** local input than in July 2025. Nothing on the rate sheet changed; the margin moved anyway. *(Our calculation from NISR and BNR figures — inference.)* • **KIGALI / MICE:** audit every rate fixed beyond March 2027. Bidding for 2028? Price off BNR's forecast path. Energy-escalation clause in anything signed this quarter. • **BUSH (Volcanoes, Nyungwe, Akagera):** exposure is transport +24.2% and energy +21%, not the permit — that's a dollar pass-through. Set 2027 brochure rates against those lines. • **BEACH / REGIONAL (Zanzibar, Diani):** a real advantage, and temporary. On 2027 multi-country programmes the Tanzanian and Kenyan legs hold value better. Tell your DMCs now.",
  "sowhat": "🎯 **So what — this is a contract problem, not a quarterly one.** RDB's 2025 annual report *(28 Apr 2026)* puts MICE at **US$94.7m from 165 events**. Congress business is won on bids placed years ahead and priced in dollars then; Visit Rwanda's own commitments run to 2028 and 2030; gorilla product enters brochures 12–18 months out. Compound BNR's forecast — 13.1% then 7.9% — and about **22% of cumulative cost inflation is already sitting inside signed prices.**",
  "segments": [
   "city",
   "bush",
   "beach"
  ...
  "countries": "🇷🇼 🇹🇿 🇰🇪",
  "confidence": "Confirmed (figures) / Inference (the read)",
  "impact": "-margin",
  "impactClass": "margin",
  "intensity": 3,
  "impactSet": "author",
  "source": "pulse-2026-09-08-evening",
  "date": "2026-09-08",
  "dateDisplay": "Tuesday, 8 September 2026",
  "edition": "Evening Wrap",
  "editionKey": "evening"
 ...
 },
 {
  ...
  "sowhat": "🎯 So what: send European agents the gov.uk line dated 2 September. Cheapest reassurance of the quarter.",
  "segments": [
   "city",
   "bush"
  ],
 ...
 {
  "headline": "21 DAYS TO EMPCO — THE EVIDENCE BURDEN FINALLY RUNS OUR WAY",
  "body": "Directive (EU) 2024/825 applies 27 September 2026: generic \"eco/green/sustainable\" barred without recognised certification, \"carbon neutral\" via offsets barred outright (EUR-Lex; Sustainable Travel International, 5 Aug 2026).",
  "sowhat": "🎯 So what: the fine sits with the European party, the evidence with you. Send EU partners a substantiation sheet before the Q4 round; you set the template.",
  "segments": [
   "city",
   "bush",
   "beach"
  ...
  "countries": "🇰🇪 🇺🇬 🇹🇿 🇷🇼",
  "confidence": "Confirmed / Inference (ours)",
  "impact": "watch",
  "impactClass": "watch",
  "intensity": 3,
  "impactSet": "auto",
 ...
 {
  "headline": "92.2% OF RESERVATION CALLS PRODUCE NO RECORD AT ALL",
  "body": "Revinate mystery-shop, 308 calls to 135 luxury and upscale properties (via Hospitality Net, 4 Sep 2026). North American sample; the failure is not.",
  "sowhat": "🎯 So what: every other record here is written by someone else. This one you write, and it is free.",
  "segments": [
   "city",
   "bush",
   "beach"
 ...
 },
 {
  ...
  "sowhat": "🎯 So what: Called off is not recovered. KBC reports passengers at JKIA since Monday; aircraft and crew are out of position, so today's arrivals are harder to plan than yesterday's. Hold rooms through tonight. Then diarise 22 September — February's settlement held five months, July's held one, and this one names its own next flashpoint.",
  "segments": [
   "city",
   "bush",
   "beach"
  ...
  "intensity": 3,
  "impactSet": "author",
  "source": "pulse-2026-09-01-morning",
  "date": "2026-09-01",
  "dateDisplay": "Tuesday, 1 September 2026",
  "edition": "Morning Brief",
  "editionKey": "morning"
 ...
 {
  "headline": "THE FCDO DID NOT DOWNGRADE KENYA. IT ADDED AN AIRPORT NOTE.",
  "body": "\"UK warns its citizens against travel to Kenya,\" ran the local headline yesterday (The Kenya Times, 31 August). We read the page. What the FCDO added on 31 August is one operational paragraph: industrial action is affecting airport operations, check with your airline. The advise-against-all-travel geography is unchanged and years old — Mandera; Tarbaj and Wajir East (except Wajir Town) and Wajir within 60km of Somalia; Garissa except Garissa Town, Lagdera and specified Balambala areas; Lamu except Lamu and Manda Islands. Ground: terrorism from Somalia-based groups (gov.uk, updated 31 August).",
  "sowhat": "🎯 So what: Nairobi, Mombasa, Diani, Watamu, the Mara, Amboseli and Laikipia are not in that list and never have been. When an agent forwards you the headline, don't reassure — quote the counties back. Precision closes the booking.",
  "segments": [
   "city",
   "bush",
   "beach"
 ...
 {
  "headline": "KENYA 6.6%, UGANDA 4.1% — AND KENYAN DIESEL FELL.",
  "body": "Kenya's annual inflation rose to 6.6% from 6.5%: food +9.0%, **transport +15.7%**, housing and utilities +3.6% (KNBS, 31 August). Uganda printed 4.1% from 4.0%, on food crops moving to 2.1% from 1.6% (UBOS, 31 August).",
  "sowhat": "🎯 So what: Kenyan transport inflation ran at 15.7% in a month when **average diesel fell 2.2% to KSh 219.04/litre** (KNBS). The pump isn't driving it — fares and margin are. Next time a transfer operator hands you a fuel surcharge, the fuel number is on your side of the table.",
  "segments": [
   "city",
   "bush"
  ],
 ...
 },
 {
  ...
  "body": "Kenya Aviation Workers Union members downed tools at the Kenya Airports Authority, KCAA and Jambojet on Sunday 30 August. Kenya Airways reported that only **30% of its scheduled flights had departed by 14:00 EAT**, with those that went averaging two-to-three-hour delays and later departures running beyond three (KQ customer update via KATA, 30 August). Disruption continued into this morning. KAA confirms delays but reports no closure — flights are operating.",
  "sowhat": "🎯 So what: Your exposure is *missed onward connections*, not cancellations. Any guest landing at JKIA today with a same-day Wilson or coastal leg to the Mara, Kilimanjaro or Zanzibar should be treated as at risk. Hold their room rather than releasing it, ring the DMC before the guest rings you, and offer the date change before anyone asks for a refund.",
  "segments": [
   "city",
   "bush",
   "beach"
  ...
  "intensity": 3,
  "impactSet": "author",
  "source": "pulse-2026-08-31-morning",
  "date": "2026-08-31",
  "dateDisplay": "Monday, 31 August 2026",
  "edition": "Morning Brief",
  "editionKey": "morning"
 ...
 {
  "headline": "THIS IS THE THIRD ROUND OF THE SAME DISPUTE SINCE FEBRUARY.",
  "body": "Treat this as a pattern, not an accident. The same CBA dispute shut JKIA for two days on 16–17 February 2026 — Jambojet flew just 25% of its schedule, cancelled over 40 flights and disrupted 5,000+ passengers (Jambojet CEO Karanja Ndegwa, Capital FM, 19 February). A second round was enjoined by the High Court on 23 July and suspended on 27 July under a return-to-work deal. KAWU has now lifted that suspension, saying the agencies never honoured it.",
  "sowhat": "🎯 So what: February's round ended on day two via mediation led by Transport CS Davis Chirchir. That is the base rate to plan against — expect resolution in days, not weeks, and don't panic-discount Q4. But stop treating JKIA reliability as a given when you build September–December itineraries: build a buffer night in Nairobi into long-haul arrivals rather than selling same-day bush connections.",
  "segments": [
   "city",
   "bush"
  ],
 ...
 {
  "headline": "STILL TRUE — KENYA IS STILL LEVEL 2. THIS IS NOT A RISK EVENT.",
  "body": "We checked travel.state.gov this morning: Kenya remains **Level 2, Exercise Increased Caution, date issued 28 July 2026** — unchanged. No government has moved on Kenya because of the strike.",
  "sowhat": "🎯 So what: When an agent asks whether Kenya is \"having problems\", answer precisely. A labour delay at an airport is an operations event; nothing about the country's risk posture has changed. Properties that blur the two hand a booking to the one that doesn't.",
  "segments": [
   "city",
   "bush",
   "beach"
 ...
 },
 {
  ...
  "sowhat": "🎯 So what: Count what share of your room-nights went through contracted allocation this year against last. Zanzibar added 5.4 points of package mix and was paid 3% less per night for it.",
  "segments": [
   "bush",
   "beach"
  ],
  "countries": "🇹🇿 Zanzibar, Tanzania (read-across: 🇰🇪 coast)",
  "confidence": "Confirmed",
  "impact": "watch",
  "impactClass": "watch",
  "intensity": 3,
  "impactSet": "author",
  "source": "pulse-2026-08-28-midday",
  "date": "2026-08-28",
  "dateDisplay": "Friday, 28 August 2026",
  "edition": "Midday Pulse",
  "editionKey": "midday"
 ...
 {
  "headline": "PACKAGE ISN'T THE PROBLEM. UNDIFFERENTIATED PACKAGE IS.",
  "body": "Same survey: mainland package guests spent USD 479 a night, up from USD 416. By activity, hunting took USD 710.8 (+54%), cultural tourism USD 537 and wildlife safari USD 452 — against birdwatching at USD 105.6. Average stay fell a night on both circuits, to 9 on the mainland and 6 in Zanzibar.",
  "sowhat": "🎯 So what: Specialisation prices; a substitutable beach night does not. Bush operators can hold rate on specialist product. Everyone lost a night of stay — recover it on rate, not volume.",
  "segments": [
   "bush",
   "beach"
  ],
 ...
 {
  "headline": "STILL TRUE — THE ADVISORY SPLIT ON ZANZIBAR",
  "body": "The US has held Tanzania and Zanzibar at Level 3 \"Reconsider travel\" since 31 October 2025, with no Zanzibar carve-out (verified against travel.state.gov, 4 August 2026). The UK has no advisory against travel. Zanzibar's two biggest source markets are Italy at 18.8% and France at 10.6%.",
  "sowhat": "🎯 So what: Don't discount a European base against an American advisory that doesn't bind it.",
  "segments": [
   "beach"
  ],
  "countries": "🇹🇿 Zanzibar",
 ...
 {
  "headline": "🇺🇬 WHO CERTIFIES UGANDA EBOLA-FREE — AND THE US LEVEL 4 STILL DOESN'T BUDGE",
  "body": "The WHO confirmed this week that Uganda has cleared the 42-day monitoring period with no new transmission (Al Jazeera, 26 Aug 2026). Total: **20 confirmed infections, two deaths**, last case 21 June. Kampala had declared it over on 28 July, counting from an earlier date — hence the month's gap. Permanent Secretary Diana Atwine: \"Unless they have other reasons, they should definitely lift the restrictions off the country.\" **We read travel.state.gov directly this afternoon.** Uganda remains **Level 4 — Do Not Travel**, issued **4 June 2026**. Unchanged for 84 days. **What everyone is missing:** State's own advisory history says the 17 May move to Level 4 was made *\"due to the Ebola Bundibugyo Virus Disease outbreak in Ituri Province in the DRC.\"* The trigger was never Ugandan epidemiology. Ituri is now the epicentre of the largest Ebola outbreak ever recorded — **5,656 confirmed cases, 2,715 deaths as at 25 August**, still climbing (DRC government data cited by ECDC, via Al Jazeera, 26 Aug 2026). Kampala cannot clear a condition set 877km away.",
  "sowhat": "🎯 **So what:** stop treating the Level 4 as a countdown. Contract 2027 as though it holds, reweight allocation towards UK, EU, Gulf and EAC trade, and ask your US agents this week what their insurers do with a Level 4 destination.",
  "segments": [
   "city",
   "bush"
  ],
  "countries": "UG",
  "confidence": "Confirmed (WHO; advisory read directly 27 Aug) / Inference (EA read)",
  "impact": "risk",
  "impactClass": "risk",
  "intensity": 3,
  "impactSet": "author",
  "source": "pulse-2026-08-27-evening",
  "date": "2026-08-27",
  "dateDisplay": "Thursday, 27 August 2026",
  "edition": "Evening Wrap",
  "editionKey": "evening"
 ...
 {
  "headline": "🇺🇬 KAMPALA SPENDS THE ALL-CLEAR ON CAPACITY, NOT MARKETING",
  "body": "Uganda took delivery of the antibody treatment **MBP134** at Kajjansi on 26 August (Uganda Ministry of Health, 26 Aug 2026) and a **Shs 1.87bn** mobile laboratory (Daily Monitor, 27 Aug 2026). It is also opening two further treatment centres inside the DRC — four in total — and supporting labs at Aru and Kasenyi in Ituri (Al Jazeera, 26 Aug 2026). Right public health. Commercially, it hard-wires the Uganda–Ituri association into the very documents advisory desks read.",
  "sowhat": "🎯 **So what:** send agents the arithmetic — 20 against 5,656 — not adjectives.",
  "segments": [
   "city",
   "bush"
  ],
 ...
 {
  "headline": "🌍 H1 2026: THE WORLD'S HOTELS GREW ON RATE, NOT HEADS",
  "body": "Global RevPAR ran **3–4% for the major chains in H1 2026**, but occupancy plateaued across most markets — the growth came from ADR (Hospitality Net, 27 Aug 2026).",
  "sowhat": "🎯 **So what:** if Uganda volumes disappoint this quarter, discounting is the wrong lever. Hold BAR, cut the length-of-stay minimum instead.",
  "segments": [
   "city",
   "bush",
   "beach"
  ],
  "countries": "KE·UG·TZ·ZNZ·RW",
  "confidence": "Reported",
  "impact": "watch",
  "impactClass": "watch",
  "intensity": 2,
 ...
 {
  "headline": "🌍 THE SEARCH BOX STOPPED SENDING PEOPLE — AND A SAFARI IS THE MOST RESEARCHED PURCHASE IN TRAVEL",
  "body": "US Google searches ended **without a single click 68.01%** of the time between January and April 2026, up from **60.45%** in 2024 (SparkToro, on Similarweb clickstream data, 9 Jun 2026). AI Overviews now appear on **more than 20%** of searches; where one appears, click-through falls by close to **60%**. Booking Holdings confirmed the mechanism. CEO Glenn Fogel told analysts Google's display changes \"definitely put some pressure on SEO\" — while direct traffic, mid-60% range, \"hasn't gone down at all\" (Skift, 4 Aug 2026). **Read that split properly.** People who already know the name still arrive. People who don't, no longer do. Booking loses one channel. A 14-tent camp in the Mara loses its *only* one. **What everyone is missing:** this never appears in your booking report. A safari is bought after weeks of informational queries — when the crossing happens, what a gorilla permit costs, is Zanzibar safe, Kenya or Tanzania. Those are exactly the questions a generated answer settles on the page. The loss lands in your agent's enquiry inbox, three to six months upstream of your pick-up.",
  "sowhat": "🎯 **So what:** publish citable facts, not adjectives. Models quote dated, checkable statements — a fee table with its effective date, exact crossing windows, transfer times in minutes. Then ask your three largest agents for *enquiry* counts, not bookings. That is the early-warning line.",
  "segments": [
   "city",
   "bush",
   "beach"
  ...
  "countries": "KE·UG·TZ·ZNZ·RW",
  "confidence": "Confirmed (search data) / Inference (EA read)",
  "impact": "watch",
  "impactClass": "watch",
  "intensity": 3,
  "impactSet": "author",
  "source": "pulse-2026-08-26-evening",
  "date": "2026-08-26",
  "dateDisplay": "Wednesday, 26 August 2026",
  "edition": "Evening Wrap",
  "editionKey": "evening"
 ...
 {
  "headline": "📉 THE DANGEROUS NUMBER ISN'T −9.3%. IT'S +4.6 POINTS.",
  "body": "US H1 2026 chain-scale data, out today: **luxury** hotels lifted ADR **10.1%** (USD 302.97 → 333.49) *and* occupancy **3.4 points**, for RevPAR **+15.9%**. **Economy** hotels filled more rooms than any other chain scale — occupancy up **4.6 points**, 63.9% → 68.5% — while ADR fell **9.3%** (USD 120.34 → 109.11). RevPAR: **−2.7%** (HotelData.com H1 2026 Profitability Report, via Hospitality Net, 25 Aug 2026). Read what that says. Economy's problem was never demand. **The discounting worked.** It filled the house and lost money anyway, because every incremental occupied room carries variable cost. **The part nobody transfers to us:** that arithmetic is crueller here. The marginal cost of an occupied bed-night in a bush camp — diesel for game drives and generators, trucked water, staff ratios, supply runs — is a multiple of a US limited-service room turn. Nairobi diesel is **KSh 217.86/L** this cycle, about **KSh 14.28 above the KSh 203.58** landed costs implied (EPRA / Business Daily, 14 Aug 2026). A Mara camp discounting to fill climbs a steeper cliff than a roadside hotel in Ohio. Kenya already runs the economy playbook at national scale. Per TRI's own 2025 report, earnings per arrival rose **3.13%** to KSh 189,004 against the report's own **4.075%** inflation assumption — real yield per visitor down roughly **0.9%**. More visitors, less real money each.",
  "sowhat": "🎯 **So what:** the divide is not luxury versus budget. It is **substitutable versus not**. Run the test on your own property — name what a guest cannot get 400 metres away. If the honest list is empty, you have economy pricing power on a premium cost base. That is the worst seat in the industry.",
  "segments": [
   "city",
   "bush",
   "beach"
  ...
  "countries": "KE·UG·TZ·ZNZ·RW",
  "confidence": "Confirmed (US data) / Inference (EA read)",
  "impact": "watch",
  "impactClass": "watch",
  "intensity": 3,
  "impactSet": "author",
  "source": "pulse-2026-08-25-evening",
  "date": "2026-08-25",
  "dateDisplay": "Tuesday, 25 August 2026",
  "edition": "Evening Wrap",
  "editionKey": "evening"
 ...
 {
  "headline": "**ZANZIBAR ARRESTS EAC CITIZENS AS \"FOREIGNERS\"",
  "body": "One Kenyan, two Ugandans, detained 18 Aug for excursion work reserved for Zanzibaris (The Citizen, 21–22 Aug).",
  "sowhat": "🎯 So what: audit every excursion, transfer and boat product you sell or subcontract for the licence holder's nationality. Liability doesn't stop at your paperwork.",
  "segments": [
   "beach"
  ],
  "countries": "ZNZ/KE/UG",
 ...
 {
  "headline": "**NAIROBI REWRITES WHO CONTROLS THE 2% LEVY",
  "body": "Fund keeps collecting, CS oversees management; the Bill widens the Fund into marketing and product (Capital FM, 21 Aug).",
  "sowhat": "🎯 So what: file during public participation. This decides whether your levy funds marketing you benefit from, or institutions you don't.",
  "segments": [
   "city",
   "bush",
   "beach"
 ...
 {
  "headline": "**TANZANIA HANDS THE PARKS BACK 51% OF THE GATE",
  "body": "Retained in Bank of Tanzania special accounts, released with Paymaster General approval (Pindi Chana, May 2026).",
  "sowhat": "🎯 So what: a park funding its own roads has the motive to reprice them. Model an increase into 2027/28 costings now.",
  "segments": [
   "bush"
  ],
  "countries": "Tanzania",
 ...
 {
  "headline": "**UGANDA IS THE COUNTER-EXAMPLE",
  "body": "UCAA reviewed 15 air service licence applications — 10 new — on 12 June 2026; Entebbe handled 189,130 international passengers in April.",
  "sowhat": "🎯 So what: Uganda is opening the layer everyone else closes. Build Entebbe into 2027 circuits before it prices itself.",
  "segments": [
   "city",
   "bush"
  ],
 ...
 {
  "headline": "🇨🇩➡️🇺🇬 THE EBOLA VACCINE THAT WON'T LIFT UGANDA'S \"DO NOT TRAVEL\"",
  "body": "The UN's vaccine coordination group allocated **70,000 Ervebo doses** to the DRC this week — **20,000** for a Phase 3 clinical trial, **50,000** for frontline health workers (WHO & Africa CDC, 20 Aug). The catch operators need to hold: **Ervebo is a Zaire-strain vaccine, and its efficacy against the Bundibugyo virus driving this outbreak is unproven** — that is what the trial exists to test. So this is a research event, not a containment event. The DRC epidemic is still the fastest-growing on record — **5,290 cases, 2,516 deaths** to 19 Aug, up 81 cases in a day, with an M23 conflict blocking the contact-tracing containment depends on (ECDC, 21 Aug).",
  "sowhat": "",
  "segments": [
   "bush"
  ],
  ...
  "intensity": 2,
  "impactSet": "auto",
  "source": "pulse-2026-08-22-evening",
  "date": "2026-08-22",
  "dateDisplay": "Saturday, 22 August 2026",
  "edition": "Evening Wrap",
  "editionKey": "evening"
 ...
 {
  "headline": "✈️ RWANDAIR TRIMS A BRUSSELS FREQUENCY FOR WINTER",
  "body": "The filing removes the **Monday** rotation on the **Kigali–Paris CDG–Brussels** route for NW26; **Paris stays bookable** (AeroRoutes, 20 Aug). A technical filing, not a route cut — but a straw in the wind.",
  "sowhat": "",
  "segments": [
   "city"
  ],
  ...
  "intensity": 2,
  "impactSet": "auto",
  "source": "pulse-2026-08-21-morning",
  "date": "2026-08-21",
  "dateDisplay": "Friday, 21 August 2026",
  "edition": "Morning Brief",
  "editionKey": "morning"
 ...
 {
  "headline": "🇰🇪 MPs MOVE AGAINST THE KTB SUPER-MERGER — AND THE MINISTRY REACHES FOR THE LEVY",
  ...
  "intensity": 2,
  "impactSet": "auto",
  "source": "pulse-2026-08-21-evening",
  "date": "2026-08-21",
  "dateDisplay": "Friday, 21 August 2026",
  "edition": "Evening Wrap",
  "editionKey": "evening"
 ...
 {
  "headline": "🇹🇿 ZANZIBAR ARRESTS THREE FOREIGNERS FOR RUNNING EXCURSIONS RESERVED FOR ZANZIBARIS",
  "body": "The **Zanzibar Commission for Tourism** and Immigration arrested three foreign nationals — including Kenyan businesswoman **Esther Mutheu Samuka** (with Mukembo Emmanuel and Karungi Scovia) — on **18 August** for operating tour and excursion businesses reserved for Zanzibari citizens under the **Tourism Act No. 6 of 2009**. A public notice was issued 17 Aug (Citizen Digital / Kenyans.co.ke, 21 Aug).",
  "sowhat": "",
  "segments": [
   "beach"
  ],
 ...
 },
 {
  ...
  "intensity": 2,
  "impactSet": "auto",
  "source": "pulse-2026-08-20-midday",
  "date": "2026-08-20",
  "dateDisplay": "Thursday, 20 August 2026",
  "edition": "Midday Pulse",
  "editionKey": "midday"
 ...
 {
  "headline": "🇺🇬 WASHINGTON ALREADY WRITES UGANDA IN THE PAST TENSE — AND KEEPS IT RESTRICTED ANYWAY",
  "body": "The full text of the US entry order signed on **12 August** went on public inspection at the Federal Register on **14 August, 08:45** and publishes **17 August** (FR Doc **2026-16706**, docket **CDC-2026-0892**). We read it this morning on public inspection; we haven't seen it reported anywhere yet. Two things in it matter more than the renewal we covered on 13 August. **First, the operative finding.** The determination reads that Ebola is _\"confirmed currently present in DRC and **recently present in Uganda**.\"_ Past tense — in a document that keeps Uganda on the restricted list. The order records Uganda's last confirmed case as **21 June**, 20 confirmed cases and two deaths in total, and the Ministry of Health declaration of **28 July**. It then keeps Uganda in on a stated ground that has nothing to do with Uganda's epidemiology: _\"continued overland travel from DRC poses an ongoing risk of cross-border transmission, particularly among healthcare workers and in western Ugandan districts.\"_ **What everyone is missing:** the release condition is a DRC number, not a Ugandan one. The order names contact tracing at **~78% nationwide against a 95% operational threshold**, says the true outbreak size may be _\"two to four times greater\"_ than reported, and puts DRC at **4,318 confirmed cases and 2,011 deaths across 53 health zones** as of 9 August — against **1,873 and 672 across 41 zones** when the July order was signed. Uganda's 42-day clock completing around **28 August** does not move any of those. Expiry is **4:59pm EDT, Friday 11 September**. **Second, there is a door, and nobody has walked through it.** Publication on 17 August opens a **15-day comment period** on docket CDC-2026-0892 — closing on or about **1 September**, ahead of the 11 September call. The order records the comments received so far: **three** on the original, **five** in June, and on the July renewal, _none_. The East African trade has never filed.",
  "sowhat": "",
  "segments": [
   "city",
   "bush"
  ...
  "intensity": 2,
  "impactSet": "auto",
  "source": "pulse-2026-08-16-midday",
  "date": "2026-08-16",
  "dateDisplay": "Sunday, 16 August 2026",
  "edition": "Midday Pulse",
  "editionKey": "midday"
 ...
 {
  "headline": "🌍 TWO OFFICIAL CASE COUNTS FOR THE SAME DAY — 63 APART",
  "body": "Worth knowing before you quote a number to an agent or an insurer. For **9 August**, the US order states DRC at **4,318 confirmed cases** across **53 health zones**. WHO AFRO's Weekly External Situation Report 13, same reporting date, states **4,381 confirmed cases and 2,011 deaths, a case fatality ratio of 45.9%**, with Ituri accounting for 85.8% of cumulative cases (afro.who.int, posted 11 Aug). Deaths agree exactly. Cases differ by 63. Neither is wrong — the US figure is a snapshot taken for an American risk assessment; WHO AFRO's is the regional surveillance line. But they will be quoted against each other in the coming fortnight, and being caught with the lower one looks like minimising.",
  "sowhat": "",
  "segments": [
   "city",
   "bush"
 ...
 {
  "headline": "🌍 THE VACCINE LINE IS NO LONGER SUPPORTABLE — AND THE RELEASE NUMBER ROSE",
  "body": "At midday we said the condition freeing Uganda from the US entry order is a DRC number. Tonight we have it. Africa CDC's Emergency Consultative Group, chaired by Prof. Salim Abdool Karim, reports **4,449 confirmed cases, 2,061 deaths, 46.3% fatality** in DRC, **~100 new cases a day**, **R(t) consistently above 1** (Africa CDC statement, **14 August**). Its words: the epidemic is \"still growing rapidly, and faster than previous Ebola epidemics.\" Against the US order's 4,318 and WHO AFRO's 4,381 for 9 August, the curve has not turned. **What everyone is missing: the vaccine sentence.** On Ervebo against Bundibugyo the ECG is blunt — **\"no reliable evidence of its clinical efficacy\"**, and \"a reasonable chance the vaccine is not effective.\" It recommends use under **trial protocol**, not rollout. Since 2019 the reassurance script has been \"Ebola is vaccine-preventable.\" For this strain, Africa's own experts say that is not established. And **63% of deaths in the last fortnight occurred in the community**, not treatment centres — detection, not capacity, is the constraint.",
  "sowhat": "",
  "segments": [
   "city",
   "bush"
  ...
  "intensity": 2,
  "impactSet": "auto",
  "source": "pulse-2026-08-16-evening",
  "date": "2026-08-16",
  "dateDisplay": "Sunday, 16 August 2026",
  "edition": "Evening Wrap",
  "editionKey": "evening"
 ...
 {
  "headline": "🌍 TWO CDC PAGES, TWO DIFFERENT MAPS",
  "body": "We checked both tonight; we haven't seen this reported anywhere. CDC's **Travel Health Notices index** (read 16 Aug, ~19:00 EAT) states under Level 4: _\"Currently there are no Travel Health Notices at this level.\"_ Its Ebola notices — Level 3 for **Ituri, North and South Kivu**, Level 2 for **DRC and Uganda** — are dated **15 June 2026**. CDC's **Ebola situation summary** (page dated **updated 12 August 2026**) instead _\"recommends avoiding all travel to Ituri and Nord-Kivu... and avoiding nonessential travel to Haut-Uele and Tshopo.\"_ Not the same map. Risk vendors and insurers ingest the index because it is machine-readable — so a client's system sees June while their risk officer reads August.",
  "sowhat": "",
  "segments": [
   "city",
   "bush"
 ...
 {
  "headline": "🇺🇬 WASHINGTON KEEPS UGANDA RESTRICTED ON A CONGOLESE NUMBER",
  "body": "The US entry order signed 12 Aug publishes **17 Aug** (FR Doc 2026-16706, docket CDC-2026-0892): it logs Uganda's 28 July all-clear, then keeps Uganda listed on cross-border grounds. Expiry **11 Sep**, comments close ~**1 Sep**. WHO AFRO put DRC at **4,381 confirmed, CFR 45.9%** as of 9 Aug (SitRep 13, 11 Aug).",
  "sowhat": "🎯 **So what:** Brief agents to 11 Sep, not 28 Aug — and file on the docket before ~1 Sep. This industry never has.",
  "segments": [
   "city",
   "bush"
  ],
 ...
 {
  "headline": "🇰🇪 YOU GOT SH5 OFF DIESEL. THE MARKET GAVE SH19.28",
  "body": "EPRA's schedule takes effect **today**, to 14 September: Nairobi diesel **Sh217.86/L** (–Sh5), petrol held at **Sh214.03**, kerosene **Sh191.38**. But landed diesel fell **13.08%** last month — US$855.59/m³ from US$984.37 — while landed petrol **rose 6.9%**. On the regulator's own disclosures diesel should have dropped **Sh19.28, to Sh203.58**. The State used diesel to cross-subsidise petrol, plus **Sh938m** of stabilisation (Business Daily, 14 Aug, quoting acting EPRA DG Joseph Oketch). **What everyone is missing:** the Sh5 isn't relief. Diesel is the safari cost line — game drives, transfers, generators, boreholes, laundry — and operators are carrying **Sh14.28/L** above market so Nairobi's motorists don't feel the Iran-war spike. The funding is running out: the Petroleum Development Levy kitty is nearly depleted, the Exchequer is behind on arrears to marketers, and MPs have called the cross-subsidy illegal. It is in court.",
  "sowhat": "",
  "segments": [
   "city",
   "bush",
  ...
  "intensity": 2,
  "impactSet": "auto",
  "source": "pulse-2026-08-15-morning",
  "date": "2026-08-15",
  "dateDisplay": "Saturday, 15 August 2026",
  "edition": "Morning Brief",
  "editionKey": "morning"
 ...
 {
  "headline": "🇰🇪 TREASURY'S SUMS DON'T ADD UP — COMMENTS CLOSE TUESDAY",
  "body": "The **Draft 2026 Budget Review and Outlook Paper** is open for public participation, **comments due close of business Tue 19 August**, Cabinet by 26 August (Treasury notice; Mwango Capital, 14 Aug). It cuts the FY2026/27 KRA target **Sh81.4bn to Sh2.777tn** — VAT –Sh18.9bn, excise –Sh17.4bn — then projects FY2027/28 revenue of **Sh3.943tn** against **Sh5.323tn** spending: a **Sh1.321tn** deficit, 5.7% of GDP (Business Daily, 11 Aug; People Daily, 14 Aug). Revenue must climb roughly **Sh1.17tn in one year** off a base just revised *down*. Growth of 5.0% doesn't deliver that. The BROP's stated answer is compliance and **a broader tax base** — enforcement, not headline rates.",
  "sowhat": "",
  "segments": [
   "city",
   "bush",
 ...
 {
  "headline": "🇺🇸→🇺🇬 THE US RENEWED, AND UGANDA STAYED COUPLED",
  "body": "CDC's returning-travellers page, updated **12 August 2026**, cites the agency's \"renewed August 12 order, under 42 CFR 71.40\" continuing restrictions for travellers recently in **DRC, Uganda or South Sudan**. The signed order landed on CDC's server as `August-T42-Order_08.11.2026-signed.pdf` — our radar first saw it at **22:51 EAT on 12 August**. CDC's own legal-authorities page still reads \"July 20, 2026\" and still names 13 July as current: the renewal is real, the canonical page hasn't caught up. Substance unchanged. DRC is a hard 21-day block on everyone, US citizens included. From Uganda or South Sudan, US citizens aren't restricted but are **rerouted to Dulles, Atlanta, Houston or JFK** for screening. Green Card holders are named as restricted.",
  "sowhat": "",
  "segments": [
   "city",
   "bush"
  ...
  "intensity": 2,
  "impactSet": "auto",
  "source": "pulse-2026-08-13-morning",
  "date": "2026-08-13",
  "dateDisplay": "Thursday, 13 August 2026",
  "edition": "Morning Brief",
  "editionKey": "morning"
 ...
 {
  "headline": "🇨🇦 CANADA IS THE HARDER RULE — AND NOBODY IS QUOTING IT",
  "body": "Per travel.gc.ca (notice modified **23 July 2026**), since 20 July anyone who has been in **Uganda or South Sudan** in the past 21 days may travel to Canada but **must quarantine 21 days on arrival** unless exempt. DRC arrivals are barred outright. The measures run under the Quarantine Act to **29 August 2026, 23:59 EDT**.",
  "sowhat": "",
  "segments": [
   "bush"
  ],
 ...
 {
  "headline": "🇺🇬 KAMPALA KEEPS THE BORDER MARKETS SHUT",
  "body": "Health Minister Dr Chris Baryomunsi told Parliament on **12 August** that markets and large gatherings stay closed in DRC-border communities despite the 28 July declaration: _\"We are seeing that the infection rates are quickly approaching the borders of Uganda.\"_ DRC has passed 2,000 deaths and 4,300 cases. The task force reviews the measures **next week** (New Vision, 12 Aug).",
  "sowhat": "",
  "segments": [
   "city",
   "bush"
 ...
 },
 {
  ...
  "intensity": 2,
  "impactSet": "auto",
  "source": "pulse-2026-08-13-midday",
  "date": "2026-08-13",
  "dateDisplay": "Thursday, 13 August 2026",
  "edition": "Midday Pulse",
  "editionKey": "midday"
 ...
 {
  "headline": "🇺🇸→🌍 THE US EBOLA ENTRY ORDER EXPIRES TODAY — RENEW OR LAPSE BY 4:59PM EDT",
  "body": "The CDC's 30-day Title 42 order covering travellers recently in the DRC, Uganda and South Sudan expires at 4:59pm EDT today (Federal Register 2026-14365, order signed 13 July). As of this morning no renewal has been published — we haven't seen the decision reported anywhere yet. The pattern says it renews (it did on 21 June and 13 July), but the question that matters for us is whether Uganda stays coupled to the DRC or gets decoupled ahead of its 42-day Ebola all-clear (~28 Aug). Where it stands now (CDC returning-travellers page, 7 Aug): the DRC is a hard block — nobody, US citizens included, boards a US-bound flight within 21 days of leaving. Uganda and South Sudan are lighter: US citizens and nationals aren't restricted, but permitted travellers are rerouted to four US airports (Dulles, Atlanta, Houston, JFK) for screening. Uganda remains US **Level 4**.",
  "sowhat": "",
  "segments": [
   "city",
   "bush"
  ...
  "intensity": 2,
  "impactSet": "auto",
  "source": "pulse-2026-08-12-morning",
  "date": "2026-08-12",
  "dateDisplay": "Wednesday, 12 August 2026",
  "edition": "Morning Brief",
  "editionKey": "morning"
 ...
 {
  "headline": "🇷🇼 KWITA IZINA IS BACK — 22 GORILLAS, 4 SEPTEMBER, A ROOM-NIGHT SQUEEZE FOR VOLCANOES",
  "body": "The Rwanda Development Board formally unveiled plans for the 21st Kwita Izina on 11 August: 22 baby mountain gorillas named at Kinigi, Musanze, on Friday 4 September (RDB, 11 Aug; Taarifa, 11 Aug). It is Rwanda's flagship conservation event and it pulls high-end conservation travel into a narrow window.",
  "sowhat": "",
  "segments": [
   "bush"
  ],
 ...
 {
  "headline": "🇰🇪 EASTLEIGH AND KIBERA ARE NOW \"DO NOT TRAVEL\"",
  "body": "The rendered travel.state.gov Kenya advisory, re-read at midday today, carries **\"Date issued: July 28, 2026\"** — not the 17 March 2025 date that stood when we last verified on 2 August — and lists the **Nairobi neighbourhoods of Eastleigh and Kibera under Level 4, Do Not Travel**, for crime and kidnapping. A sixth risk indicator, **\"Other (O)\"**, has been added. Kenya's country level is unchanged at **Level 2**. State's own note: _\"There was no change to the advisory level. The 'other' risk indicator was added. Advisory summary was updated.\"_ (travel.state.gov, checked 12 Aug; US Embassy Nairobi, 30 July.) **Correction:** our board carried those neighbourhoods as Reconsider Travel. Fixed today.",
  "sowhat": "",
  "segments": [
   "city"
  ],
 ...
 {
  "headline": "🌍 DRC EBOLA PASSES 2,000 DEATHS AS THE US ORDER EXPIRES",
  "body": "DRC officials reported **2,011 deaths from 4,381 confirmed cases** as of Tuesday, at least 1,000 of them in the past three weeks — the fastest-growing outbreak on record (AP/Al Jazeera, 11 Aug; UN News, 11 Aug). OCHA is preparing **Rwanda** for possible spread; Rwanda has no confirmed cases. Israel is testing a citizen who returned from the DRC with a fever. As of 13:30 EAT the CDC order page still shows the 13 July order as latest — **no renewal published**, expiry 4:59pm EDT tonight.",
  "sowhat": "",
  "segments": [
   "city",
   "bush"
 ...
 {
  "headline": "THE ROUTE MAP LOOKS LIKE GROWTH. THE MARGIN BEHIND IT LOOKS LIKE FRAGILITY.",
  "body": "Every new frequency into Nairobi, Entebbe, Kigali and Zanzibar reads to an owner as free demand. More seats, more guests, plan the rooms around them. That is the wrong thing to be watching. The carriers flying those seats are the least profitable in the world. IATA's outlook (December 2025, revised down through 2026) puts **African airlines' 2026 net profit at about US$100m — a 0.2% margin, and roughly US$0.40 per passenger, down from US$2.10 in 2025**. Africa is simultaneously the **fastest-growing** aviation market on earth (demand up ~10%) and the thinnest-margin one, carrying the highest unit costs globally — near 140 US-cents per ATK, about double the industry average (IATA/AFRAA). **What everyone is missing:** a route launch is not a demand guarantee — it's a bet made by an operator with no buffer. At a 0.2% margin, the first thing a carrier trims when fuel, FX or bookings wobble is the newest, thinnest route. And those are precisely the frequencies feeding secondary safari and beach gateways. Airlift you didn't build, you can't defend. 🦁 **Bush:** most exposed. A safari season hung on one newly launched or seasonal regional frequency is a fragile plan — keep multi-gateway routing and push direct/advance bookings so a schedule cut doesn't empty your season. 🏖 **Beach:** single-carrier leisure and charter routes (e.g. RwandAir's Zanzibar/Mombasa services resumed Dec 2025) are the classic first-to-be-trimmed in a squeeze. Hold rate, but keep a source-market and routing spread. 🏙 **City:** trunk routes on the strongest balance sheets are your safest airlift — but don't bank every new frequency straight into corporate-rate assumptions.",
  "sowhat": "🎯 **So what, by segment**",
  "segments": [
   "city",
   "bush",
   "beach"
  ...
  "intensity": 2,
  "impactSet": "auto",
  "source": "pulse-2026-08-11-morning",
  "date": "2026-08-11",
  "dateDisplay": "Tuesday, 11 August 2026",
  "edition": "Morning Brief",
  "editionKey": "morning"
 ...
 {
  "headline": "🇺🇬 KAMPALA'S MARRIOTT FLAGSHIP IS IN FINAL PREP — OPENING IMMINENT, NOT LIVE",
  "body": "The full Marriott-brand flagship (**181 rooms + 96 executive apartments**, Nsambya) is in final preparations, per the Ministry of Finance and Nile Post (June 2026) — a first for the brand in Uganda beyond its Protea and Four Points properties. No confirmed open date yet.",
  "sowhat": "🎯 **So what:** Kampala corporate-rate compression is coming — independents, defend your accounts now; confirm the open date before quoting it as live.",
  "segments": [
   "city"
  ],
  "countries": "",
  ...
  "intensity": 2,
  "impactSet": "auto",
  "source": "pulse-2026-08-11-midday",
  "date": "2026-08-11",
  "dateDisplay": "Tuesday, 11 August 2026",
  "edition": "Midday Pulse",
  "editionKey": "midday"
 ...
 {
  "headline": "THE RECORD THAT HIDES A RISK — READ YOUR SOURCE-MARKET MIX, NOT YOUR ARRIVALS LINE",
  "body": "Every headline this year says the same thing: records. Zanzibar cleared 917,167 arrivals in 2025 (OCGS). Tanzania banked US$4.41bn in tourism earnings, up 13% (NBS, 2025). Kenya reports ~7.9m visitors. The applause is deserved. It is also the wrong thing to be watching. Look underneath Zanzibar's boom and you find a single load-bearing pillar: Europe supplied **61.9% of June arrivals (43,105 of 69,605)** and **69.5% in January** (OCGS, June figure released ~12 Jul). One region, most of your bookings. That is not a franchise — it's a bet on one continent's disposable income and one continent's risk appetite. **What everyone is missing:** a record-arrivals headline is not validation, it's a concentration warning. And you don't have to imagine the shock — it's live. Uganda sits at **US Level 4 \"Do Not Travel\"** (State Dept, 5 Aug) and the **US CDC Section 362 entry order** (renewed 13 Jul, next call ~12 Aug) has effectively frozen one Western source market for the Uganda/DRC corridor overnight. A single government notice did that. A European recession would do the same to a coast that leans 62–70% on Europe. **The hedge already works — someone's proven it.** Tanzania grew Chinese arrivals from **33,000 to 82,000 in two years** through Mandarin-language outreach. Deliberate diversification, not luck. 🏖 **Beach:** most exposed. Build Gulf/India/intra-Africa shoulder fill now — language, OTA and payment rails ready before the next Western wobble, not after. 🦁 **Bush:** the Uganda freeze shows how fast one advisory empties a source market. Court Gulf/India feeder demand on the new Doha/Dubai lift; hold rate through a Western gap rather than discounting. 🏙 **City:** MICE and intra-African business travel are your natural diversifier — MKTE (Oct), FHS Africa Uganda 2027, ICCA Kigali 2027 are demand that doesn't depend on Western leisure sentiment.",
  "sowhat": "🎯 **So what, by segment**",
  "segments": [
   "city",
   "bush",
  ...
  "intensity": 2,
  "impactSet": "auto",
  "source": "pulse-2026-08-10-morning",
  "date": "2026-08-10",
  "dateDisplay": "Monday, 10 August 2026",
  "edition": "Morning Brief",
  "editionKey": "morning"
 ...
 {
  "headline": "THE RECORD WAS SET AT HOME — READ YOUR DOMESTIC DEMAND AS A STRATEGY, NOT A DISCOUNT BIN",
  "body": "Kenya moved a record **13.1 million air passengers in the year to June 2026**, up from 12.955m a year earlier — about 145,000 more travellers (KAA preliminary data, via Daily Nation, 6 Aug). The line that matters sits underneath it: **domestic routes were roughly 41% of all traffic**, and KAA MD Moses Wekesa says it was domestic travel that carried the record while international numbers softened under Middle East disruption. **What everyone is missing:** the record was set *because* international dipped, not alongside it. Domestic and regional demand is counter-cyclical to exactly the Western shocks — advisories, long-haul softness, recession fear — that empty a coast or a corridor overnight. Fly748, back flying scheduled routes since May, is running strong Nairobi–Mombasa and Ukunda/Diani loads this school holiday, one-way fares from **KSh 7,700** (Tuko, 6 Aug). That is real, growing, FX-proof demand — and most inbound-tuned properties are set up to miss it. 🏖 **Beach:** the direct beneficiary. Package resident/school-holiday weekend rates, make sure M-Pesa and local rails work, and list where Kenyans actually book. This demand doesn't read a State Department bulletin. 🦁 **Bush:** your EAC-resident tier is the counter-cyclical floor under Western advisory risk — hold it as a revenue line, not a discount dump. 🏙 **City:** the record ran on a hub whose domestic legs grew while international slowed. Domestic corporate + MICE (Hotel Expo 19–21 Aug, MKTE Oct) is the compounding book.",
  "sowhat": "🎯 **So what, by segment**",
  "segments": [
   "city",
   "bush",
  ...
  "intensity": 2,
  "impactSet": "auto",
  "source": "pulse-2026-08-10-midday",
  "date": "2026-08-10",
  "dateDisplay": "Monday, 10 August 2026",
  "edition": "Midday Pulse",
  "editionKey": "midday"
 },
 {
  ...
  "intensity": 3,
  "impactSet": "auto",
  "source": "pulse-2026-08-08-morning",
  "date": "2026-08-08",
  "dateDisplay": "Saturday, 8 August 2026",
  "edition": "Morning Brief",
  "editionKey": "morning"
 ...
 {
  "headline": "FORECAST CHECK-IN: KENYA'S AIR-TRAVEL TAXES POINT UP, NOT DOWN",
  "body": "Our standing call P016 — Kenya will not cut the air passenger service levy before end-2027 — isn't just holding, the direction is the opposite. Kenya has spent the past year RAISING, not trimming, the cost of flying in: the Air Passenger Service Charge (Amendment) Act, signed 15 Oct 2025, handed the Transport CS standing power to vary the charge and put the international levy on a path toward US$50 and domestic to KSh600 (per ATTA / Kenyan Wall Street). The 2026 fiscal debate over removing VAT relief on aircraft parts pushes landed and fare costs the same way. This is structure, not breaking news — but it's the structure your guests' airfares sit on.",
  "sowhat": "🎯 So what: for city and safari properties whose guests fly in, budget airlift-linked costs — fares, transfers, connecting-flight fees — as flat-to-rising into the Sept–Oct peak. Don't model a cheaper-ticket tailwind into demand; if anything, the tax base is working against lead-in fares. Call stays open, thesis strengthening.",
  "segments": [
   "city",
   "bush"
  ],
  ...
  "intensity": 2,
  "impactSet": "auto",
  "source": "pulse-2026-08-05-midday",
  "date": "2026-08-05",
  "dateDisplay": "Wednesday, 5 August 2026",
  "edition": "Midday Pulse",
  "editionKey": "midday"
 ...
 {
  "headline": "MICE WATCH: THE NEXT CITY COMPRESSION IS TWO WEEKS OUT",
  "body": "Hotel Expo Kenya lands 19–21 Aug at KICC Nairobi — a three-day city-centre trade event (100+ exhibitors in 2025, organiser figure) sitting just ahead of the Sept–Oct peak. It's a midweek exhibitor-and-buyer window, not a citywide sell-out, but it's real demand into the CBD and Upper Hill.",
  "sowhat": "🎯 So what: Nairobi city hotels near KICC should hold corporate rate through 19–21 Aug rather than discounting into the shoulder. The bigger compression — MKTE, 10,000+ delegates, 6–8 Oct — is the one to be closing out standard rate against now.",
  "segments": [
   "city"
  ],
  "countries": "Kenya",
 ...
 },
 {
  ...
  "sowhat": "🎯 So what: Confirmed fact — Airport City now has its own chief executive, separate from the airport build. Our inference, labelled as such: giving the commercial district a dedicated CEO before the runway is finished is how a government signals the hotel and mixed-use component is moving from masterplan to procurement. If you are a Kigali operator or an investor eyeing Bugesera, you now have a named counterparty to track and a governance milestone to date your own timeline against. Watch the next 90 days for a hotel or commercial tender under his office.",
  "segments": [
   "city",
   "bush"
  ],
  "countries": "🇷🇼",
  "confidence": "Confirmed (appointment) / inference flagged",
  "impact": "watch",
  "impactClass": "watch",
  "intensity": 3,
  "impactSet": "auto",
  "source": "pulse-2026-07-31-morning",
  "date": "2026-07-31",
  "dateDisplay": "Friday, 31 July 2026",
  "edition": "Morning Brief",
  "editionKey": "morning"
 ...
 {
  "headline": "ZANZIBAR MARATHON FIXES 25 OCTOBER — A 10,000-RUNNER DEMAND DATE",
  "body": "Yas has launched the 2026 Zanzibar International Marathon, its sixth edition, targeting more than 10,000 local and international runners, with a fully digital registration and payment system via the Mixx by Yas platform (The Citizen, 30 July). The most recent Citizen reporting sets the race for 25 October; one earlier source cited 20 September, so confirm the date before you load it into a rate calendar.",
  "sowhat": "🎯 So what: This is a diarised, bookable demand pulse landing inside Zanzibar's Q4 shoulder, not the December peak. A 10,000-runner field pulls a two-to-three-night stay across Stone Town and the beach strip. Set a marathon-weekend rate and a minimum-stay now, before the international entries convert to bookings, and brief your reservations team to hold inventory around 24–26 October pending the final date.",
  "segments": [
   "city",
   "beach"
  ],
 ...
 },
 {
  ...
  "sowhat": "🎯 So what: Replace the countdown language in every pre-arrival email, agent FAQ and website health notice today with \"declared over on 28 July 2026\" and the Ministry link. You have a government document now, not a diary date.",
  "segments": [
   "city",
   "bush"
  ],
  ...
  "intensity": 3,
  "impactSet": "auto",
  "source": "pulse-2026-07-29-morning",
  "date": "2026-07-29",
  "dateDisplay": "Wednesday, 29 July 2026",
  "edition": "Morning Brief",
  "editionKey": "morning"
 ...
 {
  "headline": "NOBODY ABROAD HAS SIGNED OFF ON IT",
  "body": "As at 08:00 EAT this morning we can find no WHO statement endorsing the declaration — WHO AFRO's newsroom still carries the 16 July countdown release as its most recent Uganda Ebola item. Washington has not moved either: the CDC order under PHS Act ss.362/365 (91 FR 43636, 16 July) still suspends entry for anyone present in Uganda in the previous 21 days and runs to 4:59pm EDT on 12 August, with returning travellers funnelled through Dulles, Atlanta, Houston and JFK. Across the border, DRC stood at over 3,200 confirmed cases and 1,405 deaths as at 26 July (ECDC).",
  "sowhat": "🎯 So what: Sell \"outbreak over\", not \"restrictions lifted\". A guest who books a US-return itinerary on yesterday's headline still cannot fly home for 21 days. Keep the warning in every American quote.",
  "segments": [
   "city",
   "bush"
  ],
 ...
 {
  "headline": "THE DOCKET SHUTTING ON FRIDAY NOW HAS A DECLARATION TO PUT IN IT",
  "body": "Comment on docket CDC-2026-0892 closes on 31 July. CDC refused the previous round of requests to assess Uganda separately from DRC because \"the outbreak remains interconnected across national borders.\" A formal end-of-outbreak declaration landed three days before the window shuts. That reasoning is now testable in writing.",
  "sowhat": "🎯 So what: If you sell Uganda to Americans, file at regulations.gov by Friday — attach the 28 July declaration and your own cancellation numbers. Last formal channel before the 12 August decision.",
  "segments": [
   "city",
   "bush"
  ],
 ...
 {
  "headline": "JKIA STRIKE CALLED OFF — 24 HOURS BEFORE IT STARTED",
  "body": "The Kenya Aviation Workers Union withdrew the nationwide strike it had scheduled to begin today, after signing a framework agreement on Monday 27 July with the Ministry of Roads and Transport, Kenya Airways, KAA, KCAA and Jambojet (The Star and Capital FM, 27 July). The 20 July strike notice is withdrawn; KAWU–airline talks open today, and the harder round — KAWU with KAA — begins tomorrow, 29 July. Core demands are unresolved: withdrawal of NYS and KDF personnel from the JKIA fire station, and reinstatement of four dismissed employees.",
  "sowhat": "🎯 So what: Don't stand down your contingency. Keep the airport-transfer buffer and the flexible-rebooking wording live through 29 July, and only tell agents \"resolved\" when a CBA is signed, not when a strike is suspended.",
  "segments": [
   "city",
   "bush",
   "beach"
  ...
  "intensity": 3,
  "impactSet": "auto",
  "source": "pulse-2026-07-28-morning",
  "date": "2026-07-28",
  "dateDisplay": "Tuesday, 28 July 2026",
  "edition": "Morning Brief",
  "editionKey": "morning"
 ...
 {
  "headline": "OIL ROUND-TRIPPED — AND THE AUGUST FUEL NUMBER SURVIVED IT",
  "body": "Brent went above US$100 on 23 July after Houthi attacks on two Saudi tankers in the Red Sea, then fell to US$90.28 on Monday 27 July — down 8.2% in a session — as the US and Iran paused strikes (Bloomberg and Trading Economics, 23–27 July). The Standard put the intraday peak higher, above US$112, before easing to US$88 (Financial Standard, 28 July). Context on the cost side: CBK's weekly bulletin for the week to 23 July showed reserves at US$13.854bn, 5.9 months of import cover, down from 6.0, with the shilling at 129.53 from 129.34.",
  "sowhat": "🎯 So what: EPRA prices off the previous month's landed cargo costs, so the spike lands in your September pump price, not the 15 August one — our inference, not EPRA's word. Fix diesel and LPG supply contracts this week while the market is calm, and don't rebase transfer surcharges off a four-day panic.",
  "segments": [
   "city",
   "bush",
   "beach"
  ],
  "countries": "🇰🇪 (regional read-across)",
  "confidence": "Confirmed / inference flagged",
  "impact": "risk",
  "impactClass": "risk",
  "intensity": 3,
  "impactSet": "auto",
 ...
 {
  "headline": "THE WRECK OFF NYALI STAYS PUT UNTIL MID-AUGUST",
  "body": "KMA Director General Omae Nyarandi confirmed the refloating of MV Adan — aground off Nyali since 18 May while sailing Dar es Salaam to Mombasa — will only begin in mid-August 2026, timed to favourable weather and tides (The Standard, 27 July). Yaa Holdings Limited is the appointed salvage contractor; the plan is still in regulatory review. The Coast Guard is running round-the-clock security against vandalism, and maritime sources warn of fuel discharge risk.",
  "sowhat": "🎯 So what: North-coast resorts get a wreck on the horizon through the whole August peak. Brief front desk today with one honest line, put it in pre-arrival comms before a guest photographs it, and confirm your pollution-event cover with your insurer this week.",
  "segments": [
   "beach"
  ],
  "countries": "🇰🇪",
 ...
 {
  "headline": "THE COMMENT WINDOW ON THE UGANDA ENTRY BAN CLOSES FRIDAY",
  "body": "The CDC order suspending entry to the US of anyone present in DRC, Uganda or South Sudan in the previous 21 days was published in the Federal Register on 16 July (91 FR 43636, docket CDC-2026-0892). It carries a 15-day public comment period that closes **31 July**. In the same document CDC answers the comments it received last round — and two of them asked for exactly what Ugandan tourism needs: that Uganda be assessed independently of DRC. CDC refused, in writing: \"the outbreak remains interconnected across national borders.\" We have not seen a single East African tourism body, airline or destination marketing organisation on that docket.",
  "sowhat": "🎯 So what: If you sell Uganda to Americans, file a comment at regulations.gov under docket CDC-2026-0892 before Friday, with your own cancellation and rebooking numbers in it. Evidence beats sentiment, and this is the only formal channel that exists.",
  "segments": [
   "city",
   "bush"
  ],
  ...
  "intensity": 3,
  "impactSet": "auto",
  "source": "pulse-2026-07-28-evening",
  "date": "2026-07-28",
  "dateDisplay": "Tuesday, 28 July 2026",
  "edition": "Evening Wrap",
  "editionKey": "evening"
 ...
 {
  "headline": "THE BAN NOW CATCHES US GREEN CARD HOLDERS",
  "body": "Quietly, the exemption that let US lawful permanent residents through was deleted. 42 CFR 71.40(f) was amended on 27 May (91 FR 31362) and the 13 July order applies \"including lawful permanent residents of the United States.\" A green card holder who treks Bwindi cannot go home for 21 days. That is a distinct, high-value segment — diaspora, US-based professionals, repeat gorilla clients — and most of them do not know.",
  "sowhat": "🎯 So what: Put a one-line non-US-citizen warning into every American-market quote and pre-arrival email tonight. Offer a free date change rather than lose the booking to a surprise at the airport.",
  "segments": [
   "city",
   "bush"
  ],
 ...
 {
  "headline": "UGANDA'S CONTACT-TRACING CHAIN IS NOW EMPTY",
  "body": "Uganda's Ministry of Health EVD dashboard, updated today: 20 confirmed cases, 0 current admissions, 0 active contacts under follow-up, 821 of 831 listed contacts having completed 21 days. 2,482 people tested, 5,465 travellers screened at points of entry. That is day 12 of a 42-day countdown that started 16 July and finishes around 27 August.",
  "sowhat": "🎯 So what: Uganda's epidemiological case is now genuinely strong. The problem is that the US decision point is 12 August — a fortnight before Uganda can be declared clear. Sell the data, but do not promise clients an August lift.",
  "segments": [
   "city",
   "bush"
  ],
 ...
 },
 {
  ...
  "intensity": 2,
  "impactSet": "auto",
  "source": "pulse-2026-07-27-midday",
  "date": "2026-07-27",
  "dateDisplay": "Monday, 27 July 2026",
  "edition": "Midday Pulse",
  "editionKey": "midday"
 ...
 {
  "headline": "THE AUGUST FUEL NUMBER IS BEING SET THIS FORTNIGHT",
  "body": "Brent traded at US$90.28 today, down 8.23% on the day on reports of revived US–Iran talks — but still up 22.15% over the month (per Trading Economics, 27 July). Houthi forces claimed attacks on Aramco facilities at Jizan and Yanbu over the weekend. EPRA held the 14 June–14 August cycle flat: Super Ksh214.03, diesel Ksh222.86, kerosene Ksh191.38 in Nairobi. EPRA averages landing costs of cargoes arriving up to the 10th of the month — so the next number is being priced right now (per Kenyans.co.ke, 24 July, quoting Prime CS Musalia Mudavadi).",
  "sowhat": "🎯 So what: the fact is a 22% monthly move in crude with the window still open. The inference is ours: 15 August diesel is more likely up than down. Cost your Q4 transfer and generator lines at Ksh240 diesel and see what breaks. Any 2027 contract on your desk this week needs a fuel-surcharge clause before you sign it, not after.",
  "segments": [
   "city",
   "bush",
   "beach"
  ],
  "countries": "KE 🇰🇪 regional",
  "confidence": "Confirmed (price) / inference flagged",
  "impact": "risk",
  "impactClass": "risk",
  "intensity": 3,
  "impactSet": "auto",
 ...
 {
  "headline": "TANZANIA PUTS AN EL NIÑO CONTINGENCY PLAN ON THE BOOKS",
  "body": "The Prime Minister's Office is preparing a costed national contingency plan for El Niño, with expanded early warning, disaster risk coordinator Yona Benjamin told The Citizen (27 July). The forecast beneath it is older and should be read as such: TMA projected in May a 90% probability of El Niño conditions developing October to December 2026. TMA director Dr Ladislaus Chang'a urged operators to use the remaining dry months to finish construction.",
  "sowhat": "🎯 So what: that last line is an instruction, not advice. If you have a refurbishment, a new wing or an access road running on the southern circuit, Rufiji, Selous or the coast, pull completion forward into September. Then re-read your green-season cancellation terms — a 90% flood probability across your Oct–Dec window is an underwriting question, not a weather one.",
  "segments": [
   "bush",
   "beach"
  ],
 ...
 },
 {
  ...
  "body": "Uganda discharged its last Ebola patient on 16 July, starting the WHO 42-day countdown (WHO Afro). Last case was 21 June; 20 cases, 2 deaths, 15 of them imported from DRC. Absent new cases, the outbreak can be declared over around 27 August — 33 days out.",
  "sowhat": "🎯 So what: Build your Sept-Dec recovery campaign NOW and load it before 20 August. Brief trade partners the week of 17 August. By the time bookings visibly return, your competitors have taken the share.",
  "segments": [
   "city",
   "bush"
  ],
 ...
 {
  "headline": "THE ALL-CLEAR WON'T LIFT THE US ADVISORY",
  "body": "This is the misread that will cost money. State's Level 4 (renewed 4 June) cites crime, health, terrorism AND unrest — health is one of four grounds. The outbreak ending clears one pillar, not the advisory.",
  "sowhat": "🎯 So what: Anchor your recovery messaging on the WHO declaration, not on a State Department change that may never come. Plan for Level 4 persisting.",
  "segments": [
   "city",
   "bush"
  ],
 ...
 {
  "headline": "USE THE DIVERGENCE — IT'S YOUR BEST ASSET",
  "body": "The US CDC rates Ebola in DRC/Uganda Level 2 \"Practice Enhanced Precautions\" while State says Do Not Travel — a split inside the same government. The UK FCDO (updated 1 July) carries no country-wide warning at all, only regional advice for western Uganda.",
  "sowhat": "🎯 So what: Your UK and European book is defensible on official grounds; your US book is not. Ring-fence the messaging — don't alarm markets that haven't moved.",
  "segments": [
   "city",
   "bush",
   "beach"
 ...
 {
  "headline": "WATCH MARBURG, NOT EBOLA",
  "body": "A separate Marburg death (18-month-old, Kyegegwa, western Uganda, confirmed 2 July) was caught by Ebola surveillance. Isolated so far, no secondary cases. If it spreads, the clock resets.",
  "sowhat": "🎯 So what: This is your single daily monitoring item. Everything else is on a schedule; this isn't.",
  "segments": [
   "bush"
  ],
  "countries": "UG",
...
window.BUILT_AT = "2026-09-23 06:14";
